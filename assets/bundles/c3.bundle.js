! function(t, e) {
    ...
    function r(t, e) {
        var n = this;
        n.component = t, n.params = e || {}, n.d3 = t.d3, n.scale = n.d3.scale.linear(), n.range, n.orient = "bottom", n.innerTickSize = 6, n.outerTickSize = this.params.withOuterTick ? 6 : 0, n.tickPadding = 3, n.tickValues = null, n.tickFormat, n.tickArguments, n.tickOffset = 0, n.tickCulling = !0, n.tickCentered, n.tickTextCharSize, n.tickTextRotate = n.params.tickTextRotate, n.tickLength, n.axis = n.generateAxis()
    }
        ...
        e.loadConfig(t), e.beforeInit(t), e.init(), e.afterInit(t),
            function e(n, i, r) {
                Object.keys(n).forEach(function(t) {
                    i[t] = n[t].bind(r), 0 < Object.keys(n[t]).length && e(n[t], i[t], r)
                })
            }(y, this, this)
    }
    ...
    (o = r.prototype).axisX = function(t, e, n) {
        ...
        var r = this.params.tickMultiline ? this.splitTickText(t, n, i) : [].concat(this.textFormatted(t));
        ...
        return "[object Array]" === Object.prototype.toString.call(i) ? i : ((!u || u <= 0) && (u = s.isVertical() ? 95 : s.params.isCategory ? Math.ceil(n(e[1]) - n(e[0])) - 12 : 110), function t(e, n) {
            a = void 0;
            for (var i = 1; i < n.length; i++)
                if (" " === n.charAt(i) && (a = i), r = n.substr(0, i + 1), o = s.tickTextCharSize.w * r.length, u < o) return t(e.concat(n.substr(0, a || i)), n.slice(a ? a + 1 : i));
            return e.concat(n)
        }([], i + ""))
        ...
        function v(t) {
            t.each(function() {
                var t, e, n, i = v.g = m.select(this),
                    ...
                    u = s.enter().insert("g", ".domain").attr("class", "tick").style("opacity", 1e-6),
                    c = s.exit().remove(),
                    l = y.transitionise(s).style("opacity", 1);
                w.isCategory ? (y.tickOffset = Math.ceil((a(1) - a(0)) / 2), e = y.tickCentered ? 0 : y.tickOffset, n = y.tickCentered ? y.tickOffset : 0) : y.tickOffset = e = 0, u.append("line"), u.append("text"), y.updateRange(), y.updateTickLength(), y.updateTickTextCharSize(i.select(".tick"));
                var h = l.select("line"),
                    d = l.select("text"),
                    f = s.select("text").selectAll("tspan").data(function(t, e) {
                        return y.tspanData(t, e, o, a)
                    });
                f.enter().append("tspan"), f.exit().remove(), f.text(function(t) {
                    return t.splitted
                });
                var g = i.selectAll(".domain").data([0]),
                    p = (g.enter().append("path").attr("class", "domain"), y.transitionise(g));
                switch (y.orient) {
                    case "bottom":
                        t = y.axisX, h.attr("x1", e).attr("x2", e).attr("y2", function(t, e) {
                            return y.lineY2(t, e)
                        }), d.attr("x", 0).attr("y", function(t, e) {
                            return y.textY(t, e)
                        }).attr("transform", function(t, e) {
                            return y.textTransform(t, e)
                        }).style("text-anchor", function(t, e) {
                            return y.textTextAnchor(t, e)
                        }), f.attr("x", 0).attr("dy", function(t, e) {
                            return y.tspanDy(t, e)
                        }).attr("dx", function(t, e) {
                            return y.tspanDx(t, e)
                        }), p.attr("d", "M" + y.range[0] + "," + y.outerTickSize + "V0H" + y.range[1] + "V" + y.outerTickSize);
                        break;
                    case "top":
                        t = y.axisX, h.attr("x2", 0).attr("y2", -y.innerTickSize), d.attr("x", 0).attr("y", -y.tickLength).style("text-anchor", "middle"), f.attr("x", 0).attr("dy", "0em"), p.attr("d", "M" + y.range[0] + "," + -y.outerTickSize + "V0H" + y.range[1] + "V" + -y.outerTickSize);
                        break;
                    case "left":
                        t = y.axisY, h.attr("x2", -y.innerTickSize).attr("y1", n).attr("y2", n), d.attr("x", -y.tickLength).attr("y", y.tickOffset).style("text-anchor", "end"), f.attr("x", -y.tickLength).attr("dy", function(t, e) {
                            return y.tspanDy(t, e)
                        }), p.attr("d", "M" + -y.outerTickSize + "," + y.range[0] + "H0V" + y.range[1] + "H" + -y.outerTickSize);
                        break;
                    case "right":
                        t = y.axisY, h.attr("x2", y.innerTickSize).attr("y2", 0), d.attr("x", y.tickLength).attr("y", 0).style("text-anchor", "start"), f.attr("x", y.tickLength).attr("dy", function(t, e) {
                            return y.tspanDy(t, e)
                        }), p.attr("d", "M" + y.outerTickSize + "," + y.range[0] + "H0V" + y.range[1] + "H" + y.outerTickSize)
                }
                if (a.rangeBand) {
        ...
        return v.scale = function(t) {
            ...
            return arguments.length ? (y.orient = t in {
                top: 1,
                right: 1,
                bottom: 1,
                left: 1
            ...
            var t;
            return (t = w.isCategory ? 2 * y.tickOffset : (v.g.select("path.domain").node().getTotalLength() - 2 * y.outerTickSize) / v.g.selectAll("line").size()) === 1 / 0 ? 0 : t
        }, v.ticks = function() {
            return arguments.length ? (y.tickArguments = arguments, v) : y.tickArguments
        }, v.tickCulling = function(t) {
            return arguments.length ? (y.tickCulling = t, v) : y.tickCulling
        }, v.tickValues = function(t) {
            if ("function" == typeof t) y.tickValues = function() {
    ...
    var _ = function(t) {
        function i(t) {
            ...
            var e = {
                ...
                }(this, (i.__proto__ || Object.getPrototypeOf(i)).call(this, t, "axis", e));
    ...
    (a = _.prototype).init = function() {
        var t = this.owner,
            e = t.config,
            n = t.main;
        t.axes.x = n.append("g").attr("class", X.axis + " " + X.axisX).attr("clip-path", t.clipPathForXAxis).attr("transform", t.getTranslate("x")).style("visibility", e.axis_x_show ? "visible" : "hidden"), t.axes.x.append("text").attr("class", X.axisXLabel).attr("transform", e.axis_rotated ? "rotate(-90)" : "").style("text-anchor", this.textAnchorForXAxisLabel.bind(this)), t.axes.y = n.append("g").attr("class", X.axis + " " + X.axisY).attr("clip-path", e.axis_y_inner ? "" : t.clipPathForYAxis).attr("transform", t.getTranslate("y")).style("visibility", e.axis_y_show ? "visible" : "hidden"), t.axes.y.append("text").attr("class", X.axisYLabel).attr("transform", e.axis_rotated ? "" : "rotate(-90)").style("text-anchor", this.textAnchorForYAxisLabel.bind(this)), t.axes.y2 = n.append("g").attr("class", X.axis + " " + X.axisY2).attr("transform", t.getTranslate("y2")).style("visibility", e.axis_y2_show ? "visible" : "hidden"), t.axes.y2.append("text").attr("class", X.axisY2Label).attr("transform", e.axis_rotated ? "" : "rotate(-90)").style("text-anchor", this.textAnchorForY2AxisLabel.bind(this))
        ...
        })), l.tickFormat(n).tickValues(i), s.isCategorized() && (l.tickCentered(u.axis_x_tick_centered), g(u.axis_x_tick_culling) && (u.axis_x_tick_culling = !1)), l
    }, a.updateXAxisTickValues = function(t, e) {
        var n, i = this.owner,
            r = i.config;
        return (r.axis_x_tick_fit || r.axis_x_tick_count) && (n = this.generateTickValues(i.mapTargetsToUniqueXs(t), r.axis_x_tick_count, i.isTimeSeries())), e ? e.tickValues(n) : (i.xAxis.tickValues(n), i.subXAxis.tickValues(n)), n
        ...
        return s.isTimeSeriesY() ? l.ticks(s.d3.time[u.axis_y_tick_time_value], u.axis_y_tick_time_interval) : l.tickValues(i), l
    }, a.getId = function(t) {
        ...
        var e = this.owner,
            n = e.config,
            i = e.isTimeSeries() ? e.defaultAxisTimeFormat : e.isCategorized() ? e.categoryName : function(t) {
                return t < 0 ? t.toFixed(0) : t
            };
        return n.axis_x_tick_format && (h(n.axis_x_tick_format) ? i = n.axis_x_tick_format : e.isTimeSeries() && (i = function(t) {
        ...
        c(i) ? "y" === t ? n.axis_y_label = e : "y2" === t ? n.axis_y2_label = e : "x" === t && (n.axis_x_label = e) : i && (i.text = e)
    }, a.getLabelPosition = function(t, e) {
        var n = this.getLabelOptionByAxisId(t),
            i = n && "object" === (void 0 === n ? "undefined" : s(n)) && n.position ? n.position : e;
        return {
        ...
        return P(r) ? "ratio" === t.unit ? t[e] * i : this.convertPixelsToAxisPadding(r, i) : n
        ...
        var i, r, a, o, s, u, c, l = t;
        if (e)
            if (1 === (i = h(e) ? e() : e)) l = [t[0]];
            else if (2 === i) l = [t[0], t[t.length - 1]];
        else if (2 < i) {
            for (o = i - 2, r = t[0], s = ((a = t[t.length - 1]) - r) / (o + 1), l = [r], u = 0; u < o; u++) c = +r + s * (u + 1), l.push(n ? new Date(c) : c);
            l.push(a)
        }
        ...
        var n = this.owner;
        n.axes.x.style("opacity", e ? 0 : 1), n.axes.y.style("opacity", e ? 0 : 1), n.axes.y2.style("opacity", e ? 0 : 1), n.axes.subx.style("opacity", e ? 0 : 1), t.axisX.call(n.xAxis), t.axisY.call(n.yAxis), t.axisY2.call(n.y2Axis), t.axisSubX.call(n.subXAxis)
    };
    var y, m, w = {
        version: "0.4.18",
        generate: function(t) {
    ...
    return w.chart = {
    ...
    }, y = w.chart.fn, (m = w.chart.internal.fn).beforeInit = function() {}, m.afterInit = function() {}, m.init = function() {
        var t = this,
            e = t.config;
        ...
        var n, i, r, a, o, s, u, c, l, h, d, f, g, p, x, _, v, y, m, w, S, b, A, T, P, C, L, M, E, V = this,
            ...
            z = V.xv.bind(V);
        if (n = H(t = t || {}, "withY", !0), i = H(t, "withSubchart", !0), r = H(t, "withTransition", !0), s = H(t, "withTransform", !1), u = H(t, "withUpdateXDomain", !1), c = H(t, "withUpdateOrgXDomain", !1), l = H(t, "withTrimXDomain", !0), g = H(t, "withUpdateXAxis", u), h = H(t, "withLegend", !1), d = H(t, "withEventRect", !0), f = H(t, "withDimension", !0), a = H(t, "withTransitionForExit", r), o = H(t, "withTransitionForAxis", r), m = r ? R.transition_duration : 0, w = a ? m : 0, S = o ? m : 0, e = e || V.axis.generateTransitions(S), h && R.legend_show ? V.updateLegend(V.mapToIds(V.data.targets), t, e) : f && V.updateDimension(!0), V.isCategorized() && 0 === F.length && V.x.domain([0, V.axes.x.selectAll(".tick").size()]), F.length ? (V.updateXDomain(F, u, c, l), R.axis_x_tick_values || (T = V.axis.updateXAxisTickValues(F))) : (V.xAxis.tickValues([]), V.subXAxis.tickValues([])), R.zoom_rescale && !t.flow && (L = V.x.orgDomain()), V.y.domain(V.getYDomain(F, "y", L)), V.y2.domain(V.getYDomain(F, "y2", L)), !R.axis_y_tick_values && R.axis_y_tick_count && V.yAxis.tickValues(V.axis.generateTickValues(V.y.domain(), R.axis_y_tick_count)), !R.axis_y2_tick_values && R.axis_y2_tick_count && V.y2Axis.tickValues(V.axis.generateTickValues(V.y2.domain(), R.axis_y2_tick_count)), V.axis.redraw(e, N), V.axis.updateLabels(r), (u || g) && F.length)
            ...
            } else V.svg.selectAll("." + X.axisX + " .tick text").style("display", "block");
        p = V.generateDrawArea ? V.generateDrawArea(O, !1) : void 0, x = V.generateDrawBar ? V.generateDrawBar(I) : void 0, _ = V.generateDrawLine ? V.generateDrawLine(D, !1) : void 0, v = V.generateXYForText(O, I, D, !0), y = V.generateXYForText(O, I, D, !1), n && (V.subY.domain(V.getYDomain(F, "y")), V.subY2.domain(V.getYDomain(F, "y2"))), V.updateXgridFocus(), G.select("text." + X.text + "." + X.empty).attr("x", V.width / 2).attr("y", V.height / 2).text(R.data_empty_label_text).transition().style("opacity", F.length ? 0 : 1), V.updateGrid(m), V.updateRegion(m), V.updateBar(w), V.updateLine(w), V.updateArea(w), V.updateCircle(), V.hasDataLabel() && V.updateText(w), V.redrawTitle && V.redrawTitle(), V.redrawArc && V.redrawArc(m, w, s), V.redrawSubchart && V.redrawSubchart(i, e, m, w, O, I, D), G.selectAll("." + X.selectedCircles).filter(V.isBarType.bind(V)).selectAll("circle").remove(), R.interaction_enabled && !t.flow && d && (V.redrawEventRect(), V.updateZoom && V.updateZoom()), V.updateCircleY(), M = (V.config.axis_rotated ? V.circleY : V.circleX).bind(V), E = (V.config.axis_rotated ? V.circleX : V.circleY).bind(V), t.flow && (A = V.generateFlow({
            targets: F,
            flow: t.flow,
            ...
            xForText: v,
            yForText: y
        })), (m || A) && V.isTabVisible() ? k.transition().duration(m).each(function() {
            var e = [];
            [V.redrawBar(x, !0), V.redrawLine(_, !0), V.redrawArea(p, !0), V.redrawCircle(M, E, !0), V.redrawText(v, y, t.flow, !0), V.redrawRegion(!0), V.redrawGrid(!0)].forEach(function(t) {
                t.forEach(function(t) {
                    e.push(t)
                })
            }), b = V.generateWait(), e.forEach(function(t) {
                b.add(t)
            })
        }).call(b, function() {
            A && A(), R.onrendered && R.onrendered.call(V)
        }) : (V.redrawBar(x), V.redrawLine(_), V.redrawArea(p), V.redrawCircle(M, E), V.redrawText(v, y, t.flow), V.redrawRegion(), V.redrawGrid(), R.onrendered && R.onrendered.call(V)), V.mapToIds(V.data.targets).forEach(function(t) {
            V.withoutFadeIn[t] = !0
        })
    }, m.updateAndRedraw = function(t) {
        var e, n = this,
            i = n.config;
        (t = t || {}).withTransition = H(t, "withTransition", !0), t.withTransform = H(t, "withTransform", !1), t.withLegend = H(t, "withLegend", !1), t.withUpdateXDomain = !0, t.withUpdateOrgXDomain = !0, t.withTransitionForExit = !1, t.withTransitionForTransform = H(t, "withTransitionForTransform", t.withTransition), n.updateSizes(), t.withLegend && i.legend_show || (e = n.axis.generateTransitions(t.withTransitionForAxis ? i.transition_duration : 0), n.updateScales(), n.updateSvgSize(), n.transformAll(t.withTransitionForTransform, e)), n.redraw(t, e)
        ...
        var e, n, i = this,
            r = i.config;
        return "main" === t ? (e = f(i.margin.left), n = f(i.margin.top)) : "context" === t ? (e = f(i.margin2.left), n = f(i.margin2.top)) : "legend" === t ? (e = i.margin3.left, n = i.margin3.top) : "x" === t ? (e = 0, n = r.axis_rotated ? 0 : i.height) : "y" === t ? (e = 0, n = r.axis_rotated ? i.height : 0) : "y2" === t ? (e = r.axis_rotated ? 0 : i.width, n = r.axis_rotated ? 1 : 0) : "subx" === t ? (e = 0, n = r.axis_rotated ? 0 : i.height2) : "arc" === t && (e = i.arcWidth / 2, n = i.arcHeight / 2), "translate(" + e + "," + n + ")"
        ...
        var n, i, r, a = this;
        e && e.axisX ? n = e.axisX : (n = a.main.select("." + X.axisX), t && (n = n.transition())), e && e.axisY ? i = e.axisY : (i = a.main.select("." + X.axisY), t && (i = i.transition())), e && e.axisY2 ? r = e.axisY2 : (r = a.main.select("." + X.axisY2), t && (r = r.transition())), (t ? a.main.transition() : a.main).attr("transform", a.getTranslate("main")), n.attr("transform", a.getTranslate("x")), i.attr("transform", a.getTranslate("y")), r.attr("transform", a.getTranslate("y2")), a.main.select("." + X.chartArcs).attr("transform", a.getTranslate("arc"))
        ...
        var n, i = this;
        "undefined" != typeof MutationObserver ? (n = new MutationObserver(function(t) {
            t.forEach(function(t) {
                "childList" === t.type && t.previousSibling && (n.disconnect(), i.intervalForObserveInserted = window.setInterval(function() {
                    e.node().parentNode && (window.clearInterval(i.intervalForObserveInserted), i.updateDimension(), i.brush && i.brush.update(), i.config.oninit.call(i), i.redraw({
                        withTransform: !0,
                        withUpdateXDomain: !0,
                        withUpdateOrgXDomain: !0,
                        withTransition: !1,
        ...
        if (t.resizeFunction = t.generateResize(), t.resizeFunction.add(function() {
            ...
            n ? n.add && n.remove || (n = t.generateResize()).add(window.onresize) : n = t.generateResize(), n.add(t.resizeFunction), window.onresize = n
        }
        ...
        var e;
        return t instanceof Date ? e = t : "string" == typeof t ? e = this.dataTimeFormat(this.config.data_xFormat).parse(t) : "object" === (void 0 === t ? "undefined" : s(t)) ? e = new Date(+t) : "number" != typeof t || isNaN(t) || (e = new Date(+t)), e && !isNaN(+e) || window.console.error("Failed to parse x '" + t + "' to Date object"), e
    ...
    }, m.isValue = P, m.isFunction = h, m.isString = c, m.isUndefined = l, m.isDefined = d, m.ceil10 = i, m.asHalfPixel = f, m.diffDomain = O, m.isEmpty = g, m.notEmpty = C, m.notEmpty = C, m.getOption = H, m.hasValue = p, m.sanitise = x, m.getPathBox = v, m.CLASS = X, Function.prototype.bind || (Function.prototype.bind = function(t) {
        ...
        n.prototype._isCurrentSpace = function() {
            ...
            if (this._skipOptionalSpaces(), this._currentIndex < this._endIndex && "+" == this._string.charAt(this._currentIndex) ? this._currentIndex++ : this._currentIndex < this._endIndex && "-" == this._string.charAt(this._currentIndex) && (this._currentIndex++, r = -1), !(this._currentIndex == this._endIndex || (this._string.charAt(this._currentIndex) < "0" || "9" < this._string.charAt(this._currentIndex)) && "." != this._string.charAt(this._currentIndex))) {
                ...
                if (this._currentIndex != s)
                    for (var u = this._currentIndex - 1, c = 1; s <= u;) e += c * (this._string.charAt(u--) - "0"), c *= 10;
                if (this._currentIndex < this._endIndex && "." == this._string.charAt(this._currentIndex)) {
                    if (++this._currentIndex >= this._endIndex || this._string.charAt(this._currentIndex) < "0" || "9" < this._string.charAt(this._currentIndex)) return;
                    for (; this._currentIndex < this._endIndex && "0" <= this._string.charAt(this._currentIndex) && this._string.charAt(this._currentIndex) <= "9";) n *= 10, i += (this._string.charAt(this._currentIndex) - "0") / n, this._currentIndex += 1
                }
            ...
            switch (this._previousCommand = e) {
                case window.SVGPathSeg.PATHSEG_MOVETO_REL:
                    return new window.SVGPathSegMovetoRel(i, this._parseNumber(), this._parseNumber());
                case window.SVGPathSeg.PATHSEG_MOVETO_ABS:
                    return new window.SVGPathSegMovetoAbs(i, this._parseNumber(), this._parseNumber());
                case window.SVGPathSeg.PATHSEG_LINETO_REL:
                    return new window.SVGPathSegLinetoRel(i, this._parseNumber(), this._parseNumber());
                case window.SVGPathSeg.PATHSEG_LINETO_ABS:
                    return new window.SVGPathSegLinetoAbs(i, this._parseNumber(), this._parseNumber());
                case window.SVGPathSeg.PATHSEG_LINETO_HORIZONTAL_REL:
                    return new window.SVGPathSegLinetoHorizontalRel(i, this._parseNumber());
                case window.SVGPathSeg.PATHSEG_LINETO_HORIZONTAL_ABS:
                    return new window.SVGPathSegLinetoHorizontalAbs(i, this._parseNumber());
                case window.SVGPathSeg.PATHSEG_LINETO_VERTICAL_REL:
                    return new window.SVGPathSegLinetoVerticalRel(i, this._parseNumber());
                case window.SVGPathSeg.PATHSEG_LINETO_VERTICAL_ABS:
                    return new window.SVGPathSegLinetoVerticalAbs(i, this._parseNumber());
                case window.SVGPathSeg.PATHSEG_CLOSEPATH:
                    return this._skipOptionalSpaces(), new window.SVGPathSegClosePath(i);
                case window.SVGPathSeg.PATHSEG_CURVETO_CUBIC_REL:
                    return n = {
                        ...
                        x: this._parseNumber(),
                        y: this._parseNumber()
                    }, new window.SVGPathSegCurvetoCubicRel(i, n.x, n.y, n.x1, n.y1, n.x2, n.y2);
                case window.SVGPathSeg.PATHSEG_CURVETO_CUBIC_ABS:
                    return n = {
                        ...
                        x: this._parseNumber(),
                        y: this._parseNumber()
                    }, new window.SVGPathSegCurvetoCubicAbs(i, n.x, n.y, n.x1, n.y1, n.x2, n.y2);
                case window.SVGPathSeg.PATHSEG_CURVETO_CUBIC_SMOOTH_REL:
                    return n = {
                        ...
                        x: this._parseNumber(),
                        y: this._parseNumber()
                    }, new window.SVGPathSegCurvetoCubicSmoothRel(i, n.x, n.y, n.x2, n.y2);
                case window.SVGPathSeg.PATHSEG_CURVETO_CUBIC_SMOOTH_ABS:
                    return n = {
                        ...
                        x: this._parseNumber(),
                        y: this._parseNumber()
                    }, new window.SVGPathSegCurvetoCubicSmoothAbs(i, n.x, n.y, n.x2, n.y2);
                case window.SVGPathSeg.PATHSEG_CURVETO_QUADRATIC_REL:
                    return n = {
                        ...
                        x: this._parseNumber(),
                        y: this._parseNumber()
                    }, new window.SVGPathSegCurvetoQuadraticRel(i, n.x, n.y, n.x1, n.y1);
                case window.SVGPathSeg.PATHSEG_CURVETO_QUADRATIC_ABS:
                    return n = {
                        ...
                        x: this._parseNumber(),
                        y: this._parseNumber()
                    }, new window.SVGPathSegCurvetoQuadraticAbs(i, n.x, n.y, n.x1, n.y1);
                case window.SVGPathSeg.PATHSEG_CURVETO_QUADRATIC_SMOOTH_REL:
                    return new window.SVGPathSegCurvetoQuadraticSmoothRel(i, this._parseNumber(), this._parseNumber());
                case window.SVGPathSeg.PATHSEG_CURVETO_QUADRATIC_SMOOTH_ABS:
                    return new window.SVGPathSegCurvetoQuadraticSmoothAbs(i, this._parseNumber(), this._parseNumber());
                case window.SVGPathSeg.PATHSEG_ARC_REL:
                    return n = {
                        ...
                        x: this._parseNumber(),
                        y: this._parseNumber()
                    }, new window.SVGPathSegArcRel(i, n.x, n.y, n.x1, n.y1, n.arcAngle, n.arcLarge, n.arcSweep);
                case window.SVGPathSeg.PATHSEG_ARC_ABS:
                    ...
                    return new window.SVGPathSegArcAbs(i, n.x, n.y, n.x1, n.y1, n.arcAngle, n.arcLarge, n.arcSweep);
                default:
    ...
    }), y.axis = function() {}, y.axis.labels = function(e) {
        var n = this.internal;
        ...
        "object" === (void 0 === t ? "undefined" : s(t)) ? (P(t.x) && (n.axis_x_max = t.x), P(t.y) && (n.axis_y_max = t.y), P(t.y2) && (n.axis_y2_max = t.y2)) : n.axis_y_max = n.axis_y2_max = t, e.redraw({
            withUpdateOrgXDomain: !0,
            withUpdateXDomain: !0
        })
        ...
        "object" === (void 0 === t ? "undefined" : s(t)) ? (P(t.x) && (n.axis_x_min = t.x), P(t.y) && (n.axis_y_min = t.y), P(t.y2) && (n.axis_y2_min = t.y2)) : n.axis_y_min = n.axis_y2_min = t, e.redraw({
            withUpdateOrgXDomain: !0,
            withUpdateXDomain: !0
        })
        ...
        var n = this.internal,
            i = n.config;
        return 1 < arguments.length && (i.axis_x_categories[t] = e, n.redraw()), i.axis_x_categories[t]
    }, y.categories = function(t) {
        var e = this.internal,
            n = e.config;
        return arguments.length && (n.axis_x_categories = t, e.redraw()), n.axis_x_categories
    }, y.resize = function(t) {
        ...
        var e = this.internal;
        if (window.clearInterval(e.intervalForObserveInserted), void 0 !== e.resizeTimeout && window.clearTimeout(e.resizeTimeout), window.detachEvent) window.detachEvent("onresize", e.resizeFunction);
        ...
        return e.selectChart.classed("c3", !1).html(""), Object.keys(e).forEach(function(t) {
            e[t] = null
        }), null
    }, y.color = function(t) {
        ...
        var r, e, n, i, a, o, s, u = this.internal,
            c = [],
            l = u.getMaxDataCount(),
            h = 0,
            d = 0;
        ...
        r = u.convertDataToTargets(e, !0), u.data.targets.forEach(function(t) {
            var e, n, i = !1;
            for (e = 0; e < r.length; e++)
                if (t.id === r[e].id) {
                    for (i = !0, t.values[t.values.length - 1] && (d = t.values[t.values.length - 1].index + 1), h = r[e].values.length, n = 0; n < h; n++) r[e].values[n].index = d + n, u.isTimeSeries() || (r[e].values[n].x = d + n);
            ...
            for (e = 0; e < c.length; e++)
                if (t.id === c[e])
                    for (d = t.values[t.values.length - 1].index + 1, n = 0; n < h; n++) t.values.push({
                        id: t.id,
                        index: d + n,
                        x: u.isTimeSeries() ? u.getOtherTargetX(d + n) : d + n,
                        value: null
                    })
        }), u.data.targets.length && r.forEach(function(t) {
            var e, n = [];
            for (e = u.data.targets[0].values[0].index; e < d; e++) n.push({
                id: t.id,
                index: e,
        ...
        }), u.data.targets = u.data.targets.concat(r), u.getMaxDataCount(), a = (i = u.data.targets[0]).values[0], void 0 !== t.to ? (h = 0, s = u.isTimeSeries() ? u.parseDate(t.to) : t.to, i.values.forEach(function(t) {
            t.x < s && h++
        })) : void 0 !== t.length && (h = t.length), l ? 1 === l && u.isTimeSeries() && (o = (i.values[i.values.length - 1].x - a.x) / 2, n = [new Date(+a.x - o), new Date(+a.x + o)], u.updateXDomain(null, !0, !0, !1, n)) : (o = u.isTimeSeries() ? 1 < i.values.length ? i.values[i.values.length - 1].x - a.x : a.x - u.getXDomain(u.data.targets)[0] : 1, n = [a.x - o, a.x], u.updateXDomain(null, !0, !0, !1, n)), u.updateTargets(u.data.targets), u.redraw({
            flow: {
                index: a.index,
                length: h,
        ...
        return function() {
            ...
            G.flowing = !0, G.data.targets.forEach(function(t) {
                t.values.splice(0, x)
            }), n = G.updateXDomain(r, !0, !0), G.updateXGrid && G.updateXGrid(!0), a.orgDataCount ? t = 1 === a.orgDataCount || (_ && _.x) === (v && v.x) ? G.x(y[0]) - G.x(n[0]) : G.isTimeSeries() ? G.x(y[0]) - G.x(n[0]) : G.x(_.x) - G.x(v.x) : 1 !== G.data.targets[0].values.length ? t = G.x(y[0]) - G.x(n[0]) : G.isTimeSeries() ? (_ = G.getValueOnIndex(G.data.targets[0].values, 0), v = G.getValueOnIndex(G.data.targets[0].values, G.data.targets[0].values.length - 1), t = G.x(_.x) - G.x(v.x)) : t = O(n) / 2, i = O(y) / O(n), e = "translate(" + t + ",0) scale(" + i + ",1)", G.hideXGridFocus(), R.transition().ease("linear").duration(m).each(function() {
                S.add(G.axes.x.transition().call(G.xAxis)), S.add(C.transition().attr("transform", e)), S.add(L.transition().attr("transform", e)), S.add(M.transition().attr("transform", e)), S.add(E.transition().attr("transform", e)), S.add(P.transition().attr("transform", e)), S.add(T.filter(G.isRegionOnX).transition().attr("transform", e)), S.add(b.transition().attr("transform", e)), S.add(A.transition().attr("transform", e))
            }).call(S, function() {
                var t, e = [],
                    n = [],
                    i = [];
                if (x) {
                    for (t = 0; t < x; t++) e.push("." + X.shape + "-" + (p + t)), n.push("." + X.text + "-" + (p + t)), i.push("." + X.eventRect + "-" + (p + t));
                    G.svg.selectAll("." + X.shapes).selectAll(e).remove(), G.svg.selectAll("." + X.texts).selectAll(n).remove(), G.svg.selectAll("." + X.eventRects).selectAll(i).remove(), G.svg.select("." + X.xgrid).remove()
                }
                b.attr("transform", null).attr(G.xgridAttr), A.attr("transform", null), A.select("line").attr("x1", k.axis_rotated ? 0 : h).attr("x2", k.axis_rotated ? G.width : h), A.select("text").attr("x", k.axis_rotated ? G.width : 0).attr("y", h), C.attr("transform", null).attr("d", o), L.attr("transform", null).attr("d", s), M.attr("transform", null).attr("d", u), E.attr("transform", null).attr("cx", c).attr("cy", l), P.attr("transform", null).attr("x", d).attr("y", f).style("fill-opacity", G.opacityForText.bind(G)), T.attr("transform", null), T.select("rect").filter(G.isRegionOnX).attr("x", G.regionX.bind(G)).attr("width", G.regionWidth.bind(G)), k.interaction_enabled && G.redrawEventRect(), w(), G.flowing = !1
            })
        }
    }, y.focus = function(e) {
        var t, n = this.internal;
        e = n.mapToTargetIds(e), t = n.svg.selectAll(n.selectorTargets(e.filter(n.isTargetToShow, n))), this.revert(), this.defocus(), t.classed(X.focused, !0).classed(X.defocused, !1), n.hasArcType() && n.expandArc(e), n.toggleFocusLegend(e, !0), n.focusedTargetIds = e, n.defocusedTargetIds = n.defocusedTargetIds.filter(function(t) {
            return e.indexOf(t) < 0
        })
    }, y.defocus = function(e) {
        var t = this.internal;
        e = t.mapToTargetIds(e), t.svg.selectAll(t.selectorTargets(e.filter(t.isTargetToShow, t))).classed(X.focused, !1).classed(X.defocused, !0), t.hasArcType() && t.unexpandArc(e), t.toggleFocusLegend(e, !1), t.focusedTargetIds = t.focusedTargetIds.filter(function(t) {
            return e.indexOf(t) < 0
        }), t.defocusedTargetIds = e
    }, y.revert = function(t) {
        var e = this.internal;
        t = e.mapToTargetIds(t), e.svg.selectAll(e.selectorTargets(t)).classed(X.focused, !1).classed(X.defocused, !1), e.hasArcType() && e.unexpandArc(t), e.config.legend_show && (e.showLegend(t.filter(e.isLegendToShow.bind(e))), e.legend.selectAll(e.selectorLegends(t)).filter(function() {
            return e.d3.select(this).classed(X.legendItemFocused)
        }).classed(X.legendItemFocused, !1)), e.focusedTargetIds = [], e.defocusedTargetIds = []
    }, y.xgrids = function(t) {
        var e = this.internal,
            n = e.config;
        return t && (n.grid_x_lines = t, e.redrawWithoutRescale()), n.grid_x_lines
        ...
        var e = this.internal,
            n = e.config;
        return t && (n.grid_y_lines = t, e.redrawWithoutRescale()), n.grid_y_lines
    ...
    }, y.legend = function() {}, y.legend.show = function(t) {
        var e = this.internal;
        ...
        var t = this.internal,
            n = t.config;
        e.xs && t.addXs(e.xs), "names" in e && y.data.names.bind(this)(e.names), "classes" in e && Object.keys(e.classes).forEach(function(t) {
        ...
        var e = this.internal,
            n = e.config;
        return t && (n.regions = n.regions.concat(t), e.redrawWithoutRescale()), n.regions
    }, y.regions.remove = function(t) {
        var e, n, i, r = this.internal,
            a = r.config;
        return t = t || {}, e = r.getOption(t, "duration", a.transition_duration), n = r.getOption(t, "classes", [X.region]), i = r.main.select("." + X.regions).selectAll(n.map(function(t) {
            return "." + t
        ...
        var e = this.internal,
            n = e.d3;
        return n.merge(e.main.selectAll("." + X.shapes + e.getTargetSelectorSuffix(t)).selectAll("." + X.shape).filter(function() {
        ...
        var h = this.internal,
            d = h.d3,
            f = h.config;
        f.data_selection_enabled && h.main.selectAll("." + X.shapes).selectAll("." + X.shape).each(function(t, e) {
            var n = d.select(this),
            ...
            n.classed(X.line) || n.classed(X.area) || (a && o ? f.data_selection_isselectable(t) && !s && r(!0, n.classed(X.SELECTED, !0), t, e) : void 0 !== l && l && s && r(!1, n.classed(X.SELECTED, !1), t, e))
        })
    }, y.unselect = function(u, c) {
        var l = this.internal,
            h = l.d3,
            d = l.config;
        d.data_selection_enabled && l.main.selectAll("." + X.shapes).selectAll("." + X.shape).each(function(t, e) {
            var n = h.select(this),
                i = t.data ? t.data.id : t.id,
                ...
                o = !c || 0 <= c.indexOf(e),
                s = n.classed(X.SELECTED);
            n.classed(X.line) || n.classed(X.area) || a && o && d.data_selection_isselectable(t) && s && r(!1, n.classed(X.SELECTED, !1), t, e)
        })
    }, y.show = function(t, e) {
        var n, i = this.internal;
        t = i.mapToTargetIds(t), e = e || {}, i.removeHiddenTargetIds(t), (n = i.svg.selectAll(i.selectorTargets(t))).transition().style("opacity", 1, "important").call(i.endall, function() {
        ...
        var n, i = this.internal;
        t = i.mapToTargetIds(t), e = e || {}, i.addHiddenTargetIds(t), (n = i.svg.selectAll(i.selectorTargets(t))).transition().style("opacity", 0, "important").call(i.endall, function() {
    ...
    }, y.tooltip = function() {}, y.tooltip.show = function(t) {
        ...
        a.withTransitionForTransform = !1, i.transiting = !1, i.setTargetType(t, e), i.updateTargets(i.data.targets), i.updateAndRedraw(a)
    }, y.x = function(t) {
        var e = this.internal;
        ...
        t.radiusExpanded = Math.min(t.arcWidth, t.arcHeight) / 2, t.radius = .95 * t.radiusExpanded, t.innerRadiusRatio = n ? (t.radius - n) / t.radius : .6, t.innerRadius = t.hasType("donut") || t.hasType("gauge") ? t.radius * t.innerRadiusRatio : 0
        ...
        return o ? (a.pie(a.filterTargetsToShow(a.data.targets)).forEach(function(t) {
            s || t.data.id !== e.data.id || (s = !0, (e = t).index = u), u++
        }), isNaN(e.startAngle) && (e.startAngle = 0), isNaN(e.endAngle) && (e.endAngle = e.startAngle), a.isGaugeType(e.data) && (t = o.gauge_min, n = o.gauge_max, i = Math.PI * (o.gauge_fullCircle ? 2 : 1) / (n - t), r = e.value < t ? 0 : e.value < n ? e.value - t : n - t, e.startAngle = o.gauge_startingAngle, e.endAngle = e.startAngle + i * r), s ? e : null) : null
        ...
        var n = this,
            i = n.d3.svg.arc().outerRadius(n.radiusExpanded * (t || 1)).innerRadius(n.innerRadius);
        return function(t) {
        ...
        var e, n, i, r, a, o = this,
            ...
            u = o.updateAngle(t),
            c = "";
        return u && !o.hasType("gauge") && (e = this.svgArc.centroid(u), n = isNaN(e[0]) ? 0 : e[0], i = isNaN(e[1]) ? 0 : e[1], r = Math.sqrt(n * n + i * i), c = "translate(" + n * (a = o.hasType("donut") && s.donut_label_ratio ? h(s.donut_label_ratio) ? s.donut_label_ratio(t, o.radius, r) : s.donut_label_ratio : o.hasType("pie") && s.pie_label_ratio ? h(s.pie_label_ratio) ? s.pie_label_ratio(t, o.radius, r) : s.pie_label_ratio : o.radius && r ? (.375 < 36 / o.radius ? 1.175 - 36 / o.radius : .8) * o.radius / r : 0) + "," + i * a + ")"), c
        ...
        var e, n, i, r, a, o = this;
        return o.shouldShowArcLabel() ? (n = (e = o.updateAngle(t)) ? e.value : null, i = o.getArcRatio(e), r = t.data.id, o.hasType("gauge") || o.meetsArcLabelThreshold(i) ? (a = o.getArcLabelFormat()) ? a(n, i, r) : o.defaultArcValueFormat(n, i) : "") : ""
        ...
        n.transiting ? e = window.setInterval(function() {
            n.transiting || (window.clearInterval(e), 0 < n.legend.selectAll(".c3-legend-item-focused").size() && n.expandArc(t))
        }, 10) : (t = n.mapToTargetIds(t), n.svg.selectAll(n.selectorTargets(t, "." + X.chartArc)).each(function(t) {
        ...
        var e = this;
        e.transiting || (t = e.mapToTargetIds(t), e.svg.selectAll(e.selectorTargets(t, "." + X.chartArc)).selectAll("path").transition().duration(function(t) {
            return e.expandDuration(t.data.id)
        }).attr("d", e.svgArc), e.svg.selectAll("." + X.arc))
        ...
        (e = i.select("." + X.chartArcs).selectAll("." + X.chartArc).data(n.pie(t)).attr("class", function(t) {
            return r(t) + o(t.data)
        ...
        var t = this;
        t.arcs = t.main.select("." + X.chart).append("g").attr("class", X.chartArcs).attr("transform", t.getTranslate("arc")), t.arcs.append("text").attr("class", X.chartArcsTitle).style("text-anchor", "middle").text(t.getArcTitle())
    }, m.redrawArc = function(t, e, n) {
        var i, r = this,
            a = r.d3,
            o = r.config,
            s = r.main;
        (i = s.selectAll("." + X.arcs).selectAll("." + X.arc).data(r.arcData.bind(r))).enter().append("path").attr("class", r.classArc.bind(r)).style("fill", function(t) {
            ...
            var e, n;
            r.transiting || (e = r.updateAngle(t)) && (n = r.convertToArcData(e), r.expandArc(e.data.id), r.api.focus(e.data.id), r.toggleFocusLegend(e.data.id, !0), r.config.data_onmouseover(n, this))
            ...
            var e, n;
            r.transiting || (e = r.updateAngle(t)) && (n = r.convertToArcData(e), r.unexpandArc(e.data.id), r.api.revert(), r.revertLegend(), r.hideTooltip(), r.config.data_onmouseout(n, this))
            ...
            r.transiting = !0
        }).transition().duration(t).attrTween("d", function(n) {
            var i, t = r.updateAngle(n);
            return t ? (isNaN(this._current.startAngle) && (this._current.startAngle = 0), isNaN(this._current.endAngle) && (this._current.endAngle = this._current.startAngle), i = a.interpolate(this._current, t), this._current = i(0), function(t) {
                var e = i(t);
            ...
            r.transiting = !1
        }), i.exit().transition().duration(e).style("opacity", 0).remove(), s.selectAll("." + X.chartArc).select("text").style("opacity", 0).attr("class", function(t) {
        ...
        }), s.select("." + X.chartArcsTitle).style("opacity", r.hasType("donut") || r.hasType("gauge") ? 1 : 0), r.hasType("gauge") && (r.arcs.select("." + X.chartArcsBackground).attr("d", function() {
            var t = {
                data: [{
                    value: o.gauge_max
                }],
        ...
        return this.generateClass(X.region, e) + " " + ("class" in t ? t.class : "")
        ...
        var e = this.config.data_classes[t],
            n = "";
        return e && (n = " " + X.target + "-" + e), this.generateClass(X.target, t) + n
        ...
        return " " + (0 <= this.defocusedTargetIds.indexOf(t.id) ? X.defocused : "")
        ...
        return function(t) {
            ...
            return i[n] instanceof Function ? e = i[n](t) : i[n] ? e = i[n] : (o.indexOf(n) < 0 && o.push(n), e = r[o.indexOf(n) % r.length], i[n] = e), a instanceof Function ? a(e, t) : e
        }
    ...
    }, m.additionalConfig = {}, m.loadConfig = function(e) {
        var n, i, r, a = this.config;
        Object.keys(a).forEach(function(t) {
            n = e, i = t.split("_"), void 0 !== (r = function t() {
                var e = i.shift();
                return e && n && "object" === (void 0 === n ? "undefined" : s(n)) && e in n ? (n = n[e], t()) : e ? void 0 : n
            }()) && (a[t] = r)
        })
        ...
        n && Object.keys(n).forEach(function(t) {
            ...
            var n, i = e.response || e.responseText;
            if (!e) throw new Error(t.responseURL + " " + t.status + " (" + t.statusText + ")");
            n = "json" === s ? o.convertJsonToData(JSON.parse(i), r) : "tsv" === s ? o.convertTsvToData(i) : o.convertCsvToData(i), a.call(o, n)
        })
        ...
        var r, n, a = this,
            o = [];
        return t ? (t.x ? (r = t.value.concat(t.x), a.config.data_x = t.x) : r = t.value, o.push(r), e.forEach(function(n) {
            var i = [];
            r.forEach(function(t) {
                var e = a.findValueInJson(n, t);
                l(e) && (e = null), i.push(e)
            }), o.push(i)
        }), n = a.convertRowsToData(o)) : (Object.keys(e).forEach(function(t) {
            o.push([t].concat(e[t]))
        }), n = a.convertColumnsToData(o)), n
        ...
        for (var e = [], n = t[0], i = 1; i < t.length; i++) {
            for (var r = {}, a = 0; a < t[i].length; a++) {
                if (void 0 === t[i][a]) throw new Error("Source data is missing a component at (" + i + "," + a + ")!");
                r[n[a]] = t[i][a]
            }
            e.push(r)
        }
        ...
        for (var e = [], n = 0; n < t.length; n++)
            for (var i = t[n][0], r = 1; r < t[n].length; r++) {
                if (void 0 === e[r - 1] && (e[r - 1] = {}), void 0 === t[n][r]) throw new Error("Source data is missing a component at (" + n + "," + r + ")!");
                e[r - 1][i] = t[n][r]
            }
        return e
        ...
        return n.forEach(function(n) {
            var e = u.getXKey(n);
            u.isCustomX() || u.isTimeSeries() ? 0 <= r.indexOf(e) ? u.data.xs[n] = (i && u.data.xs[n] ? u.data.xs[n] : []).concat(t.map(function(t) {
                return t[e]
            }).filter(P).map(function(t, e) {
                return u.generateTargetX(t, n, e)
            })) : c.data_x ? u.data.xs[n] = u.getOtherTargetXs() : C(c.data_xs) && (u.data.xs[n] = u.getXValuesOfXKey(e, u.data.targets)) : u.data.xs[n] = t.map(function(t, e) {
                return e
            })
        }), n.forEach(function(t) {
            if (!u.data.xs[t]) throw new Error('x is not defined for id = "' + t + '".')
            ...
            return {
                ...
                values: t.map(function(t, e) {
                    var n, i = t[u.getXKey(a)],
                        r = null === t[a] || isNaN(t[a]) ? null : +t[a];
                    return u.isCustomX() && u.isCategorized() && void 0 !== i ? (0 === o && 0 === e && (c.axis_x_categories = []), -1 === (n = c.axis_x_categories.indexOf(i)) && (n = c.axis_x_categories.length, c.axis_x_categories.push(i))) : n = u.generateTargetX(i, a, e), (void 0 === t[a] || u.data.xs[a].length <= e) && (n = void 0), {
                        x: n,
                        value: r,
                        id: s
                    }
        ...
        }), u.hasNegativeValue = u.hasNegativeValueInTargets(e), u.hasPositiveValue = u.hasPositiveValueInTargets(e), c.data_type && u.setTargetType(u.mapToIds(e).filter(function(t) {
            return !(t in c.data_types)
        }), c.data_type), e.forEach(function(t) {
        ...
        var n, i = this;
        return (t && C(t) ? i.mapToIds(t) : []).forEach(function(t) {
        ...
        return 1 < this.d3.set(Object.keys(e).map(function(t) {
            return e[t]
        })).size()
    }, m.isMultipleX = function() {
        return C(this.config.data_xs) || !this.config.data_xSort || this.hasType("scatter")
        ...
        var i = this;
        return i.isTimeSeries() ? t ? i.parseDate(t) : i.parseDate(i.getXValue(e, n)) : i.isCustomX() && !i.isCategorized() ? P(t) ? +t : i.getXValue(e, n) : n
        ...
        var e, n = t.length,
            i = 0;
        return 1 < n ? t.forEach(function(t) {
        ...
        return t.forEach(function(e) {
            n[e.id] = [], e.values.forEach(function(t) {
                n[e.id].push(t.value)
            })
        }), n
        ...
        return t.filter(function(t) {
            ...
            var e = r.main.select("." + X.bars + r.getTargetSelectorSuffix(t.id) + " ." + X.bar + "-" + t.index).node();
        ...
        var r = this;
        n && (i.filter && (n = n.filter(i.filter)), (i.type || i.types) && n.forEach(function(t) {
        ...
        }), r.data.targets = r.data.targets.concat(n)), r.updateTargets(r.data.targets), r.redraw({
            withUpdateOrgXDomain: !0,
            withUpdateXDomain: !0,
            withLegend: !0
        }), i.done && i.done()
        ...
        var n = this;
        e.data ? n.load(n.convertDataToTargets(e.data), e) : e.url ? n.convertUrlToData(e.url, e.mimeType, e.headers, e.keys, function(t) {
            n.load(n.convertDataToTargets(t), e)
        }) : e.json ? n.load(n.convertDataToTargets(n.convertJsonToData(e.json, e.keys)), e) : e.rows ? n.load(n.convertDataToTargets(n.convertRowsToData(e.rows)), e) : e.columns ? n.load(n.convertDataToTargets(n.convertColumnsToData(e.columns)), e) : n.load(null, e)
        ...
        })).transition().style("opacity", 0).remove().call(n.endall, e), t.forEach(function(e) {
            n.withoutFadeIn[e] = !1, n.legend && n.legend.selectAll("." + X.legendItem + n.getTargetSelectorSuffix(e)).remove(), n.data.targets = n.data.targets.filter(function(t) {
                return t.id !== e
            })
        })) : e()
        ...
        if (0 < u.data_groups.length)
            for (o = s.hasNegativeValueInTargets(t), e = 0; e < u.data_groups.length; e++)
                if (0 !== (r = u.data_groups[e].filter(function(t) {
                        return 0 <= c.indexOf(t)
                    })).length)
                    for (i = r[0], o && l[i] && l[i].forEach(function(t, e) {
                            l[i][e] = t < 0 ? t : 0
                        }), n = 1; n < r.length; n++) a = r[n], l[a] && l[a].forEach(function(t, e) {
                        s.axis.getId(a) !== s.axis.getId(i) || !l[i] || o && 0 < +t || (l[i][e] += +t)
                    });
        ...
        var e, n, i, r, a, o, s = this,
            ...
            l = s.getValuesAsIdKeyed(t);
        if (0 < u.data_groups.length)
            for (o = s.hasPositiveValueInTargets(t), e = 0; e < u.data_groups.length; e++)
                if (0 !== (r = u.data_groups[e].filter(function(t) {
                        return 0 <= c.indexOf(t)
                    })).length)
                    for (i = r[0], o && l[i] && l[i].forEach(function(t, e) {
        ...
        var i, r, a, o, s, u, c, l, h, d, f = this,
            g = f.config,
            ...
            S = f.hasType("bar", x) && g.bar_zerobased || f.hasType("area", x) && g.area_zerobased,
            b = "y2" === e ? g.axis_y2_inverted : g.axis_y_inverted,
            A = f.hasDataLabel() && g.axis_rotated,
            T = f.hasDataLabel() && !g.axis_rotated;
        return y = P(_) ? _ : P(v) ? y < v ? y : v - 10 : y, m = P(v) ? v : P(_) ? _ < m ? m : _ + 10 : m, 0 === x.length ? "y2" === e ? f.y2.domain() : f.y.domain() : (isNaN(y) && (y = 0), isNaN(m) && (m = y), y === m && (y < 0 ? m = 0 : y = 0), h = 0 <= y && 0 <= m, d = y <= 0 && m <= 0, (P(_) && h || P(v) && d) && (S = !1), S && (h && (y = 0), d && (m = 0)), a = o = .1 * (r = Math.abs(m - y)), void 0 !== w && (m = w + (s = Math.max(Math.abs(y), Math.abs(m))), y = w - s), A ? (u = f.getDataLabelLength(y, m, "width"), c = O(f.y.range()), a += r * ((l = [u[0] / c, u[1] / c])[1] / (1 - l[0] - l[1])), o += r * (l[0] / (1 - l[0] - l[1]))) : T && (u = f.getDataLabelLength(y, m, "height"), a += f.axis.convertPixelsToAxisPadding(u[1], r), o += f.axis.convertPixelsToAxisPadding(u[0], r)), "y" === e && C(g.axis_y_padding) && (a = f.axis.getPadding(g.axis_y_padding, "top", a, r), o = f.axis.getPadding(g.axis_y_padding, "bottom", o, r)), "y2" === e && C(g.axis_y2_padding) && (a = f.axis.getPadding(g.axis_y2_padding, "top", a, r), o = f.axis.getPadding(g.axis_y2_padding, "bottom", o, r)), S && (h && (o = y), d && (a = -m)), i = [y - o, m + a], b ? i.reverse() : i)
    }, m.getXDomainMin = function(t) {
        var e = this,
            n = e.config;
        return void 0 !== n.axis_x_min ? e.isTimeSeries() ? this.parseDate(n.axis_x_min) : n.axis_x_min : e.d3.min(t, function(t) {
        ...
        var e = this,
            n = e.config;
        return void 0 !== n.axis_x_max ? e.isTimeSeries() ? this.parseDate(n.axis_x_max) : n.axis_x_max : e.d3.max(t, function(t) {
            return e.d3.max(t.values, function(t) {
                return t.x
            })
        })
    }, m.getXDomainPadding = function(t) {
        var e, n, i, r, a = this.config,
            o = t[1] - t[0];
        return n = this.isCategorized() ? 0 : this.hasType("bar") ? 1 < (e = this.getMaxDataCount()) ? o / (e - 1) / 2 : .5 : .01 * o, "object" === s(a.axis_x_padding) && C(a.axis_x_padding) ? (i = P(a.axis_x_padding.left) ? a.axis_x_padding.left : n, r = P(a.axis_x_padding.right) ? a.axis_x_padding.right : n) : i = r = "number" == typeof a.axis_x_padding ? a.axis_x_padding : n, {
            left: i,
            right: r
        }
        ...
        var e = this,
            ...
            o = 0,
            s = 0;
        return i - r != 0 || e.isCategorized() || (e.isTimeSeries() ? (i = new Date(.5 * i.getTime()), r = new Date(1.5 * r.getTime())) : (i = 0 === i ? 1 : .5 * i, r = 0 === r ? -1 : 1.5 * r)), (i || 0 === i) && (o = e.isTimeSeries() ? new Date(i.getTime() - a.left) : i - a.left), (r || 0 === r) && (s = e.isTimeSeries() ? new Date(r.getTime() + a.right) : r + a.right), [o, s]
    }, m.updateXDomain = function(t, e, n, i, r) {
        var a = this,
            o = a.config;
        return n && (a.x.domain(r || a.d3.extent(a.getXDomain(t))), a.orgXDomain = a.x.domain(), o.zoom_enabled && a.zoom.scale(a.x).updateScaleExtent(), a.subX.domain(a.x.domain()), a.brush && a.brush.scale(a.subX)), e && (a.x.domain(r || (!a.brush || a.brush.empty() ? a.orgXDomain : a.brush.extent())), o.zoom_enabled && a.zoom.scale(a.x).updateScaleExtent()), i && a.x.domain(a.trimXDomain(a.x.orgDomain())), a.x.domain()
    }, m.trimXDomain = function(t) {
        var e = this.getZoomDomain(),
            n = e[0],
            i = e[1];
        return t[0] <= n && (t[1] = +t[1] + (n - t[0]), t[0] = n), i <= t[1] && (t[0] = +t[0] - (t[1] - i), t[1] = i), t
    }, m.drag = function(t) {
        var e, n, i, r, d, f, g, p, x = this,
            a = x.config,
            o = x.main,
            _ = x.d3;
        x.hasArcType() || a.data_selection_enabled && (a.zoom_enabled && !x.zoom.altDomain || a.data_selection_multiple && (e = x.dragStart[0], n = x.dragStart[1], i = t[0], r = t[1], d = Math.min(e, i), f = Math.max(e, i), g = a.data_selection_grouped ? x.margin.top : Math.min(n, r), p = a.data_selection_grouped ? x.height : Math.max(n, r), o.select("." + X.dragarea).attr("x", d).attr("y", g).attr("width", f - d).attr("height", p - g), o.selectAll("." + X.shapes).selectAll("." + X.shape).filter(function(t) {
            return a.data_selection_isselectable(t)
        }).each(function(t, e) {
            var n, i, r, a, o, s, u = _.select(this),
                c = u.classed(X.SELECTED),
                l = u.classed(X.INCLUDED),
                h = !1;
            if (u.classed(X.circle)) n = 1 * u.attr("cx"), i = 1 * u.attr("cy"), o = x.togglePoint, h = d < n && n < f && g < i && i < p;
            else {
                if (!u.classed(X.bar)) return;
                n = (s = v(this)).x, i = s.y, r = s.width, a = s.height, o = x.togglePath, h = !(f < n || n + r < d || p < i || i + a < g)
            }
            h ^ l && (u.classed(X.INCLUDED, !l), u.classed(X.SELECTED, !c), o.call(x, !c, u, t, e))
        })))
    }, m.dragstart = function(t) {
        var e = this,
            n = e.config;
        e.hasArcType() || n.data_selection_enabled && (e.dragStart = t, e.main.select("." + X.chart).append("rect").attr("class", X.dragarea).style("opacity", .1), e.dragging = !0)
    }, m.dragend = function() {
        var t = this,
            e = t.config;
        t.hasArcType() || e.data_selection_enabled && (t.main.select("." + X.dragarea).transition().duration(100).style("opacity", 0).remove(), t.main.selectAll("." + X.shape).classed(X.INCLUDED, !1), t.dragging = !1)
        ...
        return "function" == typeof e.format ? e.format : "object" === s(e.format) ? e.format[t] ? !0 === e.format[t] ? n : e.format[t] : function() {
            return ""
        } : n
    }, m.initGrid = function() {
        var t = this,
        ...
        var t = this,
            e = t.d3;
        t.gridLines = t.main.append("g").attr("clip-path", t.clipPathForGrid).attr("class", X.grid + " " + X.gridLines), t.gridLines.append("g").attr("class", X.xgridLines), t.gridLines.append("g").attr("class", X.ygridLines), t.xgridLines = e.selectAll([])
        ...
        e.xgridAttr = n.axis_rotated ? {
            ...
            y1: 0,
            y2: e.height
        }, e.xgrid = e.main.select("." + X.xgrids).selectAll("." + X.xgrid).data(r), e.xgrid.enter().append("line").attr("class", X.xgrid), t || e.xgrid.attr(e.xgridAttr).style("opacity", function() {
        ...
        t.ygrid = t.main.select("." + X.ygrids).selectAll("." + X.ygrid).data(n), t.ygrid.enter().append("line").attr("class", X.ygrid), t.ygrid.attr("x1", e.axis_rotated ? t.y : 0).attr("x2", e.axis_rotated ? t.y : t.width).attr("y1", e.axis_rotated ? 0 : t.y).attr("y2", e.axis_rotated ? t.height : t.y), t.ygrid.exit().remove(), t.smoothLines(t.ygrid, "grid")
        ...
        var e = this,
            ...
            a = e.xx.bind(e);
        n.tooltip_show && (e.hasType("scatter") || e.hasArcType() || (r.style("visibility", "visible").data([i[0]]).attr(n.axis_rotated ? "y1" : "x1", a).attr(n.axis_rotated ? "y2" : "x2", a), e.smoothLines(r, "grid")))
    }, m.hideXGridFocus = function() {
        this.main.select("line." + X.xgridFocus).style("visibility", "hidden")
    }, m.updateXgridFocus = function() {
        var t = this.config;
        this.main.select("line." + X.xgridFocus).attr("x1", t.axis_rotated ? 0 : -10).attr("x2", t.axis_rotated ? this.width : -10).attr("y1", t.axis_rotated ? -10 : 0).attr("y2", t.axis_rotated ? -10 : this.height)
    }, m.generateGridData = function(t, e) {
        var n, i, r, a, o = [],
            s = this.main.select("." + X.axisX).selectAll(".tick").size();
        if ("year" === t)
            for (i = (n = this.getXDomain())[0].getFullYear(), r = n[1].getFullYear(), a = i; a <= r; a++) o.push(new Date(a + "-01-01 00:00:00"));
        ...
        this.main.select("." + a).selectAll("." + o).filter(i).transition().duration(n.transition_duration).style("opacity", 0).remove(), e ? n.grid_x_lines = n.grid_x_lines.filter(r) : n.grid_y_lines = n.grid_y_lines.filter(r)
    }, m.initEventRect = function() {
        this.main.select("." + X.chart).append("g").attr("class", X.eventRects).style("fill-opacity", 0)
    }, m.redrawEventRect = function() {
        var t, e, n = this,
            i = n.config,
            r = n.isMultipleX(),
            a = n.main.select("." + X.eventRects).style("cursor", i.zoom_enabled ? i.axis_rotated ? "ns-resize" : "ew-resize" : null).classed(X.eventRectsMultiple, r).classed(X.eventRectsSingle, !r);
        a.selectAll("." + X.eventRect).remove(), n.eventRect = a.selectAll("." + X.eventRect), r ? (t = n.eventRect.data([0]), n.generateEventRectsForMultipleXs(t.enter()), n.updateEventRect(t)) : (e = n.getMaxDataCountTarget(n.data.targets), a.datum(e ? e.values : []), n.eventRect = a.selectAll("." + X.eventRect), t = n.eventRect.data(function(t) {
            return t
        ...
        t = t || s.eventRect.data(function(t) {
            return t
        }), s.isMultipleX() ? (n = e = 0, i = s.width, r = s.height) : (!s.isCustomX() && !s.isTimeSeries() || s.isCategorized() ? (a = s.getEventRectWidth(), o = function(t) {
            return s.x(t.x) - a / 2
        }) : (s.updateXs(), a = function(t) {
            var e = s.getPrevX(t.index),
                n = s.getNextX(t.index);
            return null === e && null === n ? u.axis_rotated ? s.height : s.width : (null === e && (e = s.x.domain()[0]), null === n && (n = s.x.domain()[1]), Math.max(0, (s.x(n) - s.x(e)) / 2))
        }, o = function(t) {
            var e = s.getPrevX(t.index),
                n = s.getNextX(t.index),
        ...
        var r = this,
            a = r.d3,
            o = r.config;
        t.append("rect").attr("class", r.classEvent.bind(r)).style("cursor", o.data_selection_enabled && o.data_selection_grouped ? "pointer" : null).on("mouseover", function(t) {
            var e = t.index;
            r.dragging || r.flowing || r.hasArcType() || (o.point_focus_expand_enabled && r.expandCircles(e, null, !0), r.expandBars(e, null, !0), r.main.selectAll("." + X.shape + "-" + e).each(function(t) {
                o.data_onmouseover.call(r.api, t)
            }))
        }).on("mouseout", function(t) {
            var e = t.index;
            r.config && (r.hasArcType() || (r.hideXGridFocus(), r.hideTooltip(), r.unexpandCircles(), r.unexpandBars(), r.main.selectAll("." + X.shape + "-" + e).each(function(t) {
                o.data_onmouseout.call(r.api, t)
            })))
        }).on("mousemove", function(t) {
            var e, n = t.index,
                i = r.svg.select("." + X.eventRect + "-" + n);
            r.dragging || r.flowing || r.hasArcType() || (r.isStepType(t) && "step-after" === r.config.line_step_type && a.mouse(this)[0] < r.x(r.getXValue(t.id, n)) && (n -= 1), e = r.filterTargetsToShow(r.data.targets).map(function(t) {
                return r.addName(r.getValueOnIndex(t.values, n))
            }), o.tooltip_grouped && (r.showTooltip(e, this), r.showXGridFocus(e)), (!o.tooltip_grouped || o.data_selection_enabled && !o.data_selection_grouped) && r.main.selectAll("." + X.shape + "-" + n).each(function() {
                a.select(this).classed(X.EXPANDED, !0), o.data_selection_enabled && i.style("cursor", o.data_selection_grouped ? "pointer" : null), o.tooltip_grouped || (r.hideXGridFocus(), r.hideTooltip(), o.data_selection_grouped || (r.unexpandCircles(n), r.unexpandBars(n)))
            }).filter(function(t) {
                return r.isWithinShape(this, t)
            }).each(function(t) {
                o.data_selection_enabled && (o.data_selection_grouped || o.data_selection_isselectable(t)) && i.style("cursor", "pointer"), o.tooltip_grouped || (r.showTooltip([t], this), r.showXGridFocus([t]), o.point_focus_expand_enabled && r.expandCircles(n, t.id, !0), r.expandBars(n, t.id, !0))
            }))
        }).on("click", function(t) {
            var e = t.index;
            !r.hasArcType() && r.toggleShape && (r.cancelClick ? r.cancelClick = !1 : (r.isStepType(t) && "step-after" === o.line_step_type && a.mouse(this)[0] < r.x(r.getXValue(t.id, e)) && (e -= 1), r.main.selectAll("." + X.shape + "-" + e).each(function(t) {
                (o.data_selection_grouped || r.isWithinShape(this, t)) && (r.toggleShape(this, t, e), r.config.data_onclick.call(r.api, t, this))
            })))
        }).call(o.data_selection_draggable && r.drag ? a.behavior.drag().origin(Object).on("drag", function() {
            r.drag(a.mouse(this))
        ...
        function r() {
            a.svg.select("." + X.eventRect).style("cursor", null), a.hideXGridFocus(), a.hideTooltip(), a.unexpandCircles(), a.unexpandBars()
        }
        var a = this,
            o = a.d3,
            s = a.config;
        t.append("rect").attr("x", 0).attr("y", 0).attr("width", a.width).attr("height", a.height).attr("class", X.eventRect).on("mouseout", function() {
            a.config && (a.hasArcType() || r())
        }).on("mousemove", function() {
            var t, e, n, i = a.filterTargetsToShow(a.data.targets);
            a.dragging || a.hasArcType(i) || (t = o.mouse(this), e = a.findClosestFromTargets(i, t), !a.mouseover || e && e.id === a.mouseover.id || (s.data_onmouseout.call(a.api, a.mouseover), a.mouseover = void 0), e ? (n = (a.isScatterType(e) || !s.tooltip_grouped ? [e] : a.filterByX(i, e.x)).map(function(t) {
                return a.addName(t)
            }), a.showTooltip(n, this), s.point_focus_expand_enabled && a.expandCircles(e.index, e.id, !0), a.expandBars(e.index, e.id, !0), a.showXGridFocus(n), (a.isBarType(e.id) || a.dist(e, t) < s.point_sensitivity) && (a.svg.select("." + X.eventRect).style("cursor", "pointer"), a.mouseover || (s.data_onmouseover.call(a.api, e), a.mouseover = e))) : r())
        }).on("click", function() {
            var t, e, n = a.filterTargetsToShow(a.data.targets);
            a.hasArcType(n) || (t = o.mouse(this), (e = a.findClosestFromTargets(n, t)) && (a.isBarType(e.id) || a.dist(e, t) < s.point_sensitivity) && a.main.selectAll("." + X.shapes + a.getTargetSelectorSuffix(e.id)).selectAll("." + X.shape + "-" + e.index).each(function() {
                (s.data_selection_grouped || a.isWithinShape(this, e)) && (a.toggleShape(this, e, e.index), a.config.data_onclick.call(a.api, e, this))
            }))
        }).call(s.data_selection_draggable && a.drag ? o.behavior.drag().origin(Object).on("drag", function() {
            a.drag(o.mouse(this))
        }).on("dragstart", function() {
        ...
        u.initMouseEvent(t, !0, !0, window, 0, o, s, o, s, !1, !1, !1, !1, 0, null), r.dispatchEvent(u)
        ...
        return t.classed(X.legendItemHidden) ? null : .3
    }, m.toggleFocusLegend = function(e, t) {
        var n = this;
        e = n.mapToTargetIds(e), n.legend.selectAll("." + X.legendItem).filter(function(t) {
            return 0 <= e.indexOf(t)
        }).classed(X.legendItemFocused, t).transition().duration(100).style("opacity", function() {
            return (t ? n.opacityForLegend : n.opacityForUnfocusedLegend).call(n, n.d3.select(this))
        })
    }, m.revertLegend = function() {
        var t = this,
            e = t.d3;
        t.legend.selectAll("." + X.legendItem).classed(X.legendItemFocused, !1).transition().duration(100).style("opacity", function() {
        ...
        var e = this,
            n = e.config;
        n.legend_show && g(t) && (n.legend_show = !1, e.legend.style("visibility", "hidden")), e.addHiddenLegendIds(t), e.legend.selectAll(e.selectorLegends(t)).style("opacity", 0).style("visibility", "hidden")
    }, m.clearLegendItemTextBoxCache = function() {
        this.legendItemTextBox = {}
    }, m.updateLegend = function(p, t, e) {
        function n(t, e, n) {
            function i(t, e) {
                e || (r = (g - L - f) / 2) < P && (r = (g - f) / 2, L = 0, R++), k[t] = R, G[R] = m.isLegendInset ? 10 : r, M[t] = L, L += f
            }
            var r, a, o, s, u = 0 === n,
                c = n === p.length - 1,
                l = (o = t, s = e, m.legendItemTextBox[s] || (m.legendItemTextBox[s] = m.getTextRect(o.textContent, X.legendItem, o)), m.legendItemTextBox[s]),
                h = l.width + C + (!c || m.isLegendRight || m.isLegendInset ? b : 0) + w.legend_padding,
                d = l.height + S,
                f = m.isLegendRight || m.isLegendInset ? d : h,
                g = m.isLegendRight || m.isLegendInset ? m.getLegendHeight() : m.getLegendWidth();
            u && (T = A = R = L = 0), !w.legend_show || m.isLegendToShow(e) ? (E[e] = h, V[e] = d, (!A || A <= h) && (A = h), (!T || T <= d) && (T = d), a = m.isLegendRight || m.isLegendInset ? T : A, w.legend_equally ? (Object.keys(E).forEach(function(t) {
                E[t] = A
            }), Object.keys(V).forEach(function(t) {
                V[t] = T
            }), (r = (g - a * p.length) / 2) < P ? (R = L = 0, p.forEach(function(t) {
                i(t)
            })) : i(e, !0)) : i(e)) : E[e] = V[e] = k[e] = M[e] = 0
        }
        var i, r, a, o, s, u, c, l, h, d, f, g, x, _, v, y, m = this,
            w = m.config,
            S = 4,
            b = 10,
            A = 0,
        ...
        p = p.filter(function(t) {
        ...
        }), f = H(t = t || {}, "withTransition", !0), g = H(t, "withTransitionForTransform", !0), m.isLegendInset && (R = w.legend_inset_step ? w.legend_inset_step : p.length, m.updateLegendStep(R)), m.isLegendRight ? (i = function(t) {
            return A * k[t]
        }, o = function(t) {
            return G[k[t]] + M[t]
            ...
            return o(t, e) + 4
        }, (d = m.legend.selectAll("." + X.legendItem).data(p).enter().append("g").attr("class", function(t) {
            ...
            w.legend_item_onclick ? w.legend_item_onclick.call(m, t) : m.d3.event.altKey ? (m.api.hide(), m.api.show(t)) : (m.api.toggle(t), m.isTargetToShow(t) ? m.api.focus(t) : m.api.revert())
        }).on("mouseover", function(t) {
            w.legend_item_onmouseover ? w.legend_item_onmouseover.call(m, t) : (m.d3.select(this).classed(X.legendItemFocused, !0), !m.transiting && m.isTargetToShow(t) && m.api.focus(t))
        }).on("mouseout", function(t) {
            w.legend_item_onmouseout ? w.legend_item_onmouseout.call(m, t) : (m.d3.select(this).classed(X.legendItemFocused, !1), m.api.revert())
        })).append("text").text(function(t) {
            return void 0 !== w.data_names[t] ? w.data_names[t] : t
        }).each(function(t, e) {
            n(this, t, e)
        }).style("pointer-events", "none").attr("x", m.isLegendRight || m.isLegendInset ? r : -200).attr("y", m.isLegendRight || m.isLegendInset ? -200 : s), d.append("rect").attr("class", X.legendItemEvent).style("fill-opacity", 0).attr("x", m.isLegendRight || m.isLegendInset ? a : -200).attr("y", m.isLegendRight || m.isLegendInset ? -200 : u), d.append("line").attr("class", X.legendItemTile).style("stroke", m.color).style("pointer-events", "none").attr("x1", m.isLegendRight || m.isLegendInset ? c : -200).attr("y1", m.isLegendRight || m.isLegendInset ? -200 : h).attr("x2", m.isLegendRight || m.isLegendInset ? l : -200).attr("y2", m.isLegendRight || m.isLegendInset ? -200 : h).attr("stroke-width", w.legend_item_tile_height), y = m.legend.select("." + X.legendBackground + " rect"), m.isLegendInset && 0 < A && 0 === y.size() && (y = m.legend.insert("g", "." + X.legendItem).attr("class", X.legendBackground).append("rect")), x = m.legend.selectAll("text").data(p).text(function(t) {
            return void 0 !== w.data_names[t] ? w.data_names[t] : t
        }).each(function(t, e) {
            n(this, t, e)
        }), (f ? x.transition() : x).attr("x", r).attr("y", s), _ = m.legend.selectAll("rect." + X.legendItemEvent).data(p), (f ? _.transition() : _).attr("width", function(t) {
            return E[t]
        }).attr("height", function(t) {
            return V[t]
        }).attr("x", a).attr("y", u), v = m.legend.selectAll("line." + X.legendItemTile).data(p), (f ? v.transition() : v).style("stroke", m.color).attr("x1", c).attr("y1", h).attr("x2", l).attr("y2", h), y && (f ? y.transition() : y).attr("height", m.getLegendHeight() - 12).attr("width", A * (R + 1) + 10), m.legend.selectAll("." + X.legendItem).classed(X.legendItemHidden, function(t) {
            return !m.isTargetToShow(t)
        }), m.updateLegendItemWidth(A), m.updateLegendItemHeight(T), m.updateLegendStep(R), m.updateSizes(), m.updateScales(), m.updateSvgSize(), m.transformAll(g, e), m.legendHasRendered = !0
    }, m.initRegion = function() {
        this.region = this.main.append("g").attr("clip-path", this.clipPath).attr("class", X.regions)
    }, m.updateRegion = function(t) {
        var e = this,
            n = e.config;
        e.region.style("visibility", e.hasArcType() ? "hidden" : "visible"), e.mainRegion = e.main.select("." + X.regions).selectAll("." + X.region).data(n.regions), e.mainRegion.enter().append("g").append("rect").style("fill-opacity", 0), e.mainRegion.attr("class", e.classRegion.bind(e)), e.mainRegion.exit().transition().duration(t).style("opacity", 0).remove()
        ...
        var e = this,
            n = e.config,
            i = "y" === t.axis ? e.y : e.y2;
        return "y" === t.axis || "y2" === t.axis ? n.axis_rotated && "start" in t ? i(t.start) : 0 : n.axis_rotated ? 0 : "start" in t ? e.x(e.isTimeSeries() ? e.parseDate(t.start) : t.start) : 0
    }, m.regionY = function(t) {
        var e = this,
            n = e.config,
            i = "y" === t.axis ? e.y : e.y2;
        return "y" === t.axis || "y2" === t.axis ? n.axis_rotated ? 0 : "end" in t ? i(t.end) : 0 : n.axis_rotated && "start" in t ? e.x(e.isTimeSeries() ? e.parseDate(t.start) : t.start) : 0
    }, m.regionWidth = function(t) {
        var e, n = this,
            i = n.config,
            r = n.regionX(t),
            a = "y" === t.axis ? n.y : n.y2;
        return (e = "y" === t.axis || "y2" === t.axis ? i.axis_rotated && "end" in t ? a(t.end) : n.width : i.axis_rotated ? n.width : "end" in t ? n.x(n.isTimeSeries() ? n.parseDate(t.end) : t.end) : n.width) < r ? 0 : e - r
    }, m.regionHeight = function(t) {
        var e, n = this,
            i = n.config,
            r = this.regionY(t),
            a = "y" === t.axis ? n.y : n.y2;
        return (e = "y" === t.axis || "y2" === t.axis ? i.axis_rotated ? n.height : "start" in t ? a(t.start) : n.height : i.axis_rotated && "end" in t ? n.x(n.isTimeSeries() ? n.parseDate(t.end) : t.end) : n.height) < r ? 0 : e - r
        ...
        var r, a = this.getScale(t, e, this.isTimeSeries()),
            o = n ? a.domain(n) : a;
        for (r in this.isCategorized() ? (i = i || function() {
                return 0
            }, a = function(t, e) {
                var n = o(t) + i(t);
        ...
        r.data_onselected.call(i.api, e, t.node()), i.main.select("." + X.selectedCircles + i.getTargetSelectorSuffix(e.id)).selectAll("." + X.selectedCircle + "-" + n).data([e]).enter().append("circle").attr("class", function() {
        ...
        this.config.data_onunselected.call(this.api, e, t.node()), this.main.select("." + X.selectedCircles + this.getTargetSelectorSuffix(e.id)).selectAll("." + X.selectedCircle + "-" + n).transition().duration(100).attr("r", 0).remove()
        ...
        a.data_selection_enabled && a.data_selection_isselectable(e) && (a.data_selection_multiple || i.main.selectAll("." + X.shapes + (a.data_selection_grouped ? i.getTargetSelectorSuffix(e.id) : "")).selectAll("." + X.shape).each(function(t, e) {
            var n = r.select(this);
            n.classed(X.SELECTED) && u(!1, n.classed(X.SELECTED, !1), t, e)
        }), o.classed(X.SELECTED, !s), u(!s, o, e, n))
    }, m.initBar = function() {
        this.main.select("." + X.chart).append("g").attr("class", X.chartBars)
        ...
        e.main.select("." + X.chartBars).selectAll("." + X.chartBar).data(t).attr("class", function(t) {
            return i(t) + a(t)
        ...
        e.mainBar = e.main.selectAll("." + X.bars).selectAll("." + X.bar).data(n), e.mainBar.enter().append("path").attr("class", i).style("stroke", a).style("fill", a), e.mainBar.style("opacity", r), e.mainBar.exit().transition().duration(t).remove()
        ...
        var n = this.config,
            i = "number" == typeof n.bar_width ? n.bar_width : e ? t.tickInterval() * n.bar_width_ratio / e : 0;
        return n.bar_width_max && i > n.bar_width_max ? n.bar_width_max : i
    }, m.getBars = function(t, e) {
        return (e ? this.main.selectAll("." + X.bars + this.getTargetSelectorSuffix(e)) : this.main).selectAll("." + X.bar + (P(t) ? "-" + t : ""))
        ...
        return function(t, e) {
            ...
            return "M " + n[0][i] + "," + n[0][r] + " L" + n[1][i] + "," + n[1][r] + " L" + n[2][i] + "," + n[2][r] + " L" + n[3][i] + "," + n[3][r] + " z"
        }
        ...
        return function(t, e) {
            var n = d.call(o, t.id)(0),
                ...
                r = u(t),
                a = c(t);
            return o.config.axis_rotated && (0 < t.value && a < n || t.value < 0 && n < a) && (a = n), [
                [r + h, i],
                [r + h, a - (n - i)],
                [r + s - h, a - (n - i)],
                [r + s - h, i]
        ...
        return function(n, i) {
            ...
            return c.forEach(function(t) {
                var e = u.isStepType(n) ? u.convertValuesToStep(t.values) : t.values;
                t.id !== n.id && s[t.id] === s[n.id] && l.indexOf(t.id) < l.indexOf(n.id) && (void 0 !== e[i] && +e[i].x == +n.x || (i = -1, e.forEach(function(t, e) {
                    t.x === n.x && (i = e)
        ...
        var n, i = this,
            r = i.d3.select(t);
        return i.isTargetToShow(e.id) ? "circle" === t.nodeName ? n = i.isStepType(e) ? i.isWithinStep(t, i.getYScale(e.id)(e.value)) : i.isWithinCircle(t, 1.5 * i.pointSelectR(e)) : "path" === t.nodeName && (n = !r.classed(X.bar) || i.isWithinBar(t)) : n = !1, n
    }, m.getInterpolate = function(t) {
        var e = this,
            n = e.isInterpolationType(e.config.spline_interpolation_type) ? e.config.spline_interpolation_type : "cardinal";
        return e.isSplineType(t) ? n : e.isStepType(t) ? e.config.line_step_type : "linear"
    }, m.initLine = function() {
        this.main.select("." + X.chart).append("g").attr("class", X.chartLines)
        ...
        (e = n.main.select("." + X.chartLines).selectAll("." + X.chartLine).data(t).attr("class", function(t) {
            return r(t) + u(t)
            ...
            n.main.selectAll("." + X.selectedCircles + n.getTargetSelectorSuffix(e.id)).selectAll("." + X.selectedCircle).each(function(t) {
                t.value = e.values[t.index].value
            })
        })
    }, m.updateLine = function(t) {
        var e = this;
        e.mainLine = e.main.selectAll("." + X.lines).selectAll("." + X.line).data(e.lineData.bind(e)), e.mainLine.enter().append("path").attr("class", e.classLine.bind(e)).style("stroke", e.color), e.mainLine.style("opacity", e.initialOpacity.bind(e)).style("shape-rendering", function(t) {
        ...
        var u = this,
            ...
            i = function(t, e) {
                return 0 < c.data_groups.length ? n(t, e)[0][1] : h.call(u, t.id)(t.value)
            };
        return l = c.axis_rotated ? l.x(i).y(e) : l.x(e).y(i), c.line_connectNull || (l = l.defined(function(t) {
                return null != t.value
            })),
            function(t) {
                var e, n = c.line_connectNull ? u.filterRemoveNull(t.values) : t.values,
                    i = s ? u.x : u.subX,
                    r = h.call(u, t.id),
                    a = 0,
                    o = 0;
                return u.isLineType(t) ? c.data_regions[t.id] ? e = u.lineWithRegions(n, i, r, c.data_regions[t.id]) : (u.isStepType(t) && (n = u.convertValuesToStep(n)), e = l.interpolate(u.getInterpolate(t))(n)) : (n[0] && (a = i(n[0].x), o = r(n[0].value)), e = c.axis_rotated ? "M " + o + " " + a : "M " + a + " " + o), e || "M 0 0"
            }
        ...
        return function(t, e) {
            var n = h.call(o, t.id)(0),
                ...
                r = u(t),
                a = c(t);
            return s.axis_rotated && (0 < t.value && a < n || t.value < 0 && n < a) && (a = n), [
                [r, a - (n - i)],
                [r, a - (n - i)],
                [r, a - (n - i)],
                [r, a - (n - i)]
        ...
        var n, i, r, a, h, o, s, d, f, g, p, x = this,
            _ = x.config,
            v = "M",
            y = x.isCategorized() ? .5 : 0,
            m = [];
        if (void 0 !== e)
            for (n = 0; n < e.length; n++) m[n] = {}, void 0 === e[n].start ? m[n].start = t[0].x : m[n].start = x.isTimeSeries() ? x.parseDate(e[n].start) : e[n].start, void 0 === e[n].end ? m[n].end = t[t.length - 1].x : m[n].end = x.isTimeSeries() ? x.parseDate(e[n].end) : e[n].end;
        for (g = _.axis_rotated ? function(t) {
                ...
                return c(t.value)
            }, r = x.isTimeSeries() ? function(t, e, n, i) {
                var r = t.x.getTime(),
                    a = e.x - t.x,
                    o = new Date(r + a * n),
                    s = new Date(r + a * (n + i));
                return l(_.axis_rotated ? [
                    [c(h(n)), u(o)],
                    [c(h(n + i)), u(s)]
                ] : [
                    [u(o), c(h(n))],
            ...
            if (void 0 !== m && function(t, e) {
                    var n;
                    for (n = 0; n < e.length; n++)
                        if (e[n].start < t && t <= e[n].end) return !0;
                    return !1
                }(t[n].x, m))
                for (a = x.getScale(t[n - 1].x + y, t[n].x + y, x.isTimeSeries()), h = x.getScale(t[n - 1].value, t[n].value), o = u(t[n].x) - u(t[n - 1].x), s = c(t[n].value) - c(t[n - 1].value), f = 2 * (d = 2 / Math.sqrt(Math.pow(o, 2) + Math.pow(s, 2))), i = d; i <= 1; i += f) v += r(t[n - 1], t[n], i, d);
            else v += " " + g(t[n]) + " " + p(t[n]);
            t[n].x
        }
        return v
        ...
        var e = this,
            n = e.d3;
        e.mainArea = e.main.selectAll("." + X.areas).selectAll("." + X.area).data(e.lineData.bind(e)), e.mainArea.enter().append("path").attr("class", e.classArea.bind(e)).style("fill", e.color).style("opacity", function() {
        ...
        var a = this,
            ...
            u = function(t, e) {
                return 0 < o.data_groups.length ? n(t, e)[0][1] : i.call(a, t.id)(a.getAreaBaseValue(t.id))
            },
            c = function(t, e) {
                return 0 < o.data_groups.length ? n(t, e)[1][1] : i.call(a, t.id)(t.value)
            };
        return s = o.axis_rotated ? s.x0(u).x1(c).y(r) : s.x(r).y0(o.area_above ? 0 : u).y1(c), o.line_connectNull || (s = s.defined(function(t) {
                return null !== t.value
            })),
            function(t) {
                var e, n = o.line_connectNull ? a.filterRemoveNull(t.values) : t.values,
                    i = 0,
                    r = 0;
                return a.isAreaType(t) ? (a.isStepType(t) && (n = a.convertValuesToStep(n)), e = s.interpolate(a.getInterpolate(t))(n)) : (n[0] && (i = a.x(n[0].x), r = a.getYScale(t.id)(n[0].value)), e = o.axis_rotated ? "M " + r + " " + i : "M " + i + " " + r), e || "M 0 0"
            }
        ...
        var t = this;
        t.mainCircle = t.main.selectAll("." + X.circles).selectAll("." + X.circle).data(t.lineOrScatterData.bind(t)), t.mainCircle.enter().append("circle").attr("class", t.classCircle.bind(t)).attr("r", t.pointR.bind(t)).style("fill", t.color), t.mainCircle.style("opacity", t.initialOpacityForCircle.bind(t)), t.mainCircle.exit().remove()
        ...
        var t, n, e = this;
        0 < e.config.data_groups.length ? (t = e.getShapeIndices(e.isLineType), n = e.generateGetLinePoints(t), e.circleY = function(t, e) {
            return n(t, e)[0][1]
        }) : e.circleY = function(t) {
            return e.getYScale(t.id)(t.value)
        }
    }, m.getCircles = function(t, e) {
        return (e ? this.main.selectAll("." + X.circles + this.getTargetSelectorSuffix(e)) : this.main).selectAll("." + X.circle + (P(t) ? "-" + t : ""))
    }, m.expandCircles = function(t, e, n) {
        var i = this.pointExpandedR.bind(this);
        n && this.unexpandCircles(), this.getCircles(t, e).classed(X.EXPANDED, !0).attr("r", i)
    }, m.unexpandCircles = function(t) {
        var e = this,
            n = e.pointR.bind(e);
        e.getCircles(t).filter(function() {
            return e.d3.select(this).classed(X.EXPANDED)
        }).classed(X.EXPANDED, !1).attr("r", n)
    }, m.pointR = function(t) {
        var e = this.config;
        ...
        var e = this.config;
        return P(e.padding_left) ? e.padding_left : e.axis_rotated ? e.axis_x_show ? Math.max(i(this.getAxisWidthByAxisId("x", t)), 40) : 1 : !e.axis_y_show || e.axis_y_inner ? this.axis.getYAxisLabelPosition().isOuter ? 30 : 1 : i(this.getAxisWidthByAxisId("y", t))
    }, m.getCurrentPaddingRight = function() {
        var t = this,
            e = t.config,
            n = t.isLegendRight ? t.getLegendWidth() + 20 : 0;
        return P(e.padding_right) ? e.padding_right + 1 : e.axis_rotated ? 10 + n : !e.axis_y2_show || e.axis_y2_inner ? 2 + n + (t.axis.getY2AxisLabelPosition().isOuter ? 20 : 0) : i(t.getAxisWidthByAxisId("y2")) + n
        ...
        r.subchart_show && (i.select("." + X.chartBars).selectAll("." + X.chartBar).data(t).attr("class", a).enter().append("g").style("opacity", 0).attr("class", a).append("g").attr("class", o), (e = i.select("." + X.chartLines).selectAll("." + X.chartLine).data(t).attr("class", s).enter().append("g").style("opacity", 0).attr("class", s)).append("g").attr("class", u), e.append("g").attr("class", c), i.selectAll("." + X.brush + " rect").attr(r.axis_rotated ? "width" : "height", r.axis_rotated ? n.width2 : n.height2))
    }, m.updateBarForSubchart = function(t) {
        var e = this;
        e.contextBar = e.context.selectAll("." + X.bars).selectAll("." + X.bar).data(e.barData.bind(e)), e.contextBar.enter().append("path").attr("class", e.classBar.bind(e)).style("stroke", "none").style("fill", e.color), e.contextBar.style("opacity", e.initialOpacity.bind(e)), e.contextBar.exit().transition().duration(t).style("opacity", 0).remove()
        ...
        var e = this;
        e.contextLine = e.context.selectAll("." + X.lines).selectAll("." + X.line).data(e.lineData.bind(e)), e.contextLine.enter().append("path").attr("class", e.classLine.bind(e)).style("stroke", e.color), e.contextLine.style("opacity", e.initialOpacity.bind(e)), e.contextLine.exit().transition().duration(t).style("opacity", 0).remove()
        ...
        var e = this,
            n = e.d3;
        e.contextArea = e.context.selectAll("." + X.areas).selectAll("." + X.area).data(e.lineData.bind(e)), e.contextArea.enter().append("path").attr("class", e.classArea.bind(e)).style("fill", e.color).style("opacity", function() {
            return e.orgAreaOpacity = +n.select(this).style("opacity"), 0
        ...
        var n;
        e && e.axisSubX ? n = e.axisSubX : (n = this.context.select("." + X.axisX), t && (n = n.transition())), this.context.attr("transform", this.getTranslate("context")), n.attr("transform", this.getTranslate("subx"))
    }, m.getDefaultExtent = function() {
        var t = this,
            e = t.config,
            n = h(e.axis_x_extent) ? e.axis_x_extent(t.getXDomain(t.data.targets)) : e.axis_x_extent;
        return t.isTimeSeries() && (n = [t.parseDate(n[0]), t.parseDate(n[1])]), n
    }, m.initText = function() {
        this.main.select("." + X.chart).append("g").attr("class", X.chartTexts), this.mainText = this.d3.selectAll([])
    }, m.updateTargetsForText = function(t) {
        var e = this,
            n = e.classChartText.bind(e),
            i = e.classTexts.bind(e),
            r = e.classFocus.bind(e);
        e.main.select("." + X.chartTexts).selectAll("." + X.chartText).data(t).attr("class", function(t) {
            return n(t) + r(t)
        ...
        i.mainText = i.main.selectAll("." + X.texts).selectAll("." + X.text).data(n), i.mainText.enter().append("text").attr("class", r).attr("text-anchor", function(t) {
            return e.axis_rotated ? t.value < 0 ? "end" : "start" : "middle"
        }).style("stroke", "none").style("fill", function(t) {
            return i.color(t)
        }).style("fill-opacity", 0), i.mainText.text(function(t, e, n) {
            return i.dataLabelFormat(t.id)(t.value, t.id, e, n)
        }), i.mainText.exit().transition().duration(t).style("fill-opacity", 0).remove()
        ...
        var i, r = this.d3.select("body").append("div").classed("c3", !0),
        ...
        return a.config.axis_rotated ? (r = a.isBarType(e) ? 4 : 6, i = t[2][1] + r * (e.value < 0 ? -1 : 1)) : i = a.hasType("bar") ? (t[2][0] + t[0][0]) / 2 : t[0][0], null === e.value && (i > a.width ? i = a.width - o.width : i < 0 && (i = 4)), i
    }, m.getYForText = function(t, e, n) {
        var i, r = this,
            a = n.getBoundingClientRect();
        return r.config.axis_rotated ? i = (t[0][0] + t[2][0] + .6 * a.height) / 2 : (i = t[2][1], e.value < 0 || 0 === e.value && !r.hasPositiveValue ? (i += a.height, r.isBarType(e) && r.isSafari() ? i -= 3 : !r.isBarType(e) && r.isChrome() && (i += 3)) : i += r.isBarType(e) ? -3 : -6), null !== e.value || r.config.axis_rotated || (i < a.height ? i = a.height : i > this.height && (i = this.height - 4)), i
        ...
        return 0 <= n.indexOf("right") ? t.currentWidth - t.getTextRect(t.title.node().textContent, t.CLASS.title, t.title.node()).width - e.title_padding.right : 0 <= n.indexOf("center") ? (t.currentWidth - t.getTextRect(t.title.node().textContent, t.CLASS.title, t.title.node()).width) / 2 : e.title_padding.left
        ...
        var t, e = this,
            n = e.config;
        if (e.tooltip = e.selectChart.style("position", "relative").append("div").attr("class", X.tooltipContainer).style("position", "absolute").style("pointer-events", "none").style("display", "none"), n.tooltip_init_show) {
        ...
        if (0 !== e.data_groups.length && void 0 === e.tooltip_order) {
            ...
            return (t.isOrderAsc() || t.isOrderDesc()) && (n = n.reverse()),
                function(t, e) {
                    return n.indexOf(t.id) - n.indexOf(e.id)
                }
        }
        ...
        if (c(i) && "asc" === i.toLowerCase()) return function(t, e) {
            return r(t) - r(e)
        };
        if (c(i) && "desc" === i.toLowerCase()) return function(t, e) {
            return r(e) - r(t)
        };
        if (h(i)) {
            var a = i;
        ...
        for (p && t.sort(p), a = 0; a < t.length; a++)
            if (t[a] && (t[a].value || 0 === t[a].value) && (r || (o = x(d ? d(t[a].x) : t[a].x), r = "<table class='" + l.CLASS.tooltip + "'>" + (o || 0 === o ? "<tr><th colspan='2'>" + o + "</th></tr>" : "")), void 0 !== (s = x(g(t[a].value, t[a].ratio, t[a].id, t[a].index, t))))) {
                if (null === t[a].name) continue;
                u = x(f(t[a].name, t[a].ratio, t[a].id, t[a].index)), c = l.levelColor ? l.levelColor(t[a].value) : i(t[a].id), r += "<tr class='" + l.CLASS.tooltipName + "-" + l.getTargetSelectorSuffix(t[a].id) + "'>", r += "<td class='name'><span style='background-color:" + c + "'></span>" + u + "</td>", r += "<td class='value'>" + s + "</td>", r += "</tr>"
            }
        return r + "</table>"
    }, m.tooltipPosition = function(t, e, n, i) {
        var r, a, o, s, u, c = this,
            l = c.config,
            h = c.d3,
            d = c.hasArcType(),
            f = h.mouse(i);
        return d ? (a = (c.width - (c.isLegendRight ? c.getLegendWidth() : 0)) / 2 + f[0], s = c.height / 2 + f[1] + 20) : (r = c.getSvgLeft(!0), l.axis_rotated ? (o = (a = r + f[0] + 100) + e, u = c.currentWidth - c.getCurrentPaddingRight(), s = c.x(t[0].x) + 20) : (o = (a = r + c.getCurrentPaddingLeft(!0) + c.x(t[0].x) + 20) + e, u = r + c.currentWidth - c.getCurrentPaddingRight(), s = f[1] + 15), u < o && (a -= o - u + 20), s + n > c.currentHeight && (s -= n + 30)), s < 0 && (s = 0), {
            top: s,
            left: a
        }
        ...
        0 !== u.length && o.tooltip_show && (a.tooltip.html(o.tooltip_contents.call(a, t, a.axis.getXAxisTickFormat(), a.getYFormat(s), a.color)).style("display", "block"), n = a.tooltip.property("offsetWidth"), i = a.tooltip.property("offsetHeight"), r = c.call(this, u, n, i, e), a.tooltip.style("top", r.top + "px").style("left", r.left + "px"))
        ...
        return (t = t || this.data.targets) && t.length ? t.forEach(function(t) {
            ...
            i[t] === n && (r = !0)
        }) : r = this.config.data_type === n, r
    }, m.hasArcType = function(t) {
        return this.hasType("pie", t) || this.hasType("donut", t) || this.hasType("gauge", t)
    }, m.isLineType = function(t) {
        var e = this.config,
            n = c(t) ? t : t.id;
        return !e.data_types[n] || 0 <= ["line", "spline", "area", "area-spline", "step", "area-step"].indexOf(e.data_types[n])
        ...
        var e, n = this,
            i = n.d3,
            r = n.config;
        n.zoom = i.behavior.zoom().on("zoomstart", function() {
            e = i.event.sourceEvent, n.zoom.altDomain = i.event.sourceEvent.altKey ? n.x.orgDomain() : null, r.zoom_onzoomstart.call(n.api, i.event.sourceEvent)
        }).on("zoom", function() {
            n.redrawForZoom.call(n)
        }).on("zoomend", function() {
            var t = i.event.sourceEvent;
            t && e.clientX === t.clientX && e.clientY === t.clientY || (n.redrawEventRect(), n.updateZoom(), r.zoom_onzoomend.call(n.api, n.x.orgDomain()))
        ...
        this.main.select("." + X.zoomRect).call(t).on("dblclick.zoom", null), this.main.selectAll("." + X.eventRect).call(t).on("dblclick.zoom", null)
        ...
        if (n.zoom_enabled && 0 !== t.filterTargetsToShow(t.data.targets).length) {
            if ("mousemove" === e.event.sourceEvent.type && i.altDomain) return r.domain(i.altDomain), void i.scale(r).updateScaleExtent();
            t.isCategorized() && r.orgDomain()[0] === t.orgXDomain[0] && r.domain([t.orgXDomain[0] - 1e-10, r.orgDomain()[1]]), t.redraw({
                withTransition: !1,
...
function() {
    ...
    function t(a) {
        return {
            left: function(t, e, n, i) {
                for (arguments.length < 3 && (n = 0), arguments.length < 4 && (i = t.length); n < i;) {
                    var r = n + i >>> 1;
                    a(t[r], e) < 0 ? n = r + 1 : i = r
                }
                return n
    ...
    function m(r) {
        function t() {
            for (var t, e = a, n = -1, i = e.length; ++n < i;)(t = e[n].on) && t.apply(this, arguments);
            return r
        }
        var a = [],
            o = new v;
        return t.on = function(t, e) {
            var n, i = o.get(t);
            return arguments.length < 2 ? i && i.on : (i && (i.on = null, a = a.slice(0, n = a.indexOf(i)).concat(a.slice(n + 1)), o.remove(t)), e && a.push(o.set(t, {
                on: e
            })), r)
        }, t
    }
    ...
    function I(r) {
        for (var a = new y, t = 0, e = arguments.length; ++t < e;) a[arguments[t]] = m(a);
        return a.of = function(n, i) {
            return function(t) {
                try {
    ...
    function T(e, n) {
        return e = qr.ns.qualify(e), null == n ? e.local ? function() {
    ...
    function M(n, i) {
        ...
        return "function" == typeof i ? function() {
            for (var t = -1, e = i.apply(this, arguments); ++t < r;) n[t](this, e)
        } : function() {
    ...
    function E(i) {
        ...
        return function(t, e) {
            ...
            e ? (r.lastIndex = 0, r.test(n) || t.setAttribute("class", P(n + " " + i))) : t.setAttribute("class", P(n.replace(r, " ")))
        }
    }
    ...
    function D(n) {
        return "function" == typeof n ? n : (n = qr.ns.qualify(n)).local ? function() {
            return this.ownerDocument.createElementNS(n.space, n.local)
        } : function() {
            var t = this.ownerDocument,
                e = this.namespaceURI;
            return e === fa && t.documentElement.namespaceURI === fa ? t.createElement(n) : t.createElementNS(e, n)
        }
    }
    ...
    function X(t, e) {
        for (var n = 0, i = t.length; n < i; n++)
            for (var r, a = t[n], o = 0, s = a.length; o < s; o++)(r = a[o]) && e(r, o, n);
        return t
    }
    ...
    function Y(r, e, n) {
        ...
        0 < t && (r = r.slice(0, t));
        var s = xa.get(r);
        return s && (r = s, o = j), t ? e ? function() {
            var t = o(e, Qr(arguments));
            i.call(this), this.addEventListener(r, this[a] = t, t.$ = n), t._ = e
        } : i : e ? _ : function() {
            var t, e = new RegExp("^__on([^.]+)" + qr.requote(r) + "$");
            for (var n in this)
                if (t = n.match(e)) {
                    var i = this[n];
    ...
    function U(t) {
        var n = ".dragsuppress-" + ++va,
            i = "click" + n,
            r = qr.select(k(t)).on("touchmove" + n, O).on("dragstart" + n, O).on("selectstart" + n, O);
        if (null == _a && (_a = !("onselectstart" in t) && x(t.style, "userSelect")), _a) {
            var a = s(t).style,
                o = a[_a];
            a[_a] = "none"
        }
    ...
    function q(t, e) {
        ...
        if (n.createSVGPoint) {
            ...
            return ya ? (i.x = e.pageX, i.y = e.pageY) : (i.x = e.clientX, i.y = e.clientY), [(i = i.matrixTransform(t.getScreenCTM().inverse())).x, i.y]
        }
    ...
    function nt(t, e, n) {
        return this instanceof nt ? (this.h = +t, this.s = +e, void(this.l = +n)) : arguments.length < 2 ? t instanceof nt ? new nt(t.h, t.s, t.l) : xt("" + t, _t, nt) : new nt(t, e, n)
    }

    function it(t, e, n) {
        function i(t) {
            return Math.round(255 * (360 < (e = t) ? e -= 360 : e < 0 && (e += 360), e < 60 ? r + (a - r) * e / 60 : e < 180 ? a : e < 240 ? r + (a - r) * (240 - e) / 60 : r));
            var e
        }
        var r, a;
        return t = isNaN(t) ? 0 : (t %= 360) < 0 ? t + 360 : t, e = isNaN(e) ? 0 : e < 0 ? 0 : 1 < e ? 1 : e, r = 2 * (n = n < 0 ? 0 : 1 < n ? 1 : n) - (a = n <= .5 ? n * (1 + e) : n + e - n * e), new dt(i(t + 120), i(t), i(t - 120))
    }

    function rt(t, e, n) {
        return this instanceof rt ? (this.h = +t, this.c = +e, void(this.l = +n)) : arguments.length < 2 ? t instanceof rt ? new rt(t.h, t.c, t.l) : ut(t instanceof ot ? t.l : (t = vt((t = qr.rgb(t)).r, t.g, t.b)).l, t.a, t.b) : new rt(t, e, n)
    }

    function at(t, e, n) {
        return isNaN(t) && (t = 0), isNaN(e) && (e = 0), new ot(n, Math.cos(t *= Pa) * e, Math.sin(t) * e)
    }

    function ot(t, e, n) {
        return this instanceof ot ? (this.l = +t, this.a = +e, void(this.b = +n)) : arguments.length < 2 ? t instanceof ot ? new ot(t.l, t.a, t.b) : t instanceof rt ? at(t.h, t.c, t.l) : vt((t = dt(t)).r, t.g, t.b) : new ot(t, e, n)
    }
    ...
    function st(t, e, n) {
        var i = (t + 16) / 116,
            r = i + e / 500,
            a = i - n / 200;
        return new dt(ht(3.2404542 * (r = ct(r) * Oa) - 1.5371385 * (i = ct(i) * Ia) - .4985314 * (a = ct(a) * Da)), ht(-.969266 * r + 1.8760108 * i + .041556 * a), ht(.0556434 * r - .2040259 * i + 1.0572252 * a))
    }

    function ut(t, e, n) {
        return 0 < t ? new rt(Math.atan2(n, e) * Ca, Math.sqrt(e * e + n * n), t) : new rt(NaN, NaN, t)
    }
    ...
    function dt(t, e, n) {
        return this instanceof dt ? (this.r = ~~t, this.g = ~~e, void(this.b = ~~n)) : arguments.length < 2 ? t instanceof dt ? new dt(t.r, t.g, t.b) : xt("" + t, dt, it) : new dt(t, e, n)
    }
    ...
    function xt(t, e, n) {
        ...
        return (a = za.get(t)) ? e(a.r, a.g, a.b) : (null == t || "#" !== t.charAt(0) || isNaN(a = parseInt(t.slice(1), 16)) || (4 === t.length ? (o = (3840 & a) >> 4, o |= o >> 4, s = 240 & a, s |= s >> 4, u = 15 & a, u |= u << 4) : 7 === t.length && (o = (16711680 & a) >> 16, s = (65280 & a) >> 8, u = 255 & a)), e(o, s, u))
    }

    function _t(t, e, n) {
        var i, r, a = Math.min(t /= 255, e /= 255, n /= 255),
            o = Math.max(t, e, n),
            s = o - a,
            u = (o + a) / 2;
        return s ? (r = u < .5 ? s / (o + a) : s / (2 - o - a), i = t == o ? (e - n) / s + (e < n ? 6 : 0) : e == o ? (n - t) / s + 2 : (t - e) / s + 4, i *= 60) : (i = NaN, r = 0 < u && u < 1 ? 0 : i), new nt(i, r, u)
    }

    function vt(t, e, n) {
        var i = lt((.4124564 * (t = yt(t)) + .3575761 * (e = yt(e)) + .1804375 * (n = yt(n))) / Oa),
            r = lt((.2126729 * t + .7151522 * e + .072175 * n) / Ia);
        return ot(116 * r - 16, 500 * (i - r), 200 * (r - lt((.0193339 * t + .119192 * e + .9503041 * n) / Da)))
    }
    ...
    function St(i) {
        return function(t, e, n) {
            return 2 === arguments.length && "function" == typeof e && (n = e, e = null), bt(t, e, i, n)
        }
    }

    function bt(r, a, o, t) {
        function e() {
            var t, e, n, i = l.status;
            if (!i && ((n = (e = l).responseType) && "text" !== n ? e.response : e.responseText) || 200 <= i && i < 300 || 304 === i) {
                try {
                    t = o.call(s, l)
                } catch (t) {
        ...
        var n, s = {},
            ...
            h = null;
        return !this.XDomainRequest || "withCredentials" in l || !/^(http(s)?:)?\/\//.test(r) || (l = new XDomainRequest), "onload" in l ? l.onload = l.onerror = e : l.onreadystatechange = function() {
            3 < l.readyState && e()
            ...
            if (2 === arguments.length && "function" == typeof e && (n = e, e = null), l.open(t, r, !0), null == a || "accept" in c || (c.accept = a + ",*/*"), l.setRequestHeader)
            ...
            return l.abort(), s
        }, qr.rebind(s, u, "on"), null == t ? s : s.get(1 === (n = t).length ? function(t, e) {
            n(null == t ? e : null)
        } : n)
    }
    ...
    function At(t, e, n) {
        ...
        return Ha ? Ha.n = r : Xa = r, Ha = r, Ya || (Ba = clearTimeout(Ba), Ya = 1, ja(Tt)), r
    }

    function Tt() {
        var t = Pt(),
            e = Ct() - t;
        24 < e ? (isFinite(e) && (clearTimeout(Ba), Ba = setTimeout(Tt, e)), Ya = 0) : (Ya = 1, ja(Tt))
    }

    function Pt() {
        for (var t = Date.now(), e = Xa; e;) t >= e.t && e.c(t - e.t) && (e.c = null), e = e.n;
        return t
    }

    function Ct() {
        for (var t, e = Xa, n = 1 / 0; e;) e.c ? (e.t < n && (n = e.t), e = (t = e).n) : e = t ? t.n = e.n : Xa = e.n;
        return Ha = t, n
    }
    ...
    function Vt(i, a, o) {
        ...
        function u(t, e, n) {
            var i = s(t),
                r = [];
            if (1 < n)
                for (; i < e;) o(i) % n || r.push(new Date(+i)), a(i, 1);
            else
                for (; i < e;) r.push(new Date(+i)), a(i, 1);
            return r
        }(i.floor = i).round = t, i.ceil = s, i.offset = r, i.range = u;
        var e = i.utc = Gt(i);
        return (e.floor = e).round = Gt(t), e.ceil = Gt(s), e.offset = Gt(r), e.range = function(t, e, n) {
            try {
                var i = new(Za = Et);
    ...
    function Ot(t) {
        for (var e = new v, n = -1, i = t.length; ++n < i;) e.set(t[n].toLowerCase(), n);
        return e
    }
    ...
    function zt(t, e, n) {
        Ja.lastIndex = 0;
        var i, r = Ja.exec(e.slice(n, n + 2));
        return r ? (t.y = (i = +r[0]) + (68 < i ? 1900 : 2e3), n + r[0].length) : -1
    }
    ...
    function ie() {
        ...
        so.point = function(t, e) {
            so.point = n, l = (i = t) * Pa, h = Math.cos(e = (r = e) * Pa / 2 + Sa / 4), d = Math.sin(e)
        }, so.lineEnd = function() {
            n(i, r)
        }
    }
    ...
    function ge() {
        function i(t, e) {
            ...
            var n = Math.cos(e *= Pa),
                ...
                r = n * Math.sin(t),
                a = Math.sin(e),
                o = Math.atan2(Math.sqrt((o = u * a - c * r) * o + (o = c * i - s * a) * o + (o = s * r - u * i) * o), s * i + u * r + c * a);
            co += o, go += o * (s + (s = i)), po += o * (u + (u = r)), xo += o * (c + (c = a)), fe(s, u, c)
        }
        var s, u, c;
        mo.point = function(t, e) {
            t *= Pa;
            var n = Math.cos(e *= Pa);
            s = n * Math.cos(t), u = n * Math.sin(t), c = Math.sin(e), mo.point = i, fe(s, u, c)
        }
    }
    ...
    function xe() {
        function i(t, e) {
            ...
            var n = Math.cos(e *= Pa),
                ...
                h = c && -K(l) / c,
                d = Math.atan2(c, l);
            _o += h * o, vo += h * s, yo += h * u, co += d, go += d * (f + (f = i)), po += d * (g + (g = r)), xo += d * (p + (p = a)), fe(f, g, p)
        }
        var r, a, f, g, p;
        mo.point = function(t, e) {
            r = t, a = e, mo.point = i, t *= Pa;
            var n = Math.cos(e *= Pa);
            f = n * Math.cos(t), g = n * Math.sin(t), p = Math.sin(e), fe(f, g, p)
        }, mo.lineEnd = function() {
    ...
    function _e(n, i) {
        ...
        return n.invert && i.invert && (t.invert = function(t, e) {
        ...
        if (t.forEach(function(t) {
                if (!((e = t.length - 1) <= 0)) {
                    ...
                    var a = new we(n, t, null, !0),
                        o = new we(n, null, a, !1);
                    a.o = o, u.push(a), c.push(o), o = new we(i, null, a = new we(i, t, null, !1), !0), a.o = o, u.push(a), c.push(o)
                }
            }), c.sort(e), me(u), me(c), u.length) {
            ...
            for (var l, h, d = u[0];;) {
                ...
                do {
                    if (f.v = f.o.v = !0, f.e) {
                        if (g)
                            for (r = 0, o = l.length; r < o; ++r) s.point((h = l[r])[0], h[1]);
                        else i(f.x, f.n.x, 1, s);
                        f = f.n
                    } else {
                        if (g)
                            for (r = (l = f.p.z).length - 1; 0 <= r; --r) s.point((h = l[r])[0], h[1]);
                ...
                if (h.pop(), l.push(h), h = null, i)
                    if (1 & e) {
                        ...
                        if (0 < (i = (t = n[0]).length - 1)) {
                            for (_ || (o.polygonStart(), _ = !0), o.lineStart(); ++a < i;) o.point((r = t[a])[0], r[1]);
                            o.lineEnd()
                        }
                    } else 1 < i && 2 & e && n.push(n.pop().concat(n.shift())), c.push(n.filter(be))
            }
            var c, l, h, d = y(o),
                f = i.invert(w[0], w[1]),
                g = {
                    ...
                    polygonStart: function() {
                        g.point = s, g.lineStart = a, g.lineEnd = u, c = [], l = []
                    },
                    polygonEnd: function() {
                        g.point = e, g.lineStart = n, g.lineEnd = r, c = qr.merge(c);
                        var t = function(t, e) {
                            var n = t[0],
                                i = t[1],
                            ...
                            for (var s = 0, u = e.length; s < u; ++s) {
                                var c = e[s],
                                    l = c.length;
                                if (l)
                                    for (var h = c[0], d = h[0], f = h[1] / 2 + Sa / 4, g = Math.sin(f), p = Math.cos(f), x = 1;;) {
                                        x === l && (x = 0);
                                        var _ = (t = c[x])[0],
                                            v = t[1] / 2 + Sa / 4,
                                            y = Math.sin(v),
                                            ...
                                            A = Sa < b,
                                            T = g * y;
                                        if (oo.add(Math.atan2(T * S * Math.sin(b), p * m + T * Math.cos(b))), a += A ? w + S * ba : w, A ^ n <= d ^ n <= _) {
                                            var P = oe(re(h), re(t));
                                            ce(P);
                                            var C = oe(r, P);
                                            ce(C);
                                            var L = (A ^ 0 <= w ? -1 : 1) * $(C[2]);
                                            (L < i || i === L && (P[0] || P[1])) && (o += A ^ 0 <= w ? 1 : -1)
                                        }
                                        if (!x++) break;
                                        d = _, g = y, p = m, h = t
                                    }
                        ...
                        c.length ? (_ || (o.polygonStart(), _ = !0), ye(c, Te, t, m, o)) : t && (_ || (o.polygonStart(), _ = !0), o.lineStart(), m(null, null, 1, o), o.lineEnd()), _ && (o.polygonEnd(), _ = !1), c = l = null
                    },
                    sphere: function() {
                        o.polygonStart(), o.lineStart(), m(null, null, 1, o), o.lineEnd(), o.polygonEnd()
                    }
                },
                p = Ae(),
                x = y(p),
    ...
    function Te(t, e) {
        return ((t = t.x)[0] < 0 ? t[1] - Ta - ma : Ta - t[1]) - ((e = e.x)[0] < 0 ? e[1] - Ta - ma : Ta - e[1])
    }
    ...
    function Ce(m, w, S, b) {
        function A(t, e) {
            return ia(t[0] - m) < ma ? 0 < e ? 0 : 3 : ia(t[0] - S) < ma ? 0 < e ? 2 : 1 : ia(t[1] - w) < ma ? 0 < e ? 1 : 0 : 0 < e ? 3 : 2
        }
        ...
        return function(r) {
            function i(t, e, n, i) {
                var r = 0,
                    a = 0;
                if (null == t || (r = A(t, n)) !== (a = A(e, n)) || P(t, e) < 0 ^ 0 < n)
                    for (; i.point(0 === r || 3 === r ? m : S, 1 < r ? b : w), (r = (r + n + 4) % 4) !== a;);
            ...
            function e(t, e) {
                var n = a(t = Math.max(-So, Math.min(So, t)), e = Math.max(-So, Math.min(So, e)));
                if (l && s.push([t, e]), p) u = t, c = e, p = !1, (h = n) && (r.lineStart(), r.point(t, e));
                    ...
                    v(i) ? (g || (r.lineStart(), r.point(i.a.x, i.a.y)), r.point(i.b.x, i.b.y), n || r.lineEnd(), x = !1) : n && (r.lineStart(), r.point(t, e), x = !1)
                }
                d = t, f = e, g = n
            }
            var o, l, s, u, c, h, d, f, g, p, x, _ = r,
                n = Ae(),
                v = Pe(m, w, S, b),
                y = {
                    point: t,
                    lineStart: function() {
                        y.point = e, l && l.push(s = []), g = !(p = !0), d = f = NaN
                    },
                    lineEnd: function() {
                        o && (e(u, c), h && g && n.rejoin(), o.push(n.buffer())), y.point = t, g && r.lineEnd()
                    },
                    polygonStart: function() {
                        r = n, o = [], l = [], x = !0
                    },
                    polygonEnd: function() {
                        ...
                        var t = function(t) {
                                for (var e = 0, n = l.length, i = t[1], r = 0; r < n; ++r)
                                    for (var a, o = 1, s = l[r], u = s.length, c = s[0]; o < u; ++o) a = s[o], c[1] <= i ? a[1] > i && 0 < Z(c, a, t) && ++e : a[1] <= i && Z(c, a, t) < 0 && --e, c = a;
                                return 0 !== e
                            }([m, b]),
                            e = x && t,
                            n = o.length;
                        (e || n) && (r.polygonStart(), e && (r.lineStart(), i(null, null, 1, r), r.lineEnd()), n && ye(o, T, t, i, r), r.polygonEnd()), o = l = s = null
                    }
                };
            return y
        }
    ...
    function Le(t) {
        ...
        return r.parallels = function(t) {
            return arguments.length ? i(e = t[0] * Sa / 180, n = t[1] * Sa / 180) : [e / Sa * 180, n / Sa * 180]
        }, r
    }
    ...
    function Me(t, e) {
        ...
        return n.invert = function(t, e) {
            var n = o - e;
            return [Math.atan2(t, n) / r, $((a - (t * t + n * n) * r * r) / (2 * r))]
        }, n
    }
    ...
    function Re() {
        function n(t, e) {
            var n = t - a,
                i = e - o,
                r = Math.sqrt(n * n + i * i);
            go += r * (a + t) / 2, po += r * (o + e) / 2, xo += r, ke(a = t, o = e)
        }
        var a, o;
    ...
    function Ie() {
        function n(t, e) {
            var n = t - a,
                i = e - o,
                r = Math.sqrt(n * n + i * i);
            go += r * (a + t) / 2, po += r * (o + e) / 2, xo += r, _o += (r = o * t - a * e) * (a + t), vo += r * (o + e), yo += 3 * r, ke(a = t, o = e)
        }
        var i, r, a, o;
        Vo.point = function(t, e) {
    ...
    function Ne(M) {
        function e(t) {
            return (w ? function(r) {
                ...
                function n(t, e) {
                    var n = re([t, e]),
                        i = M(t, e);
                    E(p, x, g, _, v, y, p = i[0], x = i[1], g = t, _ = n[0], v = n[1], y = n[2], w, r), r.point(p, x)
                }
                ...
                function o(t, e) {
                    n(u = t, e), c = p, l = x, h = _, d = v, f = y, m.point = n
                }

                function s() {
                    E(p, x, g, _, v, y, c, l, u, h, d, f, w, r), (m.lineEnd = i)()
                }
                var u, c, l, h, d, f, g, p, x, _, v, y, m = {
                    point: t,
                    lineStart: e,
                    lineEnd: i,
                    polygonStart: function() {
        ...
        function E(t, e, n, i, r, a, o, s, u, c, l, h, d, f) {
            ...
            if (4 * V < x && d--) {
                var _ = i + c,
                    ...
                    w = Math.asin(y /= m),
                    S = ia(ia(y) - 1) < ma || ia(n - u) < ma ? (n + u) / 2 : Math.atan2(v, _),
                    b = M(S, w),
                    A = b[0],
                    T = b[1],
                    P = A - t,
                    C = T - e,
                    L = p * P - g * C;
                (V < L * L / x || .3 < ia((g * P + p * C) / x - .5) || i * c + r * l + a * h < G) && (E(t, e, n, i, r, a, A, T, S, _ /= m, v /= m, y, d, f), f.point(A, T), E(A, T, S, _, v, y, o, s, u, c, l, h, d, f))
            }
        }
        var V = .5,
            G = Math.cos(30 * Pa),
        ...
        return e.precision = function(t) {
            return arguments.length ? (w = 0 < (V = t * t) && 16, e) : Math.sqrt(V)
        }, e
    }
    ...
    function He(t) {
        ...
        function n(t) {
            return (t = s.invert((t[0] - u) / d, (c - t[1]) / d)) && [t[0] * Ca, t[1] * Ca]
        }
        ...
        var a, o, s, u, c, l, h = Ne(function(t, e) {
        ...
        return e.stream = function(t) {
                ...
                return arguments.length ? (m = null == t ? (S = t, wo) : function(r) {
                    function f(t, e) {
                    ...
                    function g(t, e, n) {
                        ...
                        if (!(p < 0)) {
                            ...
                            var b = m - y,
                                A = ia(b - Sa) < ma;
                            if (!A && S < w && (v = w, w = S, S = v), A || b < ma ? A ? 0 < w + S ^ _[1] < (ia(_[0] - y) < ma ? w : S) : w <= _[1] && _[1] <= S : Sa < b ^ (y <= _[0] && _[0] <= m)) {
                                var T = ue(d, (-f + x) / g);
                    ...
                    function p(t, e) {
                        var n = x ? r : Sa - r,
                            i = 0;
                        return t < -n ? i |= 1 : n < t && (i |= 2), e < -n ? i |= 4 : n < e && (i |= 8), i
                    }
                    var P = Math.cos(r),
                        x = 0 < P,
                        _ = ia(P) > ma;
                    return Se(f, function(s) {
                        var u, c, l, h, d;
                        return {
                            lineStart: function() {
                                h = l = !1, d = 1
                            ...
                            point: function(t, e) {
                                var n, i = [t, e],
                                    r = f(t, e),
                                    a = x ? r ? 0 : p(t, e) : r ? p(t + (t < 0 ? Sa : -Sa), e) : 0;
                                if (!u && (h = l = r) && s.lineStart(), r !== l && (n = g(u, i), (he(u, n) || he(i, n)) && (i[0] += ma, i[1] += ma, r = f(i[0], i[1]))), r !== l) d = 0, r ? (s.lineStart(), n = g(i, u), s.point(n[0], n[1])) : (n = g(u, i), s.point(n[0], n[1]), s.lineEnd()), u = n;
                                else if (_ && u && x ^ r) {
                                    var o;
                                    a & c || !(o = g(i, u, !0)) || (d = 0, x ? (s.lineStart(), s.point(o[0][0], o[0][1]), s.point(o[1][0], o[1][1]), s.lineEnd()) : (s.point(o[1][0], o[1][1]), s.lineEnd(), s.lineStart(), s.point(o[0][0], o[0][1])))
                                }!r || u && he(u, i) || s.point(i[0], i[1]), u = i, l = r, c = a
                            },
                            lineEnd: function() {
                                l && s.lineEnd(), u = null
                            },
                    ...
                    }, Ze(r, 6 * Pa), x ? [0, -r] : [-Sa, r - Sa])
                }((S = +t) * Pa), r()) : S
            }, e.clipExtent = function(t) {
                return arguments.length ? (w = (b = t) ? Ce(t[0][0], t[0][1], t[1][0], t[1][1]) : R, r()) : b
            }, e.scale = function(t) {
                return arguments.length ? (d = +t, i()) : d
            }, e.translate = function(t) {
                return arguments.length ? (f = +t[0], g = +t[1], i()) : [f, g]
            }, e.center = function(t) {
                return arguments.length ? (p = t[0] % 360 * Pa, x = t[1] % 360 * Pa, i()) : [p * Ca, x * Ca]
            }, e.rotate = function(t) {
                return arguments.length ? (_ = t[0] % 360 * Pa, v = t[1] % 360 * Pa, y = 2 < t.length ? t[2] % 360 * Pa : 0, i()) : [_ * Ca, v * Ca, y * Ca]
    ...
    function Ue(t, e, n) {
        return t ? e || n ? _e(We(t), Qe(e, n)) : We(t) : e || n ? Qe(e, n) : je
    }
    ...
    function Ze(s, u) {
        ...
        return function(t, e, n, i) {
            var r = n * u;
            null != t ? (t = Ke(c, t), e = Ke(c, e), (0 < n ? t < e : e < t) && (t += n * ba)) : (t = s + n * ba, e = s - .5 * r);
            for (var a, o = t; 0 < n ? e < o : o < e; o -= r) i.point((a = le([c, -l * Math.cos(o), -l * Math.sin(o)]))[0], a[1])
        }
    }
    ...
    function rn(t, e) {
        ...
        return a ? (n.invert = function(t, e) {
            ...
            return [Math.atan2(t, n) / a, 2 * Math.atan(Math.pow(o / i, 1 / a)) - Ta]
        }, n) : on
    }
    ...
    function an(t, e) {
        ...
        var i = Math.cos(t),
            ...
            a = i / r + t;
        return ia(r) < ma ? Be : (n.invert = function(t, e) {
            var n = a - e;
    ...
    function yn(t) {
        var e = t.circle,
            ...
            s = [t];
        vn(t);
        for (var u = a; u.circle && ia(n - u.circle.x) < ma && ia(i - u.circle.cy) < ma;) a = u.P, s.unshift(u), vn(u), u = a;
        s.unshift(u), Cn(u);
        for (var c = o; c.circle && ia(n - c.circle.x) < ma && ia(i - c.circle.cy) < ma;) o = c.N, s.push(c), vn(c), c = o;
        s.push(c), Cn(c);
        var l, h = s.length;
        for (l = 1; l < h; ++l) c = s[l], u = s[l - 1], Vn(c.edge, u.site, c.site, r);
        u = s[0], (c = s[h - 1]).edge = En(u.site, c.site, null, r), Pn(u), Pn(c)
    }
    ...
    function mn(t) {
        for (var e, n, i, r, a = t.x, o = t.y, s = Ho._; s;)
            if (i = wn(s, o) - a, ma < i) s = s.L;
                ...
                if (r = a - Sn(s, o), !(ma < r)) {
                    -ma < i ? (e = s.P, n = s) : -ma < r ? n = (e = s).N : e = n = s;
                    break
                }
                if (!s.R) {
                    e = s;
        ...
        if (Ho.insert(e, u), e || n) {
            if (e === n) return Cn(e), n = _n(e.site), Ho.insert(u, n), u.edge = n.edge = En(e.site, u.site), Pn(e), void Pn(n);
            ...
            Vn(n.edge, c, g, m), u.edge = En(c, t, null, m), n.edge = En(t, g, null, m), Pn(e), Pn(n)
        }
    }
    ...
    function wn(t, e) {
        ...
        var l = s - i,
            h = 1 / a - 1 / c,
            d = l / c;
        return h ? (-d + Math.sqrt(d * d - 2 * h * (l * l / (-2 * c) - u + c / 2 + r - a / 2))) / h + i : (i + s) / 2
    }
            ...
            if (i !== a) {
                ...
                if (!(-wa <= h)) {
                    var d = u * u + c * c,
                        ...
                        x = p + s,
                        _ = Uo.pop() || new Tn;
                    _.arc = t, _.site = r, _.x = g + o, _.y = x + Math.sqrt(g * g + p * p), _.cy = x, t.circle = _;
    ...
    function Cn(t) {
        var e = t.circle;
        e && (e.P || (Yo = e.N), Bo.remove(e), Uo.push(e), Rn(e), t.circle = null)
    }
    ...
    function En(t, e, n, i) {
        var r = new Mn(t, e);
        return zo.push(r), n && Vn(r, t, e, n), i && Vn(r, e, t, i), Xo[t.i].edges.push(new Gn(r, t, e)), Xo[e.i].edges.push(new Gn(r, e, t)), r
    }
    ...
    function Nn(t, e) {
        var n, i, r, a = t.sort(Fn).pop();
        for (zo = [], Xo = new Array(t.length), Ho = new kn, Bo = new kn;;)
            if (r = Yo, a && (!r || a.y < r.y || a.y === r.y && a.x < r.x)) a.x === n && a.y === i || (Xo[a.i] = new bn(a), mn(a), n = a.x, i = a.y), a = t.pop();
            else {
                if (!r) break;
                yn(r.arc)
            }
        e && (function(t) {
            for (var e, n = zo, i = Pe(t[0][0], t[0][1], t[1][0], t[1][1]), r = n.length; r--;)(!Ln(e = n[r], t) || !i(e) || ia(e.a.x - e.b.x) < ma && ia(e.a.y - e.b.y) < ma) && (e.a = e.b = null, n.splice(r, 1))
        }(e), function(t) {
            for (var e, n, i, r, a, o, s, u, c, l, h = t[0][0], d = t[1][0], f = t[0][1], g = t[1][1], p = Xo, x = p.length; x--;)
                if ((a = p[x]) && a.prepare())
                    for (u = (s = a.edges).length, o = 0; o < u;) i = (l = s[o].end()).x, r = l.y, e = (c = s[++o % u].start()).x, n = c.y, (ia(i - e) > ma || ia(r - n) > ma) && (s.splice(o, 0, new Gn((_ = a.site, v = l, y = ia(i - h) < ma && ma < g - r ? {
                        x: h,
                        y: ia(e - h) < ma ? n : g
                    } : ia(r - g) < ma && ma < d - i ? {
                        x: ia(n - g) < ma ? e : d,
                        ...
                        x: ia(n - f) < ma ? e : h,
                        y: f
                    } : null, m = void 0, (m = new Mn(_, null)).a = v, m.b = y, zo.push(m), m), a.site, null)), ++u);
            var _, v, y, m
        }(e));
        var o = {
            cells: Xo,
    ...
    function Hn(t, e) {
        ...
        var n = t.r,
            ...
            s = e.b - r;
        return function(t) {
            return "#" + pt(Math.round(n + a * t)) + pt(Math.round(i + o * t)) + pt(Math.round(r + s * t))
        }
    }
    ...
    function jn(t, i) {
        var e, n, r, a = Wo.lastIndex = Qo.lastIndex = 0,
            o = -1,
            s = [],
            u = [];
        for (t += "", i += "";
            (e = Wo.exec(t)) && (n = Qo.exec(i));)(r = n.index) > a && (r = i.slice(a, r), s[o] ? s[o] += r : s[++o] = r), (e = e[0]) === (n = n[0]) ? s[o] ? s[o] += n : s[++o] = n : (s[++o] = null, u.push({
            i: o,
            x: Bn(e, n)
        })), a = Qo.lastIndex;
        return a < i.length && (r = i.slice(a), s[o] ? s[o] += r : s[++o] = r), s.length < 2 ? u[0] ? (i = u[0].x, function(t) {
            return i(t) + ""
        }) : function() {
            return i
        } : (i = u.length, function(t) {
    ...
    function Un(t, e) {
        for (var n, i = qr.interpolators.length; 0 <= --i && !(n = qr.interpolators[i](t, e)););
        return n
    }
    ...
    function ri(t) {
        var e, n, i, r = [t.a, t.b],
            ...
            o = oi(r),
            s = ai(r, a),
            u = oi(((e = a)[0] += (i = -s) * (n = r)[0], e[1] += i * n[1], e)) || 0;
        r[0] * a[1] < a[0] * r[1] && (r[0] *= -1, r[1] *= -1, o *= -1, s *= -1), this.rotate = (o ? Math.atan2(r[1], r[0]) : Math.atan2(-a[0], a[1])) * Ca, this.translate = [t.e, t.f], this.scale = [o, u], this.skew = u ? Math.atan2(s, u) * Ca : 0
    }
    ...
    function ui(t, e) {
        var n, i, r, a, o, s, u, c, l = [],
            h = [];
        return t = qr.transform(t), e = qr.transform(e),
            function(t, e, n, i) {
                if (t[0] !== e[0] || t[1] !== e[1]) {
            ...
            }(t.translate, e.translate, l, h), o = t.rotate, s = e.rotate, u = l, c = h, o !== s ? (180 < o - s ? s += 360 : 180 < s - o && (o += 360), c.push({
                i: u.push(si(u) + "rotate(", null, ")") - 2,
                x: Bn(o, s)
            })) : s && u.push(si(u) + "rotate(" + s + ")"), n = t.skew, i = e.skew, r = l, a = h, n !== i ? a.push({
                i: r.push(si(r) + "skewX(", null, ")") - 2,
                x: Bn(n, i)
            ...
            function(t, e, n, i) {
                ...
                } else 1 === e[0] && 1 === e[1] || n.push(si(n) + "scale(" + e + ")")
            }(t.scale, e.scale, l, h), t = e = null,
            function(t) {
    ...
    function hi(t) {
        for (var e = t.source, n = t.target, i = function(t, e) {
                if (t === e) return t;
                for (var n = di(t), i = di(e), r = n.pop(), a = i.pop(), o = null; r === a;) o = r, r = n.pop(), a = i.pop();
                return o
            }(e, n), r = [e]; e !== i;) e = e.parent, r.push(e);
    ...
    function _i(t, e) {
        return qr.rebind(t, e, "sort", "children", "value"), (t.nodes = t).links = bi, t
    }
    ...
    function bi(t) {
        return qr.merge(t.map(function(e) {
    ...
    function Mi(t) {
        for (var e, n = 1, i = 0, r = t[0][1], a = t.length; n < a; ++n)(e = t[n][1]) > r && (i = n, r = e);
        return i
    }
    ...
    function Fi(t) {
        ...
        if ((n = t.children) && (c = n.length)) {
            var n, i, r, a, o, s, u, c, l = 1 / 0,
                h = -1 / 0,
                d = 1 / 0,
                f = -1 / 0;
            if (n.forEach(zi), (i = n[0]).x = -i.r, i.y = 0, e(i), 1 < c && ((r = n[1]).x = r.r, r.y = 0, e(r), 2 < c))
                for (Hi(i, r, a = n[2]), e(a), Ii(i, a), Ii(i._pack_prev = a, r), r = i._pack_next, o = 3; o < c; o++) {
                    Hi(i, r, a = n[o]);
                    var g = 0,
                        p = 1,
                        x = 1;
                    ...
                    if (1 == g)
                        for (u = i._pack_prev; u !== s._pack_prev && !Ni(u, a); u = u._pack_prev, x++);
                    g ? (p < x || p == x && r.r < i.r ? Di(i, r = s) : Di(i = u, r), o--) : (Ii(i, a), e(r = a))
                }
            var _ = (l + h) / 2,
                v = (d + f) / 2,
                y = 0;
            for (o = 0; o < c; o++)(a = n[o]).x -= _, a.y -= v, y = Math.max(y, a.r + Math.sqrt(a.x * a.x + a.y * a.y));
            t.r = y, n.forEach(Xi)
        }
    }
    ...
    function Ki(t, e) {
        var n, i = 0,
            ...
            a = t[i],
            o = t[r];
        return o < a && (n = i, i = r, r = n, n = a, a = o, o = n), t[i] = e.floor(a), t[r] = e.ceil(o), t
    }
    ...
    function Ji(n, t, e, i) {
        ...
        for (n[s] < n[0] && (n = n.slice().reverse(), t = t.slice().reverse()); ++o <= s;) r.push(e(n[o - 1], n[o])), a.push(i(t[o - 1], t[o]));
        return function(t) {
    ...
    function nr(t, e) {
        ...
        var n = Wi(t),
            ...
            a = e / i * r;
        return a <= .15 ? r *= 10 : a <= .35 ? r *= 5 : a <= .75 && (r *= 2), n[0] = Math.ceil(n[0] / r) * r, n[1] = Math.floor(n[1] / r) * r + .5 * r, n[2] = r, n
    }
    ...
    function rr(t, e, n) {
        ...
        if (n) {
            ...
            if (s.shift(), "s" === s[8]) {
                ...
                return s[7] || (s[7] = "." + ar(u.scale(o[2]))), s[8] = "f", n = qr.format(s.join("")),
                    function(t) {
                        return n(u.scale(t)) + u.symbol
                    }
            }
            s[7] || (s[7] = "." + (i = s[8], a = ar((r = o)[2]), i in ss ? Math.abs(a - ar(Math.max(ia(r[0]), ia(r[1])))) + +("e" !== i) : a - 2 * ("%" === i))), n = s.join("")
        } else n = ",." + ar(o[2]) + "f";
        return qr.format(n)
    }
    ...
    function gr(t, e, n, i, r) {
        var a = t[0] - e[0],
            ...
            L = A - g,
            M = T - p;
        return L * L + M * M < P * P + C * C && (S = A, b = T), [
            [S - u, b - c],
            [S * n / y, b * n / y]
        ]
    }
    ...
    function pr(c) {
        function e(t) {
            ...
            for (var n, i = [], r = [], a = -1, o = t.length, s = wt(l), u = wt(h); ++a < o;) d.call(this, n = t[a], a) ? r.push([+s.call(this, n, a), +u.call(this, n, a)]) : r.length && (e(), r = []);
        ...
        return e.x = function(t) {
            ...
            return arguments.length ? (n = "function" == typeof t ? f = t : (f = ps.get(t) || xr).key, e) : n
    ...
    function mr(t, e) {
        if (e.length < 1 || t.length != e.length && t.length != e.length + 2) return xr(t);
        var n = t.length != e.length,
            ...
            s = o,
            u = 1;
        if (n && (i += "Q" + (a[0] - 2 * o[0] / 3) + "," + (a[1] - 2 * o[1] / 3) + "," + a[0] + "," + a[1], r = t[1], u = 2), 1 < e.length) {
            s = e[1], a = t[u], u++, i += "C" + (r[0] + o[0]) + "," + (r[1] + o[1]) + "," + (a[0] - s[0]) + "," + (a[1] - s[1]) + "," + a[0] + "," + a[1];
            for (var c = 2; c < e.length; c++, u++) a = t[u], s = e[c], i += "S" + (a[0] - s[0]) + "," + (a[1] - s[1]) + "," + a[0] + "," + a[1]
        }
        if (n) {
            var l = t[u];
    ...
    function wr(t, e) {
        for (var n, i = [], r = (1 - e) / 2, a = t[0], o = t[1], s = 1, u = t.length; ++s < u;) n = a, a = o, o = t[s], i.push([r * (o[0] - n[0]), r * (o[1] - n[1])]);
        return i
    }
    ...
    function Sr(t) {
        ...
        for (t.push(t[n - 1]); ++e <= n;) i = t[e], o.shift(), o.push(i[0]), s.shift(), s.push(i[1]), Ar(u, o, s);
    ...
    function Ar(t, e, n) {
        t.push("C", br(xs, e), ",", br(xs, n), ",", br(_s, e), ",", br(_s, n), ",", br(vs, e), ",", br(vs, n))
    }
    ...
    function Pr(t) {
        for (var e, n, i, r, a = [], o = function(t) {
                for (var e = 0, n = t.length - 1, i = [], r = t[0], a = t[1], o = i[0] = Tr(r, a); ++e < n;) i[e] = (o + (o = Tr(r = a, a = t[e + 1]))) / 2;
                return i[e] = o, i
            }(t), s = -1, u = t.length - 1; ++s < u;) e = Tr(t[s], t[s + 1]), ia(e) < ma ? o[s] = o[s + 1] = 0 : 9 < (r = (n = o[s] / e) * n + (i = o[s + 1] / e) * i) && (r = 3 * e / Math.sqrt(r), o[s] = r * n, o[s + 1] = r * i);
        for (s = -1; ++s <= u;) r = (t[Math.min(u, s + 1)][0] - t[Math.max(0, s - 1)][0]) / (6 * (1 + o[s] * o[s])), a.push([r || 0, o[s] * r || 0]);
        return a
    }

    function Cr(t) {
        for (var e, n, i, r = -1, a = t.length; ++r < a;) n = (e = t[r])[0], i = e[1] - Ta, e[0] = n * Math.cos(i), e[1] = n * Math.sin(i);
        return t
    }
    ...
    function Lr(g) {
        function e(t) {
            ...
            for (var n, i, r, a = [], o = [], s = [], u = -1, c = t.length, l = wt(p), h = wt(_), d = p === x ? function() {
                    return i
                } : wt(x), f = _ === v ? function() {
                    return r
                } : wt(v); ++u < c;) y.call(this, n = t[u], u) ? (o.push([i = +l.call(this, n, u), r = +h.call(this, n, u)]), s.push([+d.call(this, n, u), +f.call(this, n, u)])) : o.length && (e(), o = [], s = []);
        ...
        return e.x = function(t) {
            ...
            return arguments.length ? (n = "function" == typeof t ? m = t : (m = ps.get(t) || xr).key, w = m.reverse || m, S = m.closed ? "M" : "L", e) : n
        }, e.tension = function(t) {
    ...
    function Rr(i) {
        return function() {
            var t, e, n;
            (t = this[i]) && (n = t[e = t.active]) && (n.timer.c = null, n.timer.t = NaN, --t.count ? delete t[e] : delete this[i], t.active += .5, n.event && n.event.interrupt.call(this, this.__data__, n.index))
        }
    }
    ...
    function Ir(t, i, r, a) {
        var o = t.id,
            s = t.namespace;
        return X(t, "function" == typeof r ? function(t, e, n) {
    ...
    function Fr(a, o, r, s, t) {
        function n(t) {
            var e = g.active,
                n = g[e];
            for (var i in n && (n.timer.c = null, n.timer.t = NaN, --g.count, delete g[e], n.event && n.event.interrupt.call(a, a.__data__, n.index)), g)
                if (+i < s) {
                    var r = g[i];
            ...
            }, 0, c), g.active = s, p.event && p.event.start.call(a, a.__data__, o), f = [], p.tween.forEach(function(t, e) {
                (e = e.call(a, a.__data__, o)) && f.push(e)
            }), d = p.ease, h = p.duration
        }

        function u(t) {
            for (var e = t / h, n = d(e), i = f.length; 0 < i;) f[--i].call(a, n);
            return 1 <= e ? (p.event && p.event.end.call(a, a.__data__, o), --g.count ? delete g[s] : delete a[r], 1) : void 0
        }
        var c, l, h, d, f, g = a[r] || (a[r] = {
                active: 0,
                count: 0
            }),
            p = g[s];
        p || (c = t.time, l = At(function(t) {
            var e = p.delay;
    ...
    function Yr(e, r, t) {
        ...
        function s(t, e) {
            var n = (t[1] - t[0]) / e,
                i = qr.bisect(Rs, n);
            return i == Rs.length ? [r.year, nr(t.map(function(t) {
                return t / 31536e6
            }), e)[2]] : i ? r[n / Rs[i - 1] < Rs[i] / n ? i - 1 : i] : [Ds, nr(t, e)[2]]
        }
        return o.invert = function(t) {
            ...
            return a && (e = a[0], n = a[1]), o.domain(Ki(t, 1 < n ? {
                floor: function(t) {
            ...
            var n = Wi(o.domain()),
                i = null == t ? s(n, 10) : "number" == typeof t ? s(n, t) : !t.range && [{
                    range: t
                }, e];
            return i && (t = i[0], e = i[1]), t.range(n[0], Br(+n[1] + 1), e < 1 ? 1 : e)
    ...
    qr.ascending = o, qr.descending = function(t, e) {
        ...
        if (1 === arguments.length) {
            ...
            for (; ++a < o;) null != (i = t[a]) && (i < n && (n = i), r < i && (r = i))
        } else {
            for (; ++a < o;)
            ...
            for (; ++a < o;) null != (i = e.call(t, t[a], a)) && (i < n && (n = i), r < i && (r = i))
        }
        return [n, r]
    }, qr.sum = function(t, e) {
        var n, i = 0,
        ...
        if (1 === arguments.length)
            ...
            for (; ++a < r;) l(n = +e.call(t, t[a], a)) && (i += n);
        return i
        ...
        if (1 === arguments.length)
            ...
            for (; ++a < r;) l(n = c(e.call(t, t[a], a))) ? i += n : --o;
        return o ? i / o : void 0
        ...
        if (1 === arguments.length)
            ...
            for (; ++a < r;) l(n = c(e.call(t, t[a], a))) && i.push(n);
        return i.length ? qr.quantile(i.sort(o), .5) : void 0
        ...
        var n, i, r = t.length,
            ...
            u = 0;
        if (1 === arguments.length)
            for (; ++s < r;) l(n = c(t[s])) && (o += (i = n - a) * (n - (a += i / ++u)));
        else
            for (; ++s < r;) l(n = c(e.call(t, t[s], s))) && (o += (i = n - a) * (n - (a += i / ++u)));
    ...
    var na = t(o);
    qr.bisectLeft = na.left, qr.bisect = qr.bisectRight = na.right, qr.bisector = function(n) {
        return t(1 === n.length ? function(t, e) {
            return o(n(t), e)
        } : n)
    }, qr.shuffle = function(t, e, n) {
        (a = arguments.length) < 3 && (n = t.length, a < 2 && (e = 0));
        for (var i, r, a = n - e; a;) r = Math.random() * a-- | 0, i = t[a + e], t[a + e] = t[r + e], t[r + e] = i;
        return t
    }, qr.permute = function(t, e) {
        for (var n = e.length, i = new Array(n); n--;) i[n] = t[e[n]];
        return i
    }, qr.pairs = function(t) {
        for (var e = 0, n = t.length - 1, i = t[0], r = new Array(n < 0 ? 0 : n); e < n;) r[e] = [i, i = t[++e]];
        return r
    }, qr.transpose = function(t) {
        if (!(r = t.length)) return [];
        for (var e = -1, n = qr.min(t, u), i = new Array(n); ++e < n;)
            for (var r, a = -1, o = i[e] = new Array(r); ++a < r;) o[a] = t[a][e];
        return i
    }, qr.zip = function() {
    ...
    qr.range = function(t, e, n) {
        ...
        var n = new v;
        if (t instanceof v) t.forEach(function(t, e) {
            n.set(t, e)
        });
            ...
            if (1 === arguments.length)
                ...
                for (; ++r < a;) n.set(e.call(t, i = t[r], r), i)
        } else
    ...
    e(v, {
        ...
        function h(n, t, i) {
            ...
            for (var e, r, a, o, s = -1, u = t.length, c = p[i++], l = new v; ++s < u;)(o = l.get(e = c(r = t[s]))) ? o.push(r) : l.set(e, [r]);
            return n ? (r = n(), a = function(t, e) {
                r.set(t, h(n, e, i))
            }) : (r = {}, a = function(t, e) {
                r[t] = h(n, e, i)
            }), l.forEach(a), r
        ...
        var e = new g;
        if (t)
            for (var n = 0, i = t.length; n < i; ++n) e.add(t[n]);
        return e
    }, e(g, {
        has: r,
        add: function(t) {
        ...
        for (var n, i = 1, r = arguments.length; ++i < r;) t[n = arguments[i]] = p(t, e, e[n]);
        return t
    };
    var oa = ["webkit", "ms", "moz", "Moz", "o", "O"];
    qr.dispatch = function() {
        for (var t = new y, e = -1, n = arguments.length; ++e < n;) t[arguments[e]] = m(t);
        return t
    }, y.prototype.on = function(t, e) {
        var n = t.indexOf("."),
            i = "";
        if (0 <= n && (i = t.slice(n + 1), t = t.slice(0, n)), t) return arguments.length < 2 ? this[t].on(i) : this[t].on(i, e);
    ...
    "function" == typeof Sizzle && (ca = function(t, e) {
        return Sizzle(t, e)[0] || null
    }, la = Sizzle, ha = Sizzle.matchesSelector), qr.selection = function() {
    ...
    da.select = function(t) {
        ...
        for (var o = -1, s = this.length; ++o < s;) {
            ...
            for (var u = -1, c = i.length; ++u < c;)(r = i[u]) ? (e.push(n = t.call(r, r.__data__, u, o)), n && "__data__" in r && (n.__data__ = r.__data__)) : e.push(null)
        }
        return S(a)
        ...
        for (var r = -1, a = this.length; ++r < a;)
            for (var o = this[r], s = -1, u = o.length; ++s < u;)(n = o[s]) && (i.push(e = Qr(t.call(n, n.__data__, s, r))), e.parentNode = n);
        return S(i)
    };
    ...
    qr.ns = {
        ...
        qualify: function(t) {
            var e = t.indexOf(":"),
                n = t;
            return 0 <= e && "xmlns" !== (n = t.slice(0, e)) && (t = t.slice(e + 1)), ga.hasOwnProperty(n) ? {
                space: ga[n],
                local: t
            } : t
        }
        ...
        return t = D(t), this.select(function() {
            return this.appendChild(t.apply(this, arguments))
        })
    }, da.insert = function(t, e) {
        return t = D(t), e = b(e), this.select(function() {
        ...
        function e(t, e) {
            ...
            if (g) {
                var h, d = new v,
                    f = new Array(a);
                for (n = -1; ++n < a;)(i = t[n]) && (d.has(h = g.call(i, i.__data__, n)) ? l[n] = i : d.set(h, i), f[n] = h);
                for (n = -1; ++n < o;)(i = d.get(h = g.call(e, r = e[n], n))) ? !0 !== i && ((u[n] = i).__data__ = r) : c[n] = F(r), d.set(h, !0);
                for (n = -1; ++n < a;) n in f && !0 !== d.get(f[n]) && (l[n] = t[n])
            } else {
                for (n = -1; ++n < s;) i = t[n], r = e[n], i ? (i.__data__ = r, u[n] = i) : c[n] = F(r);
                for (; n < o; ++n) c[n] = F(e[n]);
                for (; n < a; ++n) l[n] = t[n]
            }
            c.update = u, c.parentNode = u.parentNode = l.parentNode = t.parentNode, p.push(c), x.push(u), _.push(l)
        }
        var n, i, r = -1,
            a = this.length;
        if (!arguments.length) {
            for (t = new Array(a = (n = this[0]).length); ++r < a;)(i = n[r]) && (t[r] = i.__data__);
            return t
        }
        var p = H([]),
            x = S([]),
        ...
        if ("function" == typeof t)
            for (; ++r < a;) e(n = this[r], t.call(n, n.parentNode.__data__, r));
        else
            for (; ++r < a;) e(n = this[r], t);
        return x.enter = function() {
            return p
        }, x.exit = function() {
            return _
        }, x
        ...
        for (var a = 0, o = this.length; a < o; a++) {
            ...
            for (var s = 0, u = n.length; s < u; s++)(i = n[s]) && t.call(i, i.__data__, s, a) && e.push(i)
        }
        return S(r)
    }, da.order = function() {
        for (var t = -1, e = this.length; ++t < e;)
            for (var n, i = this[t], r = i.length - 1, a = i[r]; 0 <= --r;)(n = i[r]) && (a && a !== n.nextSibling && a.parentNode.insertBefore(n, a), a = n);
        return this
    }, da.sort = function(t) {
        t = function(n) {
    ...
    var pa = [];
    qr.selection.enter = H, (qr.selection.enter.prototype = pa).append = da.append, pa.empty = da.empty, pa.node = da.node, pa.call = da.call, pa.size = da.size, pa.select = function(t) {
        for (var e, n, i, r, a, o = [], s = -1, u = this.length; ++s < u;) {
            i = (r = this[s]).update, o.push(e = []), e.parentNode = r.parentNode;
            for (var c = -1, l = r.length; ++c < l;)(a = r[c]) ? (e.push(i[c] = n = t.call(r.parentNode, a.__data__, c, s)), n.__data__ = a.__data__) : e.push(null)
        }
        return S(o)
        ...
        return arguments.length < 2 && (o = this, e = function(t, e, n) {
            var i, r = o[n].update,
                a = r.length;
            for (n != u && (u = n, s = 0), s <= e && (s = e + 1); !(i = r[s]) && ++s < a;);
            return i
        }), da.insert.call(this, t, e);
        var o, s, u
    }, qr.select = function(t) {
        var e;
        return "string" == typeof t ? (e = [ca(t, Zr)]).parentNode = Zr.documentElement : (e = [t]).parentNode = s(t), S([e])
    }, qr.selectAll = function(t) {
        var e;
        return "string" == typeof t ? (e = Qr(la(t, Zr))).parentNode = Zr.documentElement : (e = Qr(t)).parentNode = null, S([e])
    ...
    qr.touch = function(t, e, n) {
        ...
        function t(l, h, d, f, g) {
            return function() {
                var i, t = qr.event.target.correspondingElement || qr.event.target,
                    r = this.parentNode,
                    a = p.of(this, arguments),
                    o = 0,
                    s = l(),
                    e = ".drag" + (null == s ? "" : "-" + s),
                    n = qr.select(d(t)).on(f + e, function() {
                        var t, e, n = h(r, s);
                        n && (t = n[0] - c[0], e = n[1] - c[1], o |= t | e, a({
                            type: "drag",
                            x: (c = n)[0] + i[0],
                            y: n[1] + i[1],
                            dx: t,
                        ...
                        h(r, s) && (n.on(f + e, null).on(g + e, null), u(o), a({
                            type: "dragend"
                        }))
                    }),
                    u = U(t),
                    c = h(r, s);
                x ? i = [(i = x.apply(this, arguments)).x - c[0], i.y - c[1]] : i = [0, 0], a({
                    type: "dragstart"
                })
            }
        }
        ...
        return arguments.length < 2 && (t = w().touches), t ? Qr(t).map(function(t) {
            var e = q(n, t);
    ...
    qr.interpolateZoom = function(t, e) {
        var n, o, s = t[0],
            ...
            h = r - u,
            d = l * l + h * h;
        if (d < wa) o = Math.log(a / c) / La, n = function(t) {
            ...
            o = (_ - x) / La, n = function(t) {
                var e, n, i = t * o,
                    r = J(x),
                    a = c / (2 * f) * (r * (n = La * i + x, ((n = Math.exp(2 * n)) - 1) / (n + 1)) - (e = x, ((e = Math.exp(e)) - 1 / e) / 2));
        ...
        function r(t) {
            t.on(M, T).on(Ea + ".zoom", n).on("dblclick.zoom", i).on(V, P)
        }
        ...
        function w(t, e) {
            var n;
            e = [(n = e)[0] * L.k + L.x, n[1] * L.k + L.y], L.x += t[0] - e[0], L.y += t[1] - e[1]
        }
        ...
        function S(t, e, n, i) {
            t.__chart__ = {
                ...
                y: L.y,
                k: L.k
            }, m(Math.pow(2, i)), w(c = e, n), t = qr.select(t), 0 < _ && (t = t.transition().duration(_)), t.call(r.event)
        }

        function e() {
            d && d.domain(h.range().map(function(t) {
                return (t - L.x) / L.k
            }).map(h.invert)), g && g.domain(f.range().map(function(t) {
                return (t - L.y) / L.k
            }).map(f.invert))
        }
        ...
        function P() {
            function l() {
                var t = qr.touches(f);
                return c = L.k, t.forEach(function(t) {
            ...
            function t() {
                ...
                for (var e = qr.event.changedTouches, n = 0, i = e.length; n < i; ++n) p[e[n].identifier] = null;
                var r = l(),
                    a = Date.now();
                if (1 === r.length) {
                    if (a - C < 500) {
                        var o = r[0];
                        S(f, o, p[o.identifier], Math.floor(Math.log(L.k) / Math.LN2) + 1), O()
                    }
                    C = a
                } else if (1 < r.length) {
                    o = r[0];
            ...
            function h() {
                ...
                if (i) {
                    var s = (s = n[0] - t[0]) * s + (s = n[1] - t[1]) * s,
                        u = x && Math.sqrt(s / x);
                    t = [(t[0] + n[0]) / 2, (t[1] + n[1]) / 2], e = [(e[0] + i[0]) / 2, (e[1] + i[1]) / 2], m(u * c)
                }
                C = null, w(t, e), b(g)
            }
            ...
            function d() {
                if (qr.event.touches.length) {
                    for (var t = qr.event.changedTouches, e = 0, n = t.length; e < n; ++e) delete p[t[e].identifier];
        ...
        function n() {
            ...
            l ? clearTimeout(l) : (As.call(this), a = s(c = o || qr.mouse(this)), u(t)), l = setTimeout(function() {
                l = null, A(t)
            }, 50), O(), m(Math.pow(2, .002 * Ma()) * L.k), w(c, a), b(t)
        }

        function i() {
            var t = qr.mouse(this),
                e = Math.log(L.k) / Math.LN2;
            S(this, t, s(t), qr.event.shiftKey ? Math.ceil(e) - 1 : Math.floor(e) + 1)
        }
        var a, c, o, l, C, h, d, f, g, L = {
                x: 0,
                y: 0,
                k: 1
            },
        ...
        return Ea || (Ea = "onwheel" in Zr ? (Ma = function() {
            return -qr.event.deltaY * (qr.event.deltaMode ? 120 : 1)
        }, "wheel") : "onmousewheel" in Zr ? (Ma = function() {
            return qr.event.wheelDelta
        }, "mousewheel") : (Ma = function() {
            return -qr.event.detail
        }, "MozMousePixelScroll")), r.event = function(t) {
            t.each(function() {
                var s = G.of(this, arguments),
                    e = L;
                Ss ? qr.select(this).transition().each("start.zoom", function() {
                    L = this.__chart__ || {
                        x: 0,
                        y: 0,
                        k: 1
                    ...
                    var i = p[0],
                        ...
                        r = c ? c[0] : i / 2,
                        a = c ? c[1] : t / 2,
                        o = qr.interpolateZoom([(r - L.x) / L.k, (a - L.y) / L.k, i / L.k], [(r - e.x) / e.k, (a - e.y) / e.k, i / e.k]);
                    return function(t) {
                        var e = o(t),
                            n = i / e[2];
                        this.__chart__ = L = {
            ...
            return arguments.length ? (x = null == t ? Va : [+t[0], +t[1]], r) : x
        }, r.center = function(t) {
            ...
            return arguments.length ? (h = (d = t).copy(), L = {
                x: 0,
                y: 0,
                k: 1
            }, r) : d
        }, r.y = function(t) {
            return arguments.length ? (f = (g = t).copy(), L = {
                x: 0,
                y: 0,
                k: 1
            }, r) : g
    ...
    ka.brighter = function(t) {
        return new rt(this.h, this.c, Math.min(100, this.l + Ra * (arguments.length ? t : 1)))
    }, ka.darker = function(t) {
        return new rt(this.h, this.c, Math.max(0, this.l - Ra * (arguments.length ? t : 1)))
    }, ka.rgb = function() {
    ...
    Na.brighter = function(t) {
        return new ot(Math.min(100, this.l + Ra * (arguments.length ? t : 1)), this.a, this.b)
    }, Na.darker = function(t) {
        return new ot(Math.max(0, this.l - Ra * (arguments.length ? t : 1)), this.a, this.b)
    }, Na.rgb = function() {
    ...
    Fa.brighter = function(t) {
        ...
        var e = this.r,
            n = this.g,
            i = this.b;
        return e || n || i ? (e && e < 30 && (e = 30), n && n < 30 && (n = 30), i && i < 30 && (i = 30), new dt(Math.min(255, e / t), Math.min(255, n / t), Math.min(255, i / t))) : new dt(30, 30, 30)
    }, Fa.darker = function(t) {
        return new dt((t = Math.pow(.7, arguments.length ? t : 1)) * this.r, t * this.g, t * this.b)
    }, Fa.hsl = function() {
    ...
    za.forEach(function(t, e) {
        za.set(t, ft(e))
    }), qr.functor = wt, qr.xhr = St(R), qr.dsv = function(r, a) {
        function o(t, e, n) {
            arguments.length < 3 && (n = e, e = null);
            var i = bt(t, a, null == e ? s : u(e), n);
            return i.row = function(t) {
                return arguments.length ? i.response(null == (e = t) ? s : u(t)) : e
            }, i
        }
        ...
        return o.parse = function(t, i) {
            ...
            function e() {
                ...
                if (34 === r.charCodeAt(t)) {
                    ...
                    return c = e + 2, 13 === (n = r.charCodeAt(e + 1)) ? (a = !0, 10 === r.charCodeAt(e + 2) && ++c) : 10 === n && (a = !0), r.slice(t + 1, e).replace(/""/g, '"')
                }
                for (; c < u;) {
                    var n, i = 1;
                    if (10 === (n = r.charCodeAt(c++))) a = !0;
                    else if (13 === n) a = !0, 10 === r.charCodeAt(c) && (++c, ++i);
                    else if (n !== d) continue;
                    return r.slice(t, c - i)
                }
                return r.slice(t)
            }
            for (var n, a, o = {}, s = {}, i = [], u = r.length, c = 0, l = 0;
                (n = e()) !== s;) {
            ...
            }), [i.map(c).join(r)].concat(t.map(function(e) {
                return i.map(function(t) {
                    return c(e[t])
                }).join(r)
            })).join("\n")
    ...
    var Xa, Ha, Ya, Ba, ja = this[x(this, "requestAnimationFrame")] || function(t) {
        setTimeout(t, 17)
    };
    qr.timer = function() {
    ...
    var Ua = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"].map(function(t, e) {
    ...
    qr.formatPrefix = function(t, e) {
        var n = 0;
        return (t = +t) && (t < 0 && (t *= -1), e && (t = qr.round(t, Lt(t, e))), n = 1 + Math.floor(1e-12 + Math.log(t) / Math.LN10), n = Math.max(-24, Math.min(24, 3 * Math.floor((n - 1) / 3)))), Ua[8 + n / 3]
    };
    var qa = /(?:([^{])?([<>=^]))?([+\- ])?([$#])?(0)?(\d+)?(,)?(\.-?\d+)?([a-z%])?/i,
        Wa = qr.map({
            b: function(t) {
            ...
            r: function(t, e) {
                return (t = qr.round(t, Lt(t, e))).toFixed(Math.max(0, Math.min(20, Lt(t * (1 + 1e-15), e))))
            }
        }),
        Qa = qr.time = {},
        Za = Date;
    ...
    Qa.year = Vt(function(t) {
        return (t = Qa.day(t)).setMonth(0, 1), t
    }, function(t, e) {
        t.setFullYear(t.getFullYear() + e)
    }, function(t) {
        return t.getFullYear()
    }), Qa.years = Qa.year.range, Qa.years.utc = Qa.year.utc.range, Qa.day = Vt(function(t) {
        var e = new Za(2e3, 0);
        ...
        return t.getDate() - 1
    }), Qa.days = Qa.day.range, Qa.days.utc = Qa.day.utc.range, Qa.dayOfYear = function(t) {
        var e = Qa.year(t);
        ...
        n = 7 - n;
        var e = Qa[t] = Vt(function(t) {
            return (t = Qa.day(t)).setDate(t.getDate() - (t.getDay() + n) % 7), t
        }, function(t, e) {
            t.setDate(t.getDate() + 7 * Math.floor(e))
        }, function(t) {
            var e = Qa.year(t).getDay();
            return Math.floor((Qa.dayOfYear(t) + (e + n) % 7) / 7) - (e !== n)
        });
        Qa[t + "s"] = e.range, Qa[t + "s"].utc = e.utc.range, Qa[t + "OfYear"] = function(t) {
            var e = Qa.year(t).getDay();
    ...
    qr.locale = function(t) {
        return {
            numberFormat: (e = t, A = e.decimal, s = e.thousands, u = e.grouping, i = e.currency, T = u && s ? function(t, e) {
                for (var n = t.length, i = [], r = 0, a = u[0], o = 0; 0 < n && 0 < a && (e < o + a + 1 && (a = Math.max(1, e - o)), i.push(t.substring(n -= a, n + a)), !((o += a + 1) > e));) a = u[r = (r + 1) % u.length];
                ...
                var e = qa.exec(t),
                    ...
                    w = !1,
                    S = !0;
                switch (x && (x = +x.substring(1)), (f || "0" === l && "=" === h) && (f = l = "0", h = "="), _) {
                    case "n":
                        p = !0, _ = "g";
                        break;
                    case "%":
                ...
                "$" === n && (y = i[0], m = i[1]), "r" != _ || x || (_ = "g"), null != x && ("g" == _ ? x = Math.max(1, Math.min(21, x)) : "e" != _ && "f" != _ || (x = Math.max(0, Math.min(20, x)))), _ = Wa.get(_) || Mt;
                var b = f && p;
                return function(t) {
                    var e = m;
                    if (w && t % 1) return "";
                    ...
                    var r, a, o = (t = _(t, x)).lastIndexOf(".");
                    if (o < 0) {
                        var s = S ? t.lastIndexOf("e") : -1;
                        s < 0 ? (r = t, a = "") : (r = t.substring(0, s), a = t.substring(s))
                    } else r = t.substring(0, o), a = A + t.substring(o + 1);
                    !f && p && (r = T(r, 1 / 0));
                    var u = y.length + r.length + a.length + (b ? 0 : n.length),
                        c = u < g ? new Array(u = g - u + 1).join(l) : "";
                    return b && (r = T(c + r, c.length ? g - a.length : 1 / 0)), n += y, t = r + a, ("<" === h ? n + t + c : ">" === h ? c + n + t : "^" === h ? c.substring(0, u >>= 1) + n + t + c.substring(u) : n + (b ? t : c + t)) + e
                }
            }),
            timeFormat: function(t) {
                function i(s) {
                    function t(t) {
                        for (var e, n, i, r = [], a = -1, o = 0; ++a < u;) 37 === s.charCodeAt(a) && (r.push(s.slice(o, a)), null != (n = $a[e = s.charAt(++a)]) && (e = s.charAt(++a)), (i = m[e]) && (e = i(t, null == n ? "e" === e ? " " : "0" : n)), r.push(e), o = a + 1);
                    ...
                    return t.parse = function(t) {
                        ...
                        var n = null != e.Z && Za !== Et,
                            i = new(n ? Et : Za);
                        return "j" in e ? i.setFullYear(e.y, 0, e.j) : "W" in e || "U" in e ? ("w" in e || (e.w = "W" in e ? 1 : 0), i.setFullYear(e.y, 0, 1), i.setFullYear(e.y, 0, "W" in e ? (e.w + 6) % 7 + 7 * e.W - (i.getDay() + 5) % 7 : e.w + 7 * e.U - (i.getDay() + 6) % 7)) : i.setFullYear(e.y, e.m, e.d), i.setHours(e.H + (e.Z / 100 | 0), e.M + e.Z % 100, e.S, e.L), n ? i._ : i
                    }, t.toString = function() {
                        return s
                    }, t
                }
                ...
                function r(t, e, n, i) {
                    for (var r, a, o, s = 0, u = e.length, c = n.length; s < u;) {
                        ...
                        if (37 === (r = e.charCodeAt(s++))) {
                            if (o = e.charAt(s++), !(a = w[o in $a ? e.charAt(s++) : o]) || (i = a(t, n, i)) < 0) return -1
                ...
                var m = {
                    ...
                    w = {
                        a: function(t, e, n) {
                            ...
                            return i ? (t.w = p.get(i[0].toLowerCase()), n + i[0].length) : -1
                        },
                        A: function(t, e, n) {
                            d.lastIndex = 0;
                        ...
                        B: function(t, e, n) {
                            ...
                            return i ? (t.m = _.get(i[0].toLowerCase()), n + i[0].length) : -1
                        },
                        c: function(t, e, n) {
    ...
    qr.format = eo.numberFormat, qr.geo = {}, $t.prototype = {
        s: 0,
        t: 0,
        add: function(t) {
            Jt(t, this.t, no), Jt(no.s, this.s, this), this.s ? this.t += no.t : this.s = no.t
        },
        reset: function() {
            this.s = this.t = 0
        },
    ...
    var io = {
            ...
            FeatureCollection: function(t, e) {
                for (var n = t.features, i = -1, r = n.length; ++i < r;) te(n[i].geometry, e)
            }
        },
        ro = {
            Sphere: function(t, e) {
            ...
            MultiLineString: function(t, e) {
                for (var n = t.coordinates, i = -1, r = n.length; ++i < r;) ee(n[i], e, 0)
            },
            Polygon: function(t, e) {
                ne(t.coordinates, e)
            },
            MultiPolygon: function(t, e) {
                for (var n = t.coordinates, i = -1, r = n.length; ++i < r;) ne(n[i], e)
            },
            GeometryCollection: function(t, e) {
                for (var n = t.geometries, i = -1, r = n.length; ++i < r;) te(n[i], e)
            }
        };
    ...
    var ao, oo = new $t,
        so = {
            ...
            polygonEnd: function() {
                var t = 2 * oo;
                ao += t < 0 ? 4 * Sa + t : t, so.lineStart = so.lineEnd = so.point = _
            }
        };
    qr.geo.bounds = function() {
        ...
        function i(t, e) {
            ...
            if (_) {
                ...
                u ? t < x ? h(d, t) > h(d, g) && (g = t) : h(t, g) > h(d, g) && (d = t) : d <= g ? (t < d && (d = t), g < t && (g = t)) : x < t ? h(d, t) > h(d, g) && (g = t) : h(t, g) > h(d, g) && (d = t)
            } else l(t, e);
            _ = n, x = t
        }
        ...
        function a() {
            n(o, s), so.lineEnd(), ia(v) > ma && (d = -(g = 180)), m[0] = d, m[1] = g, _ = null
        }
        ...
        var d, f, g, p, x, o, s, _, v, y, m, w = {
            point: l,
            lineStart: t,
            lineEnd: e,
            polygonStart: function() {
                w.point = n, w.lineStart = r, w.lineEnd = a, v = 0, so.polygonStart()
            },
            polygonEnd: function() {
                so.polygonEnd(), w.point = l, w.lineStart = t, w.lineEnd = e, oo < 0 ? (d = -(g = 180), f = -(p = 90)) : ma < v ? p = 90 : v < -ma && (f = -90), m[0] = d, m[1] = g
            }
        };
        return function(t) {
            if (p = g = -(d = f = 1 / 0), y = [], qr.geo.stream(t, w), a = y.length) {
                y.sort(u);
                for (var e = 1, n = [s = y[0]]; e < a; ++e) c((r = y[e])[0], s) || c(r[1], s) ? (h(s[0], r[1]) > h(s[0], s[1]) && (s[1] = r[1]), h(r[0], s[1]) > h(s[0], s[1]) && (s[0] = r[0])) : n.push(s = r);
                for (var i, r, a, o = -1 / 0, s = (e = 0, n[a = n.length - 1]); e <= a; s = r, ++e) r = n[e], (i = h(s[1], r[0])) > o && (o = i, d = r[0], g = s[1])
            }
            return y = m = null, d === 1 / 0 || f === 1 / 0 ? [
                [NaN, NaN],
                [NaN, NaN]
            ] : [
                [d, f],
        ...
        uo = co = lo = ho = fo = go = po = xo = _o = vo = yo = 0, qr.geo.stream(t, mo);
        var e = _o,
            n = vo,
            i = yo,
            r = e * e + n * n + i * i;
        return r < wa && (e = go, n = po, i = xo, co < ma && (e = lo, n = ho, i = fo), (r = e * e + n * n + i * i) < wa) ? [NaN, NaN] : [Math.atan2(n, e) * Ca, $(i / Math.sqrt(r)) * Ca]
    };
    var uo, co, lo, ho, fo, go, po, xo, _o, vo, yo, mo = {
            sphere: _,
            point: de,
            lineStart: ge,
            lineEnd: pe,
        ...
        wo = Se(ve, function(h) {
            ...
            return {
                ...
                point: function(t, e) {
                    var n, i, r, a, o, s, u, c = 0 < t ? Sa : -Sa,
                        l = ia(t - f);
                    ia(l - Sa) < ma ? (h.point(f, g = 0 < (g + e) / 2 ? Ta : -Ta), h.point(p, g), h.lineEnd(), h.lineStart(), h.point(c, g), h.point(t, g), d = 0) : p !== c && Sa <= l && (ia(f - p) < ma && (f -= p * ma), ia(t - c) < ma && (t -= c * ma), n = f, i = g, r = t, a = e, u = Math.sin(n - r), g = ia(u) > ma ? Math.atan((Math.sin(i) * (s = Math.cos(a)) * Math.sin(r) - Math.sin(a) * (o = Math.cos(i)) * Math.sin(n)) / (o * s * u)) : (i + a) / 2, h.point(p, g), h.lineEnd(), h.lineStart(), h.point(c, g), d = 0), h.point(f = t, g = e), p = c
                },
                lineEnd: function() {
                    h.lineEnd(), f = g = NaN
                },
            ...
            var r;
            if (null == t) r = n * Ta, i.point(-Sa, r), i.point(0, r), i.point(Sa, r), i.point(Sa, 0), i.point(Sa, -r), i.point(0, -r), i.point(-Sa, -r), i.point(-Sa, 0), i.point(-Sa, r);
    ...
    qr.geo.clipExtent = function() {
        var e, n, i, r, a, o, s = {
            ...
            extent: function(t) {
                return arguments.length ? (o = Ce(e = +t[0][0], n = +t[0][1], i = +t[1][0], r = +t[1][1]), a && (a.valid = !1, a = null), s) : [
                    [e, n],
                    [i, r]
                ]
            }
        ...
        var i, a, o, s, u = qr.geo.albers(),
            c = qr.geo.conicEqualArea().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]),
            l = qr.geo.conicEqualArea().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]),
            h = {
                point: function(t, e) {
                    i = [t, e]
                }
        ...
        return r.invert = function(t) {
            var e = u.scale(),
                ...
                i = (t[0] - n[0]) / e,
                r = (t[1] - n[1]) / e;
            return (.12 <= r && r < .234 && -.425 <= i && i < -.214 ? c : .166 <= r && r < .234 && -.214 <= i && i < -.115 ? l : u).invert(t)
        }, r.stream = function(t) {
            var n = u.stream(t),
                i = c.stream(t),
                r = l.stream(t);
            ...
            return arguments.length ? (u.precision(t), c.precision(t), l.precision(t), r) : u.precision()
        }, r.scale = function(t) {
            return arguments.length ? (u.scale(t), c.scale(.35 * t), l.scale(t), r.translate(u.translate())) : u.scale()
        }, r.translate = function(t) {
            if (!arguments.length) return u.translate();
            var e = u.scale(),
                n = +t[0],
                i = +t[1];
            return a = u.translate(t).clipExtent([
                [n - .455 * e, i - .238 * e],
                [n + .455 * e, i + .238 * e]
            ]).stream(h).point, o = c.translate([n - .307 * e, i + .201 * e]).clipExtent([
                [n - .425 * e + ma, i + .12 * e + ma],
                [n - .214 * e - ma, i + .234 * e - ma]
            ]).stream(h).point, s = l.translate([n - .205 * e, i + .212 * e]).clipExtent([
                [n - .214 * e + ma, i + .166 * e + ma],
                [n - .115 * e - ma, i + .234 * e - ma]
            ]).stream(h).point, r
        }, r.scale(1070)
    };
    var bo, Ao, To, Po, Co, Lo, Mo = {
            point: _,
            lineStart: _,
            lineEnd: _,
            polygonStart: function() {
        ...
        Eo = {
            point: function(t, e) {
                t < To && (To = t), Co < t && (Co = t), e < Po && (Po = e), Lo < e && (Lo = e)
            },
            lineStart: _,
            lineEnd: _,
            polygonStart: _,
    ...
    qr.geo.path = function() {
        function e(t) {
            return t && ("function" == typeof u && o.pointRadius(+u.apply(this, arguments)), s && s.valid || (s = a(o)), qr.geo.stream(t, s)), o.result()
        }
        ...
        return e.area = function(t) {
            ...
            return lo = ho = fo = go = po = xo = _o = vo = yo = 0, qr.geo.stream(t, a(Vo)), yo ? [_o / yo, vo / yo] : xo ? [go / xo, po / xo] : fo ? [lo / fo, ho / fo] : [NaN, NaN]
        }, e.bounds = function(t) {
            return Co = Lo = -(To = Po = 1 / 0), qr.geo.stream(t, a(Eo)), [
                [To, Po],
                [Co, Lo]
            ]
        }, e.projection = function(t) {
            return arguments.length ? (a = (r = t) ? t.stream || (n = t, e = Ne(function(t, e) {
                return n([t * Ca, e * Ca])
            }), function(t) {
                return Ye(e(t))
            }) : R, i()) : r;
            ...
            return arguments.length ? (o = null == (n = t) ? new Ve : new De(t), "function" != typeof u && o.pointRadius(u), i()) : n
        }, e.pointRadius = function(t) {
            return arguments.length ? (u = "function" == typeof t ? t : (o.pointRadius(+t), +t), e) : u
    ...
    }, qr.geo.projection = Xe, qr.geo.projectionMutator = He, (qr.geo.equirectangular = function() {
        return Xe(Be)
    }).raw = Be.invert = Be, qr.geo.rotation = function(e) {
        function t(t) {
            return (t = e(t[0] * Pa, t[1] * Pa))[0] *= Ca, t[1] *= Ca, t
        }
        return e = Ue(e[0] % 360 * Pa, e[1] * Pa, 2 < e.length ? e[2] * Pa : 0), t.invert = function(t) {
            return (t = e.invert(t[0] * Pa, t[1] * Pa))[0] *= Ca, t[1] *= Ca, t
        }, t
    }, je.invert = Be, qr.geo.circle = function() {
        function e() {
        ...
        function t() {
            return qr.range(Math.ceil(a / x) * x, r, x).map(d).concat(qr.range(Math.ceil(c / _) * _, u, _).map(f)).concat(qr.range(Math.ceil(i / g) * g, n, g).filter(function(t) {
                return ia(t % x) > ma
            }).map(l)).concat(qr.range(Math.ceil(s / p) * p, o, p).filter(function(t) {
                return ia(t % _) > ma
            }).map(h))
        }
        var n, i, r, a, o, s, u, c, l, h, d, f, g = 10,
            p = g,
            x = 90,
            _ = 360,
            v = 2.5;
        return e.lines = function() {
            ...
            return {
                type: "Polygon",
                coordinates: [d(a).concat(f(u).slice(1), d(r).reverse().slice(1), f(c).reverse().slice(1))]
            }
        }, e.extent = function(t) {
            return arguments.length ? e.majorExtent(t).minorExtent(t) : e.minorExtent()
        }, e.majorExtent = function(t) {
            return arguments.length ? (a = +t[0][0], r = +t[1][0], c = +t[0][1], u = +t[1][1], r < a && (t = a, a = r, r = t), u < c && (t = c, c = u, u = t), e.precision(v)) : [
                [a, c],
                [r, u]
            ]
        }, e.minorExtent = function(t) {
            return arguments.length ? (i = +t[0][0], n = +t[1][0], s = +t[0][1], o = +t[1][1], n < i && (t = i, i = n, n = t), o < s && (t = s, s = o, o = t), e.precision(v)) : [
                [i, s],
                [n, o]
            ]
        }, e.step = function(t) {
            ...
            return arguments.length ? (v = +t, l = $e(s, o, 90), h = Je(i, n, v), d = $e(c, u, 90), f = Je(a, r, v), e) : v
        }, e.majorExtent([
            [-180, -90 + ma],
            [180, 90 - ma]
        ]).minorExtent([
        ...
        function e() {
            return {
                type: "LineString",
                coordinates: [n || r.apply(this, arguments), i || a.apply(this, arguments)]
            }
        }
        var n, i, r = tn,
            a = en;
        return e.distance = function() {
            return qr.geo.distance(n || r.apply(this, arguments), i || a.apply(this, arguments))
        }, e.source = function(t) {
            return arguments.length ? (n = "function" == typeof(r = t) ? null : t, e) : r
        }, e.target = function(t) {
            return arguments.length ? (i = "function" == typeof(a = t) ? null : t, e) : a
        }, e.precision = function() {
            return arguments.length ? e : 0
        }, e
    }, qr.geo.interpolate = function(t, e) {
        return n = t[0] * Pa, i = t[1] * Pa, r = e[0] * Pa, a = e[1] * Pa, o = Math.cos(i), s = Math.sin(i), u = Math.cos(a), c = Math.sin(a), l = o * Math.cos(n), h = o * Math.sin(n), d = u * Math.cos(r), f = u * Math.sin(r), g = 2 * Math.asin(Math.sqrt(tt(a - i) + o * u * tt(r - n))), p = 1 / Math.sin(g), (x = g ? function(t) {
            ...
            lineStart: function() {
                function n(t, e) {
                    var n = Math.sin(e *= Pa),
                        ...
                        r = ia((t *= Pa) - o),
                        a = Math.cos(r);
                    Go += Math.atan2(Math.sqrt((r = i * Math.sin(r)) * r + (r = u * n - s * i * a) * r), s * n + u * i * a), o = t, s = n, u = i
                }
                var o, s, u;
                ko.point = function(t, e) {
                    o = t * Pa, s = Math.sin(e *= Pa), u = Math.cos(e), ko.point = n
                }, ko.lineEnd = function() {
    ...
    (qr.geo.azimuthalEquidistant = function() {
        return Xe(Oo)
    }).raw = Oo, (qr.geo.conicConformal = function() {
        return Le(rn)
    }).raw = rn, (qr.geo.conicEquidistant = function() {
        return Le(an)
    }).raw = an;
    ...
    }).raw = un, qr.geom = {}, qr.geom.hull = function(t) {
        function e(t) {
            ...
            var e, n = wt(d),
                ...
                a = [],
                o = [];
            for (e = 0; e < r; e++) a.push([+n.call(this, t[e], e), +i.call(this, t[e], e), e]);
    ...
    Fo.area = function() {
        for (var t, e = -1, n = this.length, i = this[n - 1], r = 0; ++e < n;) t = i, i = this[e], r += t[1] * i[0] - t[0] * i[1];
        return .5 * r
        ...
        var e, n, i = -1,
            ...
            o = 0,
            s = this[r - 1];
        for (arguments.length || (t = -1 / (6 * this.area())); ++i < r;) e = s, s = this[i], n = e[0] * s[1] - s[0] * e[1], a += (e[0] + s[0]) * n, o += (e[1] + s[1]) * n;
        return [a * t, o * t]
    }, Fo.clip = function(t) {
        for (var e, n, i, r, a, o, s = pn(t), u = -1, c = this.length - pn(this), l = this[c - 1]; ++u < c;) {
            for (e = t.slice(), t.length = 0, r = this[u], a = e[(i = e.length - s) - 1], n = -1; ++n < i;) fn(o = e[n], l, r) ? (fn(a, l, r) || t.push(gn(a, o, l, r)), t.push(o)) : fn(a, l, r) && t.push(gn(a, o, l, r)), a = o;
            s && t.push(t[0]), l = r
        }
        return t
    };
    var zo, Xo, Ho, Yo, Bo, jo = [],
        Uo = [];
    bn.prototype.prepare = function() {
        ...
        insert: function(t, e) {
            ...
            if (t) {
                ...
                n = t
            } else this._ ? (t = Dn(this._), e.P = null, (e.N = t).P = t.L = e, n = t) : (e.P = e.N = null, this._ = e, n = null);
            for (e.L = e.R = null, e.U = n, e.C = !0, t = e; n && n.C;) n === (i = n.U).L ? (r = i.R) && r.C ? (n.C = r.C = !1, i.C = !0, t = i) : (t === n.R && (On(this, n), n = (t = n).U), n.C = !1, i.C = !0, In(this, i)) : (r = i.L) && r.C ? (n.C = r.C = !1, i.C = !0, t = i) : (t === n.L && (In(this, n), n = (t = n).U), n.C = !1, i.C = !0, On(this, i)), n = t.U;
            this._.C = !1
        },
        remove: function(t) {
            ...
            var e, n, i, r = t.U,
                a = t.L,
                o = t.R;
            if (n = a ? o ? Dn(o) : a : o, r ? r.L === t ? r.L = n : r.R = n : this._ = n, a && o ? (i = n.C, n.C = t.C, ((n.L = a).U = n) !== o ? (r = n.U, n.U = t.U, t = n.R, r.L = t, (n.R = o).U = n) : (n.U = r, t = (r = n).R)) : (i = t.C, t = n), t && (t.U = r), !i) {
                if (t && t.C) return void(t.C = !1);
                do {
                    if (t === this._) break;
                    if (t === r.L) {
                        if ((e = r.R).C && (e.C = !1, r.C = !0, On(this, r), e = r.R), e.L && e.L.C || e.R && e.R.C) {
                            e.R && e.R.C || (e.L.C = !1, e.C = !0, In(this, e), e = r.R), e.C = r.C, r.C = e.R.C = !1, On(this, r), t = this._;
                            break
                        }
                    } else if ((e = r.L).C && (e.C = !1, r.C = !0, In(this, r), e = r.L), e.L && e.L.C || e.R && e.R.C) {
                        e.L && e.L.C || (e.R.C = !1, e.C = !0, On(this, e), e = r.L), e.C = r.C, r.C = e.L.C = !1, In(this, r), t = this._;
                        break
                    }
                    e.C = !0, r = (t = r).U
                } while (!t.C);
        ...
        function e(r) {
            var a = new Array(r.length),
                ...
                u = l[1][0],
                c = l[1][1];
            return Nn(n(r), l).cells.forEach(function(t, e) {
                var n = t.edges,
                    i = t.site;
        ...
        var i = cn,
            ...
            o = r,
            l = qo;
        return t ? e(t) : (e.links = function(e) {
            return Nn(n(e)).edges.filter(function(t) {
                return t.l && t.r
            }).map(function(t) {
                return {
                    source: e[t.l.i],
            ...
            var f = [];
            return Nn(n(d)).cells.forEach(function(t, e) {
                for (var n, i = t.site, r = t.edges.sort(An), a = -1, o = r.length, s = r[o - 1].edge, u = s.l === i ? s.r : s.l; ++a < o;) s, n = u, u = (s = r[a].edge).l === i ? s.r : s.l, e < n.i && e < u.i && (l = n, h = u, ((c = i).x - h.x) * (l.y - c.y) - (c.x - l.x) * (h.y - c.y) < 0) && f.push([d[e], d[n.i], d[u.i]]);
                var c, l, h
            }), f
        }, e.x = function(t) {
            ...
            return arguments.length ? (l = null == t ? qo : t, e) : l === qo ? null : l
        }, e.size = function(t) {
    ...
    qr.geom.delaunay = function(t) {
        ...
        function e(t) {
                ...
                if (!isNaN(n) && !isNaN(i))
                    if (t.leaf) {
                        var u = t.x,
                            c = t.y;
                        if (null != u)
                            if (ia(u - n) + ia(c - i) < .01) h(t, e, n, i, r, a, o, s);
                            else {
                                var l = t.point;
                                t.x = t.y = t.point = null, h(t, l, u, c, r, a, o, s), h(t, e, n, i, r, a, o, s)
                            }
            ...
            function h(t, e, n, i, r, a, o, s) {
                var u = .5 * (r + o),
                    ...
                    h = c <= i,
                    d = h << 1 | l;
                t.leaf = !1, l ? r = u : o = u, h ? a = c : s = c, f(t = t.nodes[d] || (t.nodes[d] = {
                    leaf: !0,
                    nodes: [],
                    point: null,
                    x: null,
            ...
            var e, n, i, r, a, o, s, u, c, l = wt(b),
                d = wt(T);
            if (null != v) o = v, s = y, u = m, c = w;
            else if (u = c = -(o = s = 1 / 0), n = [], i = [], a = t.length, S)
                for (r = 0; r < a; ++r)(e = t[r]).x < o && (o = e.x), e.y < s && (s = e.y), e.x > u && (u = e.x), e.y > c && (c = e.y), n.push(e.x), i.push(e.y);
            else
                for (r = 0; r < a; ++r) {
                    var g = +l(e = t[r], r),
                        p = +d(e, r);
                    g < o && (o = g), p < s && (s = p), u < g && (u = g), c < p && (c = p), n.push(g), i.push(p)
                }
            var x = u - o,
                _ = c - s;
            _ < x ? c = s + x : u = o + _;
            ...
            if (A.visit = function(t) {
                    ! function t(e, n, i, r, a, o) {
                        if (!e(n, i, r, a, o)) {
                            var s = .5 * (i + a),
                                u = .5 * (r + o),
                                c = n.nodes;
                            c[0] && t(e, c[0], i, r, s, u), c[1] && t(e, c[1], s, r, a, u), c[2] && t(e, c[2], i, u, s, o), c[3] && t(e, c[3], s, u, a, o)
                        }
                    }(t, A, o, s, u, c)
                }, A.find = function(t) {
                    return e = A, x = t[0], _ = t[1], b = 1 / 0,
                        function t(e, n, i, r, a) {
                            if (!(m < n || w < i || r < v || a < y)) {
                                if (o = e.point) {
                                    ...
                                    if (c < b) {
                                        var l = Math.sqrt(b = c);
                                        v = x - l, y = _ - l, m = x + l, w = _ + l, S = o
                                    }
                                }
                                for (var h = e.nodes, d = .5 * (n + r), f = .5 * (i + a), g = (f <= _) << 1 | d <= x, p = g + 4; g < p; ++g)
                                    if (e = h[3 & g]) switch (3 & g) {
                                        case 0:
                                            t(e, n, i, d, f);
                                            break;
                                        case 1:
        ...
        var S, b = cn,
            T = ln;
        return (S = arguments.length) ? (b = zn, T = Xn, 3 === S && (w = y, m = v, y = v = 0), e(t)) : (e.x = function(t) {
            return arguments.length ? (b = t, e) : b
        }, e.y = function(t) {
            return arguments.length ? (T = t, e) : T
        }, e.extent = function(t) {
            return arguments.length ? (null == t ? v = y = m = w = null : (v = +t[0][0], y = +t[0][1], m = +t[1][0], w = +t[1][1]), e) : null == v ? null : [
                [v, y],
                [m, w]
            ]
        }, e.size = function(t) {
            return arguments.length ? (null == t ? v = y = m = w = null : (v = y = 0, m = +t[0], w = +t[1]), e) : null == v ? null : [m - v, w - y]
        }, e)
    }, qr.interpolateRgb = Hn, qr.interpolateObject = Yn, qr.interpolateNumber = Bn, qr.interpolateString = jn;
    var Wo = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g,
        Qo = new RegExp(Wo.source, "g");
    qr.interpolate = Un, qr.interpolators = [function(t, e) {
        var n = typeof e;
        return ("string" === n ? za.has(e.toLowerCase()) || /^(#|rgb\(|hsl\()/i.test(e) ? Hn : jn : e instanceof et ? Hn : Array.isArray(e) ? qn : "object" === n && isNaN(e) ? Yn : Bn)(t, e)
    ...
    var Zo = function() {
        ...
        Ko = qr.map({
            ...
            elastic: function(e, n) {
                var i;
                return arguments.length < 2 && (n = .45), arguments.length ? i = n / ba * Math.asin(1 / e) : (e = 1, i = n / 4),
                    function(t) {
                        return 1 + e * Math.pow(2, -10 * t) * Math.sin((t - i) * ba / n)
                    }
            },
            back: function(e) {
                return e || (e = 1.70158),
    ...
    qr.ease = function(t) {
        ...
        return i = Ko.get(i) || Zo, r = $o.get(r) || R, e = r(i.apply(null, Wr.call(arguments, 1))),
            function(t) {
        ...
        var n = t.h,
            ...
            o = e.c - i,
            s = e.l - r;
        return isNaN(o) && (o = 0, i = isNaN(i) ? e.c : i), isNaN(a) ? (a = 0, n = isNaN(n) ? e.h : n) : 180 < a ? a -= 360 : a < -180 && (a += 360),
            function(t) {
        ...
        var n = t.h,
            ...
            o = e.s - i,
            s = e.l - r;
        return isNaN(o) && (o = 0, i = isNaN(i) ? e.s : i), isNaN(a) ? (a = 0, n = isNaN(n) ? e.h : n) : 180 < a ? a -= 360 : a < -180 && (a += 360),
            function(t) {
    ...
    }, qr.interpolateRound = ii, qr.transform = function(t) {
    ...
    qr.interpolateTransform = ui, qr.layout = {}, qr.layout.bundle = function() {
        return function(t) {
        ...
        function t() {
            ...
            for (w && s.sort(function(t, e) {
                    return w(o[t], o[e])
                }), S && u.forEach(function(t, n) {
                    t.sort(function(t, e) {
                        return S(y[n][t], y[n][e])
                    })
                }), t = (ba - A * m) / t, e = 0, i = -1; ++i < m;) {
                for (n = e, r = -1; ++r < m;) {
                    var c = s[i],
                        l = u[c][r],
                        h = y[c][l],
            ...
            for (i = -1; ++i < m;)
                for (r = i - 1; ++r < m;) {
                    var g = a[i + "-" + r],
                        p = a[r + "-" + i];
                    (g.value || p.value) && _.push(g.value < p.value ? {
                        source: p,
                        target: g
                    } : {
                        source: g,
        ...
        function x() {
            _.sort(function(t, e) {
                return b((t.source.value + t.target.value) / 2, (e.source.value + e.target.value) / 2)
            })
        }
        var _, v, y, m, w, S, b, e = {},
            A = 0;
        return e.matrix = function(t) {
            return arguments.length ? (m = (y = t) && y.length, _ = v = null, e) : y
        ...
        return r.tick = function() {
            if ((f *= .99) < .005) return d = null, _.end({
                type: "end",
                alpha: f = 0
            }), !0;
            var t, e, n, i, r, a, o, s, u, c = b.length,
                l = A.length;
            for (e = 0; e < l; ++e) i = (n = A[e]).source, (a = (s = (r = n.target).x - i.x) * s + (u = r.y - i.y) * u) && (s *= a = f * p[e] * ((a = Math.sqrt(a)) - g[e]) / a, u *= a, r.x -= s * (o = i.weight + r.weight ? i.weight / (i.weight + r.weight) : .5), r.y -= u * o, i.x += s * (o = 1 - o), i.y += u * o);
            if ((o = f * w) && (s = v[0] / 2, u = v[1] / 2, e = -1, o))
                for (; ++e < c;)(n = b[e]).x += (s - n.x) * o, n.y += (u - n.y) * o;
            if (m)
                for (function t(e, n, i) {
                        var r = 0,
                            a = 0;
                        if (e.charge = 0, !e.leaf)
                            for (var o, s = e.nodes, u = s.length, c = -1; ++c < u;) null != (o = s[c]) && (t(o, n, i), e.charge += o.charge, r += o.charge * o.cx, a += o.charge * o.cy);
                        if (e.point) {
                            e.leaf || (e.point.x += Math.random() - .5, e.point.y += Math.random() - .5);
                            var l = n * i[e.point.index];
                            e.charge += e.pointCharge = l, r += l * e.point.x, a += l * e.point.y
                        }
                        e.cx = r / e.charge, e.cy = a / e.charge
                    }(t = qr.geom.quadtree(b), f, x), e = -1; ++e < c;)(n = b[e]).fixed || t.visit(h(n));
            for (e = -1; ++e < c;)(n = b[e]).fixed ? (n.x = n.px, n.y = n.py) : (n.x -= (n.px - (n.px = n.x)) * y, n.y -= (n.py - (n.py = n.y)) * y);
            _.tick({
                type: "tick",
                alpha: f
            })
            ...
            return arguments.length ? (m = "function" == typeof t ? t : +t, r) : m
            ...
            return arguments.length ? (t = +t, f ? 0 < t ? f = t : (d.c = null, d.t = NaN, d = null, _.end({
                type: "end",
                alpha: f = 0
            })) : 0 < t && (_.start({
                type: "start",
            ...
            var s, u, e, c = b.length,
                l = A.length,
                n = v[0],
                i = v[1];
            for (s = 0; s < c; ++s)(e = b[s]).index = s, e.weight = 0;
            for (s = 0; s < l; ++s) "number" == typeof(e = A[s]).source && (e.source = b[e.source]), "number" == typeof e.target && (e.target = b[e.target]), ++e.source.weight, ++e.target.weight;
            for (s = 0; s < c; ++s) e = b[s], isNaN(e.x) && (e.x = t("x", n)), isNaN(e.y) && (e.y = t("y", i)), isNaN(e.px) && (e.px = e.x), isNaN(e.py) && (e.py = e.y);
            ...
            return e || (e = qr.behavior.drag().origin(R).on("dragstart.force", fi).on("drag.force", t).on("dragend.force", gi)), arguments.length ? void this.on("mouseover.force", pi).on("mouseout.force", xi).call(e) : e
        }, qr.rebind(r, _, "on")
    };
    var ts = 20,
        es = 1,
    ...
    qr.layout.hierarchy = function() {
        function s(t) {
            ...
            for (t.depth = 0; null != (e = n.pop());)
                if (i.push(e), (a = c.call(s, e, e.depth)) && (r = a.length)) {
                    for (var r, a, o; 0 <= --r;) n.push(o = a[r]), o.parent = e, o.depth = e.depth + 1;
                    l && (e.value = 0), e.children = a
                } else l && (e.value = +l.call(s, e, e.depth) || 0), delete e.children;
            return yi(t, function(t) {
                var e, n;
                u && (e = t.children) && e.sort(u), l && (n = t.parent) && (n.value += t.value)
            }), i
        }
        var u = Si,
            c = mi,
        ...
        return s.sort = function(t) {
            ...
            return l && (vi(t, function(t) {
                t.children && (t.value = 0)
            }), yi(t, function(t) {
                var e;
                t.children || (t.value = +l.call(s, t, t.depth) || 0), (e = t.parent) && (e.value += t.value)
            })), t
        }, s
        ...
        function e(t, e) {
            ...
            return function t(e, n, i, r) {
                ...
                if (e.x = n, e.y = e.depth * r, e.dx = i, e.dy = r, a && (o = a.length)) {
                    var o, s, u, c = -1;
                    for (i = e.value ? i / e.value : 0; ++c < o;) t(s = a[c], n, u = s.value * i, r), n += u
                }
            }(n[0], 0, r[0], r[1] / function t(e) {
                var n = e.children,
                    i = 0;
                if (n && (r = n.length))
        ...
        function d(n) {
            var e, t = n.length,
                ...
                l = qr.range(t),
                h = [];
            return null != g && l.sort(g === is ? function(t, e) {
                return i[e] - i[t]
            } : function(t, e) {
                return g(n[t], n[e])
    ...
    qr.layout.stack = function() {
        function h(t, e) {
            ...
            var a, o, s, u, c = g.call(h, i, e),
                l = n[0].length;
            for (s = 0; s < l; ++s)
                for (p.call(h, n[0][s], u = c[s], i[0][s][1]), o = 1; o < a; ++o) p.call(h, n[o][s], u += i[o - 1][s][1], i[o][s][1]);
            return t
        }
        var d = R,
            f = Ci,
            ...
            x = Ai,
            _ = Ti;
        return h.values = function(t) {
            return arguments.length ? (d = t, h) : d
        }, h.order = function(t) {
            return arguments.length ? (f = "function" == typeof t ? t : rs.get(t) || Ci, h) : f
        }, h.offset = function(t) {
            return arguments.length ? (g = "function" == typeof t ? t : as.get(t) || Li, h) : g
        }, h.x = function(t) {
    ...
    var rs = qr.map({
            "inside-out": function(t) {
                var e, n, i = t.length,
                    ...
                    c = [],
                    l = [];
                for (e = 0; e < i; ++e) n = o[e], s < u ? (s += a[n], c.push(n)) : (u += a[n], l.push(n));
        ...
        as = qr.map({
            ...
            wiggle: function(t) {
                var e, n, i, r, a, o, s, u, c, l = t.length,
                    h = t[0],
                    d = h.length,
                    f = [];
            ...
            expand: function(t) {
                ...
                for (n = 0; n < a; ++n) {
                    for (i = e = 0; e < r; e++) i += t[e][n][1];
                    if (i)
                        for (e = 0; e < r; e++) t[e][n][1] /= i;
                    else
                        for (e = 0; e < r; e++) t[e][n][1] = o
                }
                for (n = 0; n < a; ++n) s[n] = 0;
                return s
            },
    ...
    qr.layout.histogram = function() {
        function n(t, e) {
            for (var n, i, r = [], a = t.map(d, this), o = f.call(this, a, e), s = g.call(this, o, a, e), u = (e = -1, a.length), c = s.length - 1, l = h ? 1 : 1 / u; ++e < c;)(n = r[e] = []).dx = s[e + 1] - (n.x = s[e]), n.y = 0;
            if (0 < c)
                for (e = -1; ++e < u;)(i = a[e]) >= o[0] && i <= o[1] && ((n = r[qr.bisect(s, i, 1, c) - 1]).y += l, n.push(t[e]));
            return r
        }
        var h = !0,
            d = Number,
        ...
        function e(t, e) {
            ...
            if (i.x = i.y = 0, yi(i, function(t) {
                    t.r = +o(t.value)
                }), yi(i, Fi), l) {
                var s = l * (u ? 1 : Math.max(2 * i.r / r, 2 * i.r / a)) / 2;
                yi(i, function(t) {
                    t.r += s
                }), yi(i, Fi), yi(i, function(t) {
                    t.r -= s
                })
            }
            return function t(e, n, i, r) {
            ...
            }(i, r / 2, a / 2, u ? 1 : 1 / Math.max(2 * i.r / r, 2 * i.r / a)), n
        }
        var u, c = qr.layout.hierarchy().sort(Oi),
            l = 0,
            h = [1, 1];
        return e.size = function(t) {
            return arguments.length ? (h = t, e) : h
        }, e.radius = function(t) {
            return arguments.length ? (u = null == t || "function" == typeof t ? t : +t, e) : u
        }, e.padding = function(t) {
            return arguments.length ? (l = +t, e) : l
        }, _i(e, c)
            ...
            var n = g.call(this, t, e),
                ...
                r = function(t) {
                    for (var e, n = {
                        ...
                        for (var r, a = e.children, o = 0, s = a.length; o < s; ++o) i.push((a[o] = r = {
                            _: a[o],
                            parent: e,
        ...
        function h(t) {
            ...
            if (e.length) {
                ! function(t) {
                    for (var e, n = 0, i = 0, r = t.children, a = r.length; 0 <= --a;)(e = r[a]).z += n, e.m += n, n += e.s + (i += e.c)
                }(t);
            ...
            t.parent.A = function(t, e, n) {
                if (e) {
                    for (var i, r = t, a = t, o = e, s = r.parent.children[0], u = r.m, c = a.m, l = o.m, h = s.m; o = ji(o), r = Bi(r), o && r;) s = Bi(s), (a = ji(a)).a = t, 0 < (i = o.z + l - r.z - u + y(o._, r._)) && (_ = t, v = n, d = (x = o).a.parent === _.parent ? x.a : v, void 0, p = (g = i) / ((f = t).i - d.i), f.c -= p, f.s += g, d.c += p, f.z += g, f.m += g, u += i, c += i), l += o.m, u += r.m, h += s.m, c += a.m;
                    o && !ji(a) && (a.t = o, a.m += l - c), r && !Bi(s) && (s.t = r, s.m += u - h, n = t)
                }
                var d, f, g, p;
                var x, _, v;
                return n
        ...
        return e.separation = function(t) {
            ...
            return arguments.length ? (x = null == (p = t) ? f : null, e) : x ? null : p
        }, e.nodeSize = function(t) {
            return arguments.length ? (x = null == (p = t) ? null : f, e) : x ? p : null
        }, _i(e, g)
    }, qr.layout.cluster = function() {
        function e(t, e) {
            var r, n = l.call(this, t, e),
                i = n[0],
                a = 0;
            yi(i, function(t) {
                var e, n, i = t.children;
                i && i.length ? (t.x = (n = i).reduce(function(t, e) {
                    return t + e.x
                }, 0) / n.length, t.y = (e = i, 1 + qr.max(e, function(t) {
                    return t.y
            ...
            var o = function t(e) {
                ...
                u = o.x - h(o, s) / 2,
                c = s.x + h(s, o) / 2;
            return yi(i, f ? function(t) {
                t.x = (t.x - i.x) * d[0], t.y = (i.y - t.y) * d[1]
            } : function(t) {
                t.x = (t.x - u) / (c - u) * d[0], t.y = (1 - (i.y ? t.y / i.y : 1)) * d[1]
            }), n
        }
        ...
        function l(t, e) {
            for (var n, i, r = -1, a = t.length; ++r < a;) i = (n = t[r]).value * (e < 0 ? 0 : e), n.area = isNaN(i) || i <= 0 ? 0 : i
        }
        ...
        function h(t) {
            ...
            if (e && e.length) {
                var n, i, r, a = p(t),
                    ...
                    s = e.slice(),
                    u = 1 / 0,
                    c = "slice" === x ? a.dx : "dice" === x ? a.dy : "slice-dice" === x ? 1 & t.depth ? a.dy : a.dx : Math.min(a.dx, a.dy);
                for (l(s, a.dx * a.dy / t.value), o.area = 0; 0 < (r = s.length);) o.push(n = s[r - 1]), o.area += n.area, "squarify" !== x || (i = d(o, c)) <= u ? (s.pop(), u = i) : (o.area -= o.pop().area, f(o, c, a, !1), c = Math.min(a.dx, a.dy), o.length = o.area = 0, u = 1 / 0);
        ...
        function o(t) {
            ...
            if (e && e.length) {
                var n, i = p(t),
                    r = e.slice(),
                    a = [];
                for (l(r, i.dx * i.dy / t.value), a.area = 0; n = r.pop();) a.push(n), a.area += n.area, null != n.z && (f(a, n.z ? i.dx : i.dy, i, !r.length), a.length = a.area = 0);
                e.forEach(o)
            }
        }

        function d(t, e) {
            for (var n, i = t.area, r = 0, a = 1 / 0, o = -1, s = t.length; ++o < s;)(n = t[o].area) && (n < a && (a = n), r < n && (r = n));
            return e *= e, (i *= i) ? Math.max(e * r * _ / i, i / (e * a * _)) : 1 / 0
        }
        ...
        function f(t, e, n, i) {
            var r, a = -1,
                ...
                c = e ? g(t.area / e) : 0;
            if (e == n.dx) {
                for ((i || c > n.dy) && (c = n.dy); ++a < o;)(r = t[a]).x = s, r.y = u, r.dy = c, s += r.dx = Math.min(n.x + n.dx - s, c ? g(r.area / c) : 0);
                r.z = !0, r.dx += n.x + n.dx - s, n.y += c, n.dy -= c
            } else {
                for ((i || c > n.dx) && (c = n.dx); ++a < o;)(r = t[a]).x = s, r.y = u, r.dx = c, u += r.dy = Math.min(n.y + n.dy - u, c ? g(r.area / c) : 0);
        ...
        function i(t) {
            var e = r || a(t),
                n = e[0];
            return n.x = n.y = 0, n.value ? (n.dx = s[0], n.dy = s[1]) : n.dx = n.dy = 0, r && a.revalue(n), l([n], n.dx * n.dy / n.value), (r ? o : h)(n), c && (r = e), e
        }
        var r, a = qr.layout.hierarchy(),
            g = Math.round,
            s = [1, 1],
            u = null,
            p = Ui,
        ...
        return i.size = function(t) {
            ...
            return arguments.length ? (p = null == (u = n) ? Ui : "function" == (e = typeof n) ? function(t) {
                var e = n.call(i, t, t.depth);
                return null == e ? Ui(t) : qi(t, "number" == typeof e ? [e, e, e, e] : e)
            } : ("number" === e && (n = [n, n, n, n]), t), i) : u;
            var e
        }, i.round = function(t) {
            return arguments.length ? (g = t ? Math.round : Number, i) : g != Number
        }, i.sticky = function(t) {
    ...
    qr.scale.log = function() {
        return function t(e, u, c, l) {
            ...
            return r.invert = function(t) {
                ...
                return arguments.length ? (c = 0 <= t[0], e.domain((l = t.map(Number)).map(h)), r) : l
            }, r.base = function(t) {
                ...
                if (isFinite(a - r)) {
                    if (c) {
                        for (; r < a; r++)
                            for (var s = 1; s < o; s++) e.push(d(r) * s);
                        e.push(d(r))
                    } else
                        for (e.push(d(r)); r++ < a;)
                ...
                arguments.length < 2 ? n = us : "function" != typeof n && (n = qr.format(n));
                var i = Math.max(1, u * t / r.ticks().length);
                return function(t) {
                    var e = t / d(Math.round(h(t)));
                    return e * u < u - .5 && (e *= u), e <= i ? n(t) : ""
                }
            }, r.copy = function() {
    ...
    qr.scale.pow = function() {
        return function t(e, n, i) {
            ...
            return r.invert = function(t) {
                ...
                return arguments.length ? (a = or(n = t), o = or(1 / n), e.domain(i.map(a)), r) : n
            }, r.copy = function() {
                return t(e.copy(), n, i)
            }, tr(r, e)
        ...
        return function t(s, u) {
            function c(t) {
                return h[((r.get(t) || ("range" === u.t ? r.set(t, s.push(t)) : NaN)) - 1) % h.length]
            }
            ...
            return c.domain = function(t) {
                ...
                s = [], r = new v;
                for (var e, n = -1, i = t.length; ++n < i;) r.has(e = t[n]) || r.set(e, s.push(e));
                return c[u.t].apply(c, u.a)
            }, c.range = function(t) {
                return arguments.length ? (h = t, d = 0, u = {
                    t: "range",
                    a: arguments
                }, c) : h
                ...
                var n = t[0],
                    i = t[1],
                    r = s.length < 2 ? (n = (n + i) / 2, 0) : (i - n) / (s.length - 1 + e);
                return h = l(n + r * e / 2, r), d = 0, u = {
                    t: "rangePoints",
                    a: arguments
                }, c
                ...
                var n = t[0],
                    i = t[1],
                    r = s.length < 2 ? (n = i = Math.round((n + i) / 2), 0) : (i - n) / (s.length - 1 + e) | 0;
                return h = l(n + Math.round(r * e / 2 + (i - n - (s.length - 1 + e) * r) / 2), r), d = 0, u = {
                    t: "rangeRoundPoints",
                    a: arguments
                }, c
                ...
                return h = l(r + a * n, a), i && h.reverse(), d = a * (1 - e), u = {
                    t: "rangeBands",
                    a: arguments
                }, c
                ...
                return h = l(r + Math.round((a - r - (s.length - e) * o) / 2), o), i && h.reverse(), d = Math.round(o * (1 - e)), u = {
                    t: "rangeRoundBands",
                    a: arguments
                }, c
    ...
    var ls = [2062260, 16744206, 2924588, 14034728, 9725885, 9197131, 14907330, 8355711, 12369186, 1556175].map(gt),
        hs = [2062260, 11454440, 16744206, 16759672, 2924588, 10018698, 14034728, 16750742, 9725885, 12955861, 9197131, 12885140, 14907330, 16234194, 8355711, 13092807, 12369186, 14408589, 1556175, 10410725].map(gt),
        ds = [3750777, 5395619, 7040719, 10264286, 6519097, 9216594, 11915115, 13556636, 9202993, 12426809, 15186514, 15190932, 8666169, 11356490, 14049643, 15177372, 8077683, 10834324, 13528509, 14589654].map(gt),
        fs = [3244733, 7057110, 10406625, 13032431, 15095053, 16616764, 16625259, 16634018, 3253076, 7652470, 10607003, 13101504, 7695281, 10394312, 12369372, 14342891, 6513507, 9868950, 12434877, 14277081].map(gt);
    qr.scale.quantile = function() {
        return function t(n, i) {
            ...
            return r.domain = function(t) {
                return arguments.length ? (n = t.map(c).filter(l).sort(o), e()) : n
            }, r.range = function(t) {
                return arguments.length ? (i = t, e()) : i
            }, r.quantiles = function() {
                return a
            }, r.invertExtent = function(t) {
                return (t = i.indexOf(t)) < 0 ? [NaN, NaN] : [0 < t ? a[t - 1] : n[0], t < a.length ? a[t] : n[n.length - 1]]
            }, r.copy = function() {
                return t(n, i)
            }, e()
        }([], [])
        ...
        return function t(e, n, i) {
            ...
            var o, s;
            return r.domain = function(t) {
                return arguments.length ? (e = +t[0], n = +t[t.length - 1], a()) : [e, n]
            }, r.range = function(t) {
                return arguments.length ? (i = t, a()) : i
            }, r.invertExtent = function(t) {
                return [t = (t = i.indexOf(t)) < 0 ? NaN : t / o + e, t + 1 / o]
            }, r.copy = function() {
                return t(e, n, i)
            }, a()
        }(0, 1, [0, 1])
        ...
        function e() {
            var t = Math.max(0, +F.apply(this, arguments)),
                ...
                r = Math.abs(i - n),
                a = i < n ? 0 : 1;
            if (e < t && (o = e, e = t, t = o), Aa <= r) return N(e, a) + (t ? N(t, 1 - a) : "") + "Z";
            var o, s, u, c, l, h, d, f, g, p, x, _, v = 0,
                y = 0,
                m = [];
            if ((c = (+j.apply(this, arguments) || 0) / 2) && (u = H === gs ? Math.sqrt(t * t + e * e) : +H.apply(this, arguments), a || (y *= -1), e && (y = $(u / e * Math.sin(c))), t && (v = $(u / t * Math.sin(c)))), e) {
                l = e * Math.cos(n + y), h = e * Math.sin(n + y), d = e * Math.cos(i - y), f = e * Math.sin(i - y);
            ...
            if (t) {
                g = t * Math.cos(i - v), p = t * Math.sin(i - v), x = t * Math.cos(n + v), _ = t * Math.sin(n + v);
            ...
            if (ma < r && .001 < (o = Math.min(Math.abs(e - t) / 2, +X.apply(this, arguments)))) {
                s = t < e ^ a ? 0 : 1;
                var T = o,
                    P = o;
                if (r < Sa) {
                    var C = null == x ? [g, p] : null == d ? [l, h] : gn([l, h], [x, _], [d, f], [g, p]),
                        L = l - C[0],
                        M = h - C[1],
                        E = d - C[0],
                        V = f - C[1],
                        G = 1 / Math.sin(Math.acos((L * E + M * V) / (Math.sqrt(L * L + M * M) * Math.sqrt(E * E + V * V))) / 2),
                        k = Math.sqrt(C[0] * C[0] + C[1] * C[1]);
                    P = Math.min(o, (t - k) / (G - 1)), T = Math.min(o, (e - k) / (G + 1))
                }
                if (null != d) {
                    var R = gr(null == x ? [g, p] : [x, _], [l, h], e, T, a),
                        O = gr([d, f], [g, p], e, T, a);
                    o === T ? m.push("M", R[0], "A", T, ",", T, " 0 0,", s, " ", R[1], "A", e, ",", e, " 0 ", 1 - a ^ fr(R[1][0], R[1][1], O[1][0], O[1][1]), ",", a, " ", O[1], "A", T, ",", T, " 0 0,", s, " ", O[0]) : m.push("M", R[0], "A", T, ",", T, " 0 1,", s, " ", O[0])
                } else m.push("M", l, ",", h);
                if (null != x) {
                    var I = gr([l, h], [x, _], t, -P, a),
                        D = gr([g, p], null == d ? [l, h] : [d, f], t, -P, a);
                    o === P ? m.push("L", D[0], "A", P, ",", P, " 0 0,", s, " ", D[1], "A", t, ",", t, " 0 ", a ^ fr(D[1][0], D[1][1], I[1][0], I[1][1]), ",", 1 - a, " ", I[1], "A", P, ",", P, " 0 0,", s, " ", I[0]) : m.push("L", D[0], "A", P, ",", P, " 0 0,", s, " ", I[0])
                } else m.push("L", g, ",", p)
            } else m.push("M", l, ",", h), null != d && m.push("A", e, ",", e, " 0 ", w, ",", a, " ", d, ",", f), m.push("L", g, ",", p), null != x && m.push("A", t, ",", t, " 0 ", b, ",", 1 - a, " ", x, ",", _);
        ...
        return e.innerRadius = function(t) {
            ...
            var t = (+F.apply(this, arguments) + +z.apply(this, arguments)) / 2,
                e = (+Y.apply(this, arguments) + +B.apply(this, arguments)) / 2 - Ta;
    ...
    var ps = qr.map({
        ...
        "basis-open": function(t) {
            ...
            for (var e, n = [], i = -1, r = t.length, a = [0], o = [0]; ++i < 3;) e = t[i], a.push(e[0]), o.push(e[1]);
            for (n.push(br(vs, a) + "," + br(vs, o)), --i; ++i < r;) e = t[i], a.shift(), a.push(e[0]), o.shift(), o.push(e[1]), Ar(n, a, o);
            return n.join("")
        },
        "basis-closed": function(t) {
            for (var e, n, i = -1, r = t.length, a = r + 4, o = [], s = []; ++i < 4;) n = t[i % r], o.push(n[0]), s.push(n[1]);
            for (e = [br(vs, o), ",", br(vs, s)], --i; ++i < a;) n = t[i % r], o.shift(), o.push(n[0]), s.shift(), s.push(n[1]), Ar(e, o, s);
            return e.join("")
        },
        bundle: function(t, e) {
            var n = t.length - 1;
            if (n)
                for (var i, r, a = t[0][0], o = t[0][1], s = t[n][0] - a, u = t[n][1] - o, c = -1; ++c <= n;) r = c / n, (i = t[c])[0] = e * i[0] + (1 - e) * (a + r * s), i[1] = e * i[1] + (1 - e) * (o + r * u);
            return Sr(t)
        },
        ...
        "cardinal-closed": function(t, e) {
            return t.length < 3 ? _r(t) : t[0] + mr((t.push(t[0]), t), wr([t[t.length - 2]].concat(t, [t[1]]), e))
        },
        monotone: function(t) {
    ...
    qr.svg.line.radial = function() {
    ...
    }, (vr.reverse = yr).reverse = vr, qr.svg.area = function() {
        return Lr(R)
        ...
        function e(t, e) {
            var n, i, r = o(this, c, t, e),
                a = o(this, l, t, e);
            return "M" + r.p0 + s(r.r, r.p1, r.a1 - r.a0) + (i = a, (n = r).a0 == i.a0 && n.a1 == i.a1 ? u(r.r, r.p1, r.r, r.p0) : u(r.r, r.p1, a.r, a.p0) + s(a.r, a.p1, a.a1 - a.a0) + u(a.r, a.p1, r.r, r.p0)) + "Z"
        }
        ...
        return t.projection = function(t) {
            return arguments.length ? n((i = e = t, function() {
    ...
    da.transition = function(t) {
        for (var e, n, i = Ss || ++Ps, r = Nr(t), a = [], o = bs || {
                time: Date.now(),
                ease: $n,
                delay: 0,
                duration: 250
            ...
            a.push(e = []);
            for (var c = this[s], l = -1, h = c.length; ++l < h;)(n = c[l]) && Fr(n, l, r, i, o), e.push(n)
        }
        return Or(a, r, i)
    ...
    var Ss, bs, As = Rr(Nr()),
        Ts = [],
        Ps = 0;
    Ts.call = da.call, Ts.empty = da.empty, Ts.node = da.node, Ts.size = da.size, qr.transition = function(t, e) {
        return t && t.transition ? Ss ? t.transition(e) : t : qr.selection().transition(t)
        ...
        for (var s = -1, u = this.length; ++s < u;) {
            o.push(e = []);
            for (var c = this[s], l = -1, h = c.length; ++l < h;)(i = c[l]) && (n = t.call(i, i.__data__, l, s)) ? ("__data__" in i && (n.__data__ = i.__data__), Fr(n, l, a, r, i[a][r]), e.push(n)) : e.push(null)
        }
        return Or(o, a, r)
    }, Ts.selectAll = function(t) {
        var e, n, i, r, a, o = this.id,
            s = this.namespace,
            u = [];
        t = A(t);
        for (var c = -1, l = this.length; ++c < l;)
            for (var h = this[c], d = -1, f = h.length; ++d < f;)
                if (i = h[d]) {
                    a = i[s][o], n = t.call(i, i.__data__, d, c), u.push(e = []);
                    for (var g = -1, p = n.length; ++g < p;)(r = n[g]) && Fr(r, g, s, o, a), e.push(r)
                }
        return Or(u, s, o)
        ...
        for (var r = 0, a = this.length; r < a; r++) {
            i.push(e = []);
            for (var o, s = 0, u = (o = this[r]).length; s < u; s++)(n = o[s]) && t.call(n, n.__data__, s, r) && e.push(n)
        }
        return Or(i, this.namespace, this.id)
    }, Ts.tween = function(e, n) {
        var i = this.id,
            r = this.namespace;
        return arguments.length < 2 ? this.node()[r][i].tween.get(e) : X(this, null == n ? function(t) {
        ...
        var a = "transform" == t ? ui : Un,
            o = qr.ns.qualify(t);
        return Ir(this, "attr." + t, e, o.local ? function(n) {
            return null == n ? r : (n += "", function() {
                var e, t = this.getAttributeNS(o.space, o.local);
                return t !== n && (e = a(t, n), function(t) {
        ...
        return this.tween("attr." + t, r.local ? function(t, e) {
            var n = i.call(this, t, e, this.getAttributeNS(r.space, r.local));
            return n && function(t) {
        ...
        return Ir(this, "style." + i, t, function(n) {
            return null == n ? e : (n += "", function() {
                var e, t = k(this).getComputedStyle(this, null).getPropertyValue(i);
                return t !== n && (e = Un(t, n), function(t) {
                    this.style.setProperty(i, e(t), r)
                })
            })
        })
    }, Ts.styleTween = function(i, r, a) {
        return arguments.length < 3 && (a = ""), this.tween("style." + i, function(t, e) {
            var n = r.call(this, t, e, k(this).getComputedStyle(this, null).getPropertyValue(i));
            return n && function(t) {
        ...
        var n = this.id,
            i = this.namespace;
        return arguments.length < 1 ? this.node()[i][n].ease : ("function" != typeof e && (e = qr.ease.apply(qr, arguments)), X(this, function(t) {
            t[i][n].ease = e
        }))
    }, Ts.delay = function(i) {
        var r = this.id,
            a = this.namespace;
        return arguments.length < 1 ? this.node()[a][r].delay : X(this, "function" == typeof i ? function(t, e, n) {
        ...
        var r = this.id,
            a = this.namespace;
        return arguments.length < 1 ? this.node()[a][r].duration : X(this, "function" == typeof i ? function(t, e, n) {
            t[a][r].duration = Math.max(1, i.call(t, t.__data__, e, n))
        } : (i = Math.max(1, i), function(t) {
            t[a][r].duration = i
        }))
        ...
        if (arguments.length < 2) {
            var t = bs,
                e = Ss;
            try {
                Ss = r, X(this, function(t, e, n) {
                    bs = t[a][r], i.call(t, t.__data__, e, n)
                })
            } finally {
                bs = t, Ss = e
            }
        } else X(this, function(t) {
            var e = t[a][r];
            (e.event || (e.event = qr.dispatch("start", "end", "interrupt"))).on(i, n)
        });
        return this
    }, Ts.transition = function() {
        for (var t, e, n, i = this.id, r = ++Ps, a = this.namespace, o = [], s = 0, u = this.length; s < u; s++) {
            o.push(t = []);
            for (var c, l = 0, h = (c = this[s]).length; l < h; l++)(e = c[l]) && Fr(e, l, a, r, {
                time: (n = e[a][i]).time,
                ease: n.ease,
    ...
    qr.svg.brush = function() {
        function v(t) {
            t.each(function() {
                var t = qr.select(this).style("pointer-events", "all").style("-webkit-tap-highlight-color", "rgba(0,0,0,0)").on("mousedown.brush", o).on("touchstart.brush", o),
                ...
                }).attr("width", 6).attr("height", 6).style("visibility", "hidden"), n.style("display", v.empty() ? "none" : null);
                var i, r = qr.transition(t),
                    a = qr.transition(e);
                T && (i = Qi(T), a.attr("x", i[0]).attr("width", i[1] - i[0]), m(r)), P && (i = Qi(P), a.attr("y", i[0]).attr("height", i[1] - i[0]), w(r)), y(r)
            })
        }
        ...
        function o() {
            function t() {
                var t = qr.mouse(r),
                    e = !1;
                i && (t[0] += i[0], t[1] += i[1]), d || (qr.event.altKey ? (h || (h = [(C[0] + C[1]) / 2, (L[0] + L[1]) / 2]), g[0] = C[+(t[0] < h[0])], g[1] = L[+(t[1] < h[1])]) : h = null), c && n(t, T, 0) && (m(s), e = !0), l && n(t, P, 1) && (w(s), e = !0), e && (y(s), o({
                    type: "brush",
                    mode: d ? "move" : "resize"
                }))
            }
            ...
            function n(t, e, n) {
                var i, r, a = Qi(e),
                    ...
                    c = n ? L : C,
                    l = c[1] - c[0];
                return d && (o -= u, s -= l + u), i = (n ? E : M) ? Math.max(o, Math.min(s, t[n])) : t[n], d ? r = (i += u) + l : (h && (u = Math.max(o, Math.min(s, 2 * h[n] - i))), u < i ? (r = i, i = u) : r = u), c[0] != i || c[1] != r ? (n ? b = null : S = null, c[0] = i, c[1] = r, !0) : void 0
            }

            function e() {
                t(), s.style("pointer-events", "all").selectAll(".resize").style("display", v.empty() ? "none" : null), qr.select("body").style("cursor", null), p.on("mousemove.brush", null).on("mouseup.brush", null).on("touchmove.brush", null).on("touchend.brush", null).on("keydown.brush", null).on("keyup.brush", null), f(), o({
                    type: "brushend"
                })
            }
            var h, i, r = this,
                ...
                f = U(r),
                g = qr.mouse(r),
                p = qr.select(k(r)).on("keydown.brush", function() {
                    32 == qr.event.keyCode && (d || (h = null, g[0] -= C[1], g[1] -= L[1], d = 2), O())
                }).on("keyup.brush", function() {
                    32 == qr.event.keyCode && 2 == d && (g[0] += C[1], g[1] += L[1], d = 0, O())
                });
            if (qr.event.changedTouches ? p.on("touchmove.brush", t).on("touchend.brush", e) : p.on("mousemove.brush", t).on("mouseup.brush", e), s.interrupt().selectAll("*").interrupt(), d) g[0] = C[0] - g[0], g[1] = L[0] - g[1];
            else if (u) {
                var x = +/w$/.test(u),
                    _ = +/^n/.test(u);
                i = [C[1 - x] - g[0], L[1 - _] - g[1]], g[0] = C[x], g[1] = L[_]
            } else qr.event.altKey && (h = g.slice());
            s.style("pointer-events", "none").selectAll(".resize").style("display", null), qr.select("body").style("cursor", a.style("cursor")), o({
                type: "brushstart"
            }), t()
        }
        var S, b, A = I(v, "brushstart", "brush", "brushend"),
            T = null,
            P = null,
            C = [0, 0],
            L = [0, 0],
        ...
        return v.event = function(t) {
            t.each(function() {
                var i = A.of(this, arguments),
                    ...
                    t = this.__chart__ || r;
                this.__chart__ = r, Ss ? qr.select(this).transition().each("start.brush", function() {
                    S = t.i, b = t.j, C = t.x, L = t.y, i({
                        type: "brushstart"
                    })
            ...
            return arguments.length ? (T && P ? (M = !!t[0], E = !!t[1]) : T ? M = !!t : P && (E = !!t), v) : T && P ? [M, E] : T ? M : P ? E : null
        }, v.extent = function(t) {
            var e, n, i, r, a;
            return arguments.length ? (T && (e = t[0], n = t[1], P && (e = e[0], n = n[0]), S = [e, n], T.invert && (e = T(e), n = T(n)), n < e && (a = e, e = n, n = a), e == C[0] && n == C[1] || (C = [e, n])), P && (i = t[0], r = t[1], T && (i = i[1], r = r[1]), b = [i, r], P.invert && (i = P(i), r = P(r)), r < i && (a = i, i = r, r = a), i == L[0] && r == L[1] || (L = [i, r])), v) : (T && (S ? (e = S[0], n = S[1]) : (e = C[0], n = C[1], T.invert && (e = T.invert(e), n = T.invert(n)), n < e && (a = e, e = n, n = a))), P && (b ? (i = b[0], r = b[1]) : (i = L[0], r = L[1], P.invert && (i = P.invert(i), r = P.invert(r)), r < i && (a = i, i = r, r = a))), T && P ? [
                [e, i],
                [n, r]
            ] : T ? [e, n] : P && [i, r])
        }, v.clear = function() {
    ...
    Vs.iso = Date.prototype.toISOString && +new Date("2000-01-01T00:00:00.000Z") ? Hr : ks, Hr.parse = function(t) {
        var e = new Date(t);
        return isNaN(e) ? null : e
    }, Hr.toString = ks.toString, Qa.second = Vt(function(t) {
        return new Za(1e3 * Math.floor(t / 1e3))
    }, function(t, e) {
        t.setTime(t.getTime() + 1e3 * Math.floor(e))
    }, function(t) {
        return t.getSeconds()
    }), Qa.seconds = Qa.second.range, Qa.seconds.utc = Qa.second.utc.range, Qa.minute = Vt(function(t) {
        return new Za(6e4 * Math.floor(t / 6e4))
    }, function(t, e) {
        t.setTime(t.getTime() + 6e4 * Math.floor(e))
    }, function(t) {
        return t.getMinutes()
    }), Qa.minutes = Qa.minute.range, Qa.minutes.utc = Qa.minute.utc.range, Qa.hour = Vt(function(t) {
        ...
        return t.getHours()
    }), Qa.hours = Qa.hour.range, Qa.hours.utc = Qa.hour.utc.range, Qa.month = Vt(function(t) {
    ...
    Os.year = Qa.year, Qa.scale = function() {
    ...
    Ns.year = Qa.year.utc, Qa.scale.utc = function() {
    ...
    }), "function" == typeof define && define.amd ? (this.d3 = qr, define(qr)) : "object" == typeof module && module.exports ? module.exports = qr : this.d3 = qr
}();